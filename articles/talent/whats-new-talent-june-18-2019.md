...
A szakaszban ismertetett módosítások a 8.1.2347-ös buildre vonatkoznak.

### <a name="confirmation-of-course-participants-causes-an-error"></a>A tanfolyam résztvevőinek visszaigazolása hibát okoz

Eltávolítottuk a tanfolyam résztvevőire vonatkozó jelentés nyomtatására szolgáló párbeszédpanelt. A Talent nem támogatja ezt a jelentést.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>A Dolgozó áthelyezése oldal Kompenzáció szakasza nem érhető el bizonyos esetekben

Ennek a módosításnak köszönhetően a felhasználók megadhatják a kompenzációs adatokat a **Dolgozó áthelyezése** lap kitöltése során.
...
A következő entitások támogatják majd az egyéni mezőket: Bérlista bevételeinek kódja és Kompenzációs hivatkozási pontok. 
