...
### <a name="pdf-renderer-for-candidate-documents"></a>PDF-megjelenítő a pályázó dokumentumai számára

Az Attract-felhasználók a jelöltek PDF-mellékletit a dokumentummegtekintőben tekinthetik meg, és nem kell letölteniük a mellékleteket.

### <a name="signing-up-for-attract-user-research-group"></a>Feliratkozás az Attract felhasználói kutatási csoportjára 

A termék új szolgáltatásainak és a szállítási előnézeti funkcióknak a tervezéskor igyekszünk tájékoztatni a felhasználókat a fejlesztési irányról. Az érdeklődő felhasználók az alkalmazás regisztrációs hivatkozása segítségével fel is iratkozhatnak, hogy a felhasználói kutatási csoport részesévé váljanak.
...
Ebben a kiadásban a **Munkanaptár** és a **Munkanaptár napja** támogatják az egyéni mezőket a Common Data Service képernyőn.
