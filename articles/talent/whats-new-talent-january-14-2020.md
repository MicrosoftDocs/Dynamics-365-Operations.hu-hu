...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Új vagy módosult elemek a Dynamics 365 Talent szolgáltatásban (2020. január 14.)
...
A szakaszban ismertetett módosítások a 8.1.2709-ös buildre vonatkoznak. A néhány fejlécben látható, zárójelben lévő számok az Microsoft Dynamics Lifecycle Services (LCS) támogatási számaira vonatkoznak.

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>A rendszer nem tud naptári napokat generálni az adatkezelési keretrendszerbe történő importáláskor (381195)

Ez a módosítás javítja azt a hibát, amelynél a naptári napok importálásakor **Érvénytelen dátumformátum** jön létre. Ez a hiba megakadályozza a munkanaptár-dátumok sorainak létrehozását.
