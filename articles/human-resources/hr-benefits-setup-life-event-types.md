...
---
# <a name="configure-life-event-types"></a>Élettartamesemény-típusok konfigurálása
...
| Fedezet változása (fizetés) | Dolgozó > Kompenzáció > Fix konstrukció | A kompenzáció megváltoztatásakor a rendszer automatikusan újraszámítja az éves juttatásfizetést |
