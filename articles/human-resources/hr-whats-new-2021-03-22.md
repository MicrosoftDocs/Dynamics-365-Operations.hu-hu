...
| --- | --- | --- |
| Lehetőség az elakadt kötegelt feladatok érvénytelenítésének és alaphelyzetbe állításának kényszerítésére (560976) | NA | [Beragadt kötegelt feladatok alaphelyzetbe állítása](https://docs.microsoft.com/dynamics365/human-resources/hr-admin-troubleshooting-batch-execution) |
