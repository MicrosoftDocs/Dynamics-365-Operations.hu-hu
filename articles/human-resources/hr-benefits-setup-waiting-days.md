...
1. A **Juttatások kezelése** munkaterület **Beállítás** részén válassza a **Várakozási napok** elemet.
...
3. Adjon meg értékeket a következő mezőkben:
   ...
   | Mező | Leírás |
   | --- | --- |
   | **Várakozási nap** | A várakozási nap egyedi azonosítója. |
   | **Leírás** | A várakozási nap leírása. |
