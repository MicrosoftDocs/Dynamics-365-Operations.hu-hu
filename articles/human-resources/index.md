...
[Human Resources – hibaelhárítás](hr-admin-troubleshooting-support.md)</br>
...
[Human Resources-entitások a Common Data Service szolgáltatásban](hr-developer-entities.md)</br>
[Egyéni mezők](hr-developer-custom-fields.md)</br>
[Adatintegráció beállítása](hr-admin-integration-choose-technology.md)</br>
[Entitás API referenciája](hr-developer-api-authentication.md)

## <a name="user-guide"></a>Felhasználói útmutató

[Áttekintés](hr-hrpro-overview.md)</br>
[Ismerje meg a felhasználói felületet](../fin-ops-core/fin-ops/get-started/user-interface-elements.md?toc=/dynamics365/human-resources/toc.json)</br>
[Az Emberi erőforrások modul beállítása](hr-setup-parameters.md)</br>
