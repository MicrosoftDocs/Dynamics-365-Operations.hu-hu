...
-  [Mentett nézetek – általános elérhetőség](https://docs.microsoft.com/dynamics365-release-plan/2020wave2/finance-operations/finance-operations-crossapp-capabilities/saved-views--general-availability)<br>- További információ: [Mentett nézetek](https://docs.microsoft.com/dynamics365/fin-ops-core/fin-ops/get-started/saved-views). 
...
Ez a kiadás további naptár-beállításokat tartalmaz a szabadság- és a távolléti naptárakhoz. További tájékoztatás: [Csoportos és vállalati naptárak megtekintése](https://docs.microsoft.com/dynamics365/human-resources/hr-employee-self-service-calendar).
