...
ms.locfileid: "3429773"
---
# <a name="configure-waiting-periods"></a>Várakozási időszakok konfigurálása

A Microsoft Dynamics 365 Human Resources rendszerben a várakozási napokkal hozhatók létre mérföldkövek, amelyek a juttatási konstrukciókhoz használhatók. Például három hónap a felvételi dátumtól számítva, a hónap első napja vagy hat hónap.   

1. A **Juttatások kezelése** munkaterület **Beállítás** részén válassza a **Várakozási időszakok** elemet.
