...
- <span data-ttu-id="d504e-111">Emberierőforrás-adatok</span><span class="sxs-lookup"><span data-stu-id="d504e-111">Human resources data</span></span>
...
<span data-ttu-id="d504e-127">Az Azure tárolási fiókokkal és az Azure tárolási kapcsolati karakterláncokkal kapcsolatos további információkat az alábbi Azure-cikkben találja:</span><span class="sxs-lookup"><span data-stu-id="d504e-127">For more information about Azure storage accounts and Azure Storage connection strings, see the following Azure articles:</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="d504e-141">Adatai konfigurálása</span><span class="sxs-lookup"><span data-stu-id="d504e-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="d504e-158">Juttatások</span><span class="sxs-lookup"><span data-stu-id="d504e-158">Benefits</span></span>
...
<span data-ttu-id="d504e-187">A juttatási programok meghatározásával és kezelésével kapcsolatos további tájékoztatást a következő cikkekben találja:</span><span class="sxs-lookup"><span data-stu-id="d504e-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="d504e-204">Kompenzációs folyamat meghatározása és eredmények kiszámítása</span><span class="sxs-lookup"><span data-stu-id="d504e-204">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="d504e-226">Fizetési ciklus (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="d504e-241">Fizetési ciklusok és fizetési időszakok</span><span class="sxs-lookup"><span data-stu-id="d504e-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="d504e-257">Bevételkódok</span><span class="sxs-lookup"><span data-stu-id="d504e-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="d504e-296">Névjegy adatai</span><span class="sxs-lookup"><span data-stu-id="d504e-296">Contact information</span></span> 
...
- <span data-ttu-id="d504e-358">Elsődleges (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-358">Primary (required)</span></span>
...
- <span data-ttu-id="d504e-380">Elsődleges (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-380">Primary (required)</span></span>
...
<span data-ttu-id="d504e-421">A következő okkódok és leírások szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="d504e-458">Özvegy</span><span class="sxs-lookup"><span data-stu-id="d504e-458">Widowed</span></span>                | <span data-ttu-id="d504e-459">Özvegy</span><span class="sxs-lookup"><span data-stu-id="d504e-459">Widowed</span></span>              |
...
- <span data-ttu-id="d504e-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-491">2OFMTH</span></span>
...
- <span data-ttu-id="d504e-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="d504e-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="d504e-513">Címek</span><span class="sxs-lookup"><span data-stu-id="d504e-513">Addresses</span></span>

<span data-ttu-id="d504e-514">Az adott ország vagy régió, állam és megye (település) kódok specifikus formátumokat követelnek, hogy Dayforce és az országos és regionális szolgáltatók felismerjék azokat.</span><span class="sxs-lookup"><span data-stu-id="d504e-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="d504e-515">Annak ellenére, hogy a városok formátuma rugalmas, minden városnak társítva kell lennie egy államhoz.</span><span class="sxs-lookup"><span data-stu-id="d504e-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="d504e-516">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-516">Human Resources</span></span>          | <span data-ttu-id="d504e-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="d504e-518">Ország/régió</span><span class="sxs-lookup"><span data-stu-id="d504e-518">Country/Region</span></span>  | <span data-ttu-id="d504e-519">Országkód</span><span class="sxs-lookup"><span data-stu-id="d504e-519">Country Code</span></span>          |
| <span data-ttu-id="d504e-520">Irányítószám / postai kód</span><span class="sxs-lookup"><span data-stu-id="d504e-520">Zip/Postal Code</span></span> | <span data-ttu-id="d504e-521">Irányítószám</span><span class="sxs-lookup"><span data-stu-id="d504e-521">Postal Code</span></span>           |
| <span data-ttu-id="d504e-522">Állami</span><span class="sxs-lookup"><span data-stu-id="d504e-522">State</span></span>           | <span data-ttu-id="d504e-523">Államkód</span><span class="sxs-lookup"><span data-stu-id="d504e-523">State Code</span></span>            |
| <span data-ttu-id="d504e-524">Város</span><span class="sxs-lookup"><span data-stu-id="d504e-524">City</span></span>            | <span data-ttu-id="d504e-525">Város</span><span class="sxs-lookup"><span data-stu-id="d504e-525">City</span></span>                  |
| <span data-ttu-id="d504e-526">Megye</span><span class="sxs-lookup"><span data-stu-id="d504e-526">County</span></span>          | <span data-ttu-id="d504e-527">Megye (Helyhatóság)</span><span class="sxs-lookup"><span data-stu-id="d504e-527">County (Municipality)</span></span> |
| <span data-ttu-id="d504e-528">Utca</span><span class="sxs-lookup"><span data-stu-id="d504e-528">Street</span></span>          | <span data-ttu-id="d504e-529">Cím 1. sora</span><span class="sxs-lookup"><span data-stu-id="d504e-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="d504e-530">Adórégiók</span><span class="sxs-lookup"><span data-stu-id="d504e-530">Tax regions</span></span>

<span data-ttu-id="d504e-531">Az adórégiók a megfelelő adó megállapítására szolgálnak, amelyet a bérlista létrehozásakor kell alkalmazni.</span><span class="sxs-lookup"><span data-stu-id="d504e-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="d504e-532">Az adórégiók helycímként vannak a Dayforce-hoz rendelve.</span><span class="sxs-lookup"><span data-stu-id="d504e-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="d504e-533">Az alapértelmezett adórégiót a dolgozó aktív beosztásával kell társítani.</span><span class="sxs-lookup"><span data-stu-id="d504e-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="d504e-534">Adórégió (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-534">Tax region (required)</span></span>
- <span data-ttu-id="d504e-535">Ország/régió (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-535">Country/Region (required)</span></span>
- <span data-ttu-id="d504e-536">Állam (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-536">State (required)</span></span>
- <span data-ttu-id="d504e-537">Megye</span><span class="sxs-lookup"><span data-stu-id="d504e-537">County</span></span> 
- <span data-ttu-id="d504e-538">Város (kötelező)</span><span class="sxs-lookup"><span data-stu-id="d504e-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="d504e-539">Adatok konfigurálása bérlista létrehozásához Mexikóban</span><span class="sxs-lookup"><span data-stu-id="d504e-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="d504e-540">Ha a fizetést generál alkalmazottaknak Mexikóban, a következő elemeket kell beállítani:</span><span class="sxs-lookup"><span data-stu-id="d504e-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="d504e-541">Részlegek szükségesek beosztásokhoz.</span><span class="sxs-lookup"><span data-stu-id="d504e-541">Departments are required on positions.</span></span>
- <span data-ttu-id="d504e-542">Költséghelyek pénzügyi dimenziókként kell beállítani, és az Alapértelmezett pénzügyi dimenzió karakterlánc első elemének kell lennie.</span><span class="sxs-lookup"><span data-stu-id="d504e-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="d504e-543">Beosztástípusok</span><span class="sxs-lookup"><span data-stu-id="d504e-543">Job types</span></span>

<span data-ttu-id="d504e-544">Beosztástípusok használatával a hasonló feladatok kategóriákba sorolhatók.</span><span class="sxs-lookup"><span data-stu-id="d504e-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="d504e-545">Mexikóban a Bérlista feldolgozásához feladattípusok szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="d504e-546">Beosztástípusok többek között a teljes és részmunkaidős, illetve a munkabéres és az órabéres.</span><span class="sxs-lookup"><span data-stu-id="d504e-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="d504e-547">A beosztástípusok a fizetéstípusokként vannak hozzárendelve a Dayforce-hoz, melyek jelzik, hogy a munkavállaló órás vagy bérezéses.</span><span class="sxs-lookup"><span data-stu-id="d504e-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="d504e-548">A következő feladattípusok és leírások szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="d504e-549">Feladattípus</span><span class="sxs-lookup"><span data-stu-id="d504e-549">Job type</span></span>   | <span data-ttu-id="d504e-550">Leírás</span><span class="sxs-lookup"><span data-stu-id="d504e-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="d504e-551">Óránként</span><span class="sxs-lookup"><span data-stu-id="d504e-551">Hourly</span></span>     | <span data-ttu-id="d504e-552">MX Órabér</span><span class="sxs-lookup"><span data-stu-id="d504e-552">MX Hourly</span></span>   |
| <span data-ttu-id="d504e-553">Bérezéses</span><span class="sxs-lookup"><span data-stu-id="d504e-553">Salaried</span></span>   | <span data-ttu-id="d504e-554">MX Bérezéses</span><span class="sxs-lookup"><span data-stu-id="d504e-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="d504e-555">Beosztási típusok</span><span class="sxs-lookup"><span data-stu-id="d504e-555">Position types</span></span> 

<span data-ttu-id="d504e-556">Ne használjon beosztástípusokat annak leírására, hogy a beosztás teljes munkaidős, részmunkaidős vagy más.</span><span class="sxs-lookup"><span data-stu-id="d504e-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="d504e-557">A feladattípusok a fizetésosztályokként vannak hozzárendelve a Dayforce-hoz, melyek jelzik, hogy a munkavállaló teljes- vagy részmunkaidős.</span><span class="sxs-lookup"><span data-stu-id="d504e-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="d504e-558">A következő beosztástípusok és leírások szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="d504e-559">Beosztás típusa</span><span class="sxs-lookup"><span data-stu-id="d504e-559">Position type</span></span>   | <span data-ttu-id="d504e-560">Leírás</span><span class="sxs-lookup"><span data-stu-id="d504e-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="d504e-561">Teljes munkaidős</span><span class="sxs-lookup"><span data-stu-id="d504e-561">Full-time</span></span>       | <span data-ttu-id="d504e-562">Teljes munkaidős alkalmazott</span><span class="sxs-lookup"><span data-stu-id="d504e-562">Full time employee</span></span> |
| <span data-ttu-id="d504e-563">Részmunkaidős</span><span class="sxs-lookup"><span data-stu-id="d504e-563">Part-time</span></span>       | <span data-ttu-id="d504e-564">Részmunkaidős alkalmazott</span><span class="sxs-lookup"><span data-stu-id="d504e-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="d504e-565">Okkódok</span><span class="sxs-lookup"><span data-stu-id="d504e-565">Reason codes</span></span>

<span data-ttu-id="d504e-566">Az alkalmazottak állapotával kapcsolatos okkódok tájékoztatnak.</span><span class="sxs-lookup"><span data-stu-id="d504e-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="d504e-567">Okkódok a Dayforce-hoz állapot okaként vannak hozzárendelve, melyek jelzik egy alkalmazott beosztásában vagy alkalmazotti státuszában bekövetkezett változások okát.</span><span class="sxs-lookup"><span data-stu-id="d504e-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="d504e-568">A következő okkódok és leírások szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="d504e-569">Okkód</span><span class="sxs-lookup"><span data-stu-id="d504e-569">Reason code</span></span>            | <span data-ttu-id="d504e-570">Leírás</span><span class="sxs-lookup"><span data-stu-id="d504e-570">Description</span></span>                    | <span data-ttu-id="d504e-571">Alkalmazandó forgatókönyvek</span><span class="sxs-lookup"><span data-stu-id="d504e-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="d504e-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="d504e-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="d504e-573">Indulás első bérlista előtt</span><span class="sxs-lookup"><span data-stu-id="d504e-573">Departure before first payroll</span></span> | <span data-ttu-id="d504e-574">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-574">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="d504e-575">RESIGNATION</span></span>            | <span data-ttu-id="d504e-576">Felmondás</span><span class="sxs-lookup"><span data-stu-id="d504e-576">Resignation</span></span>                    | <span data-ttu-id="d504e-577">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-577">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="d504e-578">PENSION</span></span>                | <span data-ttu-id="d504e-579">Nyugdíj</span><span class="sxs-lookup"><span data-stu-id="d504e-579">Pension</span></span>                        | <span data-ttu-id="d504e-580">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-580">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="d504e-581">TERMINATION</span></span>            | <span data-ttu-id="d504e-582">Befejezés</span><span class="sxs-lookup"><span data-stu-id="d504e-582">Termination</span></span>                    | <span data-ttu-id="d504e-583">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-583">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="d504e-584">RETIREMENT</span></span>             | <span data-ttu-id="d504e-585">Megszüntetés</span><span class="sxs-lookup"><span data-stu-id="d504e-585">Retirement</span></span>                     | <span data-ttu-id="d504e-586">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-586">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="d504e-587">ABSENTEE</span></span>               | <span data-ttu-id="d504e-588">Távollevő</span><span class="sxs-lookup"><span data-stu-id="d504e-588">Absentee</span></span>                       | <span data-ttu-id="d504e-589">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-589">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-590">EGYÉB</span><span class="sxs-lookup"><span data-stu-id="d504e-590">OTHER</span></span>                  | <span data-ttu-id="d504e-591">Egyéb okok</span><span class="sxs-lookup"><span data-stu-id="d504e-591">Other Reasons</span></span>                  | <span data-ttu-id="d504e-592">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-592">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="d504e-593">CLOSURE</span></span>                | <span data-ttu-id="d504e-594">Üzletzárás</span><span class="sxs-lookup"><span data-stu-id="d504e-594">Business Closure</span></span>               | <span data-ttu-id="d504e-595">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-595">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="d504e-596">DEATH</span></span>                  | <span data-ttu-id="d504e-597">Elhalálozás</span><span class="sxs-lookup"><span data-stu-id="d504e-597">Death</span></span>                          | <span data-ttu-id="d504e-598">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-598">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="d504e-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="d504e-600">Szabadság</span><span class="sxs-lookup"><span data-stu-id="d504e-600">Leave of Absence</span></span>               | <span data-ttu-id="d504e-601">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-601">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="d504e-602">CONTRACTEND</span></span>            | <span data-ttu-id="d504e-603">Szerződés vége</span><span class="sxs-lookup"><span data-stu-id="d504e-603">End of Contract</span></span>                | <span data-ttu-id="d504e-604">Felmondás a dolgozónak</span><span class="sxs-lookup"><span data-stu-id="d504e-604">Terminate worker</span></span>     |
| <span data-ttu-id="d504e-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="d504e-605">SALARYCHANGE</span></span>           | <span data-ttu-id="d504e-606">Munkabér módosítása</span><span class="sxs-lookup"><span data-stu-id="d504e-606">Change of Salary</span></span>               | <span data-ttu-id="d504e-607">Kompenzáció</span><span class="sxs-lookup"><span data-stu-id="d504e-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="d504e-608">Foglalkoztatási feltételek</span><span class="sxs-lookup"><span data-stu-id="d504e-608">Terms of employment</span></span>

<span data-ttu-id="d504e-609">A Foglalkoztatási feltételek foglalkoztatási feltételkategóriák létrehozására használatosak.</span><span class="sxs-lookup"><span data-stu-id="d504e-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="d504e-610">A feltételek alkalmazási mutató értékekként vannak a Dayforce-hoz rendelve.</span><span class="sxs-lookup"><span data-stu-id="d504e-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="d504e-611">A következő alkalmazási feltételek és leírások szükségesek.</span><span class="sxs-lookup"><span data-stu-id="d504e-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="d504e-612">Foglalkoztatási feltételek</span><span class="sxs-lookup"><span data-stu-id="d504e-612">Terms of employment</span></span>   | <span data-ttu-id="d504e-613">Leírás</span><span class="sxs-lookup"><span data-stu-id="d504e-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="d504e-614">Szabályos</span><span class="sxs-lookup"><span data-stu-id="d504e-614">Regular</span></span>               | <span data-ttu-id="d504e-615">Szabályos</span><span class="sxs-lookup"><span data-stu-id="d504e-615">Regular</span></span>     |
| <span data-ttu-id="d504e-616">Közvetlen</span><span class="sxs-lookup"><span data-stu-id="d504e-616">Direct</span></span>                | <span data-ttu-id="d504e-617">Közvetlen</span><span class="sxs-lookup"><span data-stu-id="d504e-617">Direct</span></span>      |
| <span data-ttu-id="d504e-618">Szakmai gyakorlat</span><span class="sxs-lookup"><span data-stu-id="d504e-618">Internship</span></span>            | <span data-ttu-id="d504e-619">Szakmai gyakorlat</span><span class="sxs-lookup"><span data-stu-id="d504e-619">Internship</span></span>  |
| <span data-ttu-id="d504e-620">Állandó</span><span class="sxs-lookup"><span data-stu-id="d504e-620">Permanent</span></span>             | <span data-ttu-id="d504e-621">Állandó</span><span class="sxs-lookup"><span data-stu-id="d504e-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="d504e-622">Családi állapot</span><span class="sxs-lookup"><span data-stu-id="d504e-622">Marital status</span></span>

<span data-ttu-id="d504e-623">Családi állapot értékei Dayforce-hoz vannak rendelve és konvertálva szükség esetén az elfogadható értékekre az integráció során.</span><span class="sxs-lookup"><span data-stu-id="d504e-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="d504e-624">Az alábbi táblázat bemutatja, hogy családi állapot értékek hogyan vannak leképezve a Dayforce -ban.</span><span class="sxs-lookup"><span data-stu-id="d504e-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="d504e-625">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-625">Human Resources</span></span>                 | <span data-ttu-id="d504e-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="d504e-627">Nős/férjezett</span><span class="sxs-lookup"><span data-stu-id="d504e-627">Married</span></span>                | <span data-ttu-id="d504e-628">Nős/férjezett</span><span class="sxs-lookup"><span data-stu-id="d504e-628">Married</span></span>                   |
| <span data-ttu-id="d504e-629">Egy</span><span class="sxs-lookup"><span data-stu-id="d504e-629">Single</span></span>                 | <span data-ttu-id="d504e-630">Egy</span><span class="sxs-lookup"><span data-stu-id="d504e-630">Single</span></span>                    |
| <span data-ttu-id="d504e-631">Özvegy</span><span class="sxs-lookup"><span data-stu-id="d504e-631">Widowed</span></span>                | <span data-ttu-id="d504e-632">Özvegy</span><span class="sxs-lookup"><span data-stu-id="d504e-632">Widowed</span></span>                   |
| <span data-ttu-id="d504e-633">Elvált</span><span class="sxs-lookup"><span data-stu-id="d504e-633">Divorced</span></span>               | <span data-ttu-id="d504e-634">Elvált</span><span class="sxs-lookup"><span data-stu-id="d504e-634">Divorced</span></span>                  |
| <span data-ttu-id="d504e-635">Bejegyzett élettársi kapcsolat</span><span class="sxs-lookup"><span data-stu-id="d504e-635">Registered Partnership</span></span> | <span data-ttu-id="d504e-636">Élettársi viszony</span><span class="sxs-lookup"><span data-stu-id="d504e-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="d504e-637">Nincs</span><span class="sxs-lookup"><span data-stu-id="d504e-637">None</span></span>                   | <span data-ttu-id="d504e-638">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="d504e-639">Együttélés</span><span class="sxs-lookup"><span data-stu-id="d504e-639">Cohabiting</span></span>             | <span data-ttu-id="d504e-640">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="d504e-641">Nem</span><span class="sxs-lookup"><span data-stu-id="d504e-641">Gender</span></span>

<span data-ttu-id="d504e-642">A nemek a Dayforce-hoz vannak rendelve és konvertálva szükség esetén az elfogadható értékekre az integráció során.</span><span class="sxs-lookup"><span data-stu-id="d504e-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="d504e-643">Az alábbi táblázat bemutatja, hogy a nemek hogyan vannak leképezve a Dayforce-ban.</span><span class="sxs-lookup"><span data-stu-id="d504e-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="d504e-644">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-644">Human Resources</span></span>       | <span data-ttu-id="d504e-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="d504e-646">Férfi</span><span class="sxs-lookup"><span data-stu-id="d504e-646">Male</span></span>         | <span data-ttu-id="d504e-647">Férfi</span><span class="sxs-lookup"><span data-stu-id="d504e-647">Male</span></span>                      |
| <span data-ttu-id="d504e-648">Nő</span><span class="sxs-lookup"><span data-stu-id="d504e-648">Female</span></span>       | <span data-ttu-id="d504e-649">Nő</span><span class="sxs-lookup"><span data-stu-id="d504e-649">Female</span></span>                    |
| <span data-ttu-id="d504e-650">Nem meghatározott</span><span class="sxs-lookup"><span data-stu-id="d504e-650">Non-specific</span></span> | <span data-ttu-id="d504e-651">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="d504e-652">Kifizetési mód</span><span class="sxs-lookup"><span data-stu-id="d504e-652">Payment method</span></span>

<span data-ttu-id="d504e-653">A Fizetési módok adják meg az alkalmazott és a vállalat számára az alkalmazott kifizetésének módja leírásának lehetőségét.</span><span class="sxs-lookup"><span data-stu-id="d504e-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="d504e-654">A Fizetési módok a Dayforce-hoz vannak rendelve és konvertálva szükség esetén az elfogadható értékekre az integráció során.</span><span class="sxs-lookup"><span data-stu-id="d504e-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="d504e-655">Az alábbi táblázat bemutatja, hogy a fizetés módok hogyan vannak leképezve a Dayforce-ban.</span><span class="sxs-lookup"><span data-stu-id="d504e-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="d504e-656">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-656">Human Resources</span></span>             | <span data-ttu-id="d504e-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="d504e-658">Készpénz</span><span class="sxs-lookup"><span data-stu-id="d504e-658">Cash</span></span>               | <span data-ttu-id="d504e-659">Készpénz</span><span class="sxs-lookup"><span data-stu-id="d504e-659">Cash</span></span>                      |
| <span data-ttu-id="d504e-660">Elektronikus fizetés</span><span class="sxs-lookup"><span data-stu-id="d504e-660">Electronic Payment</span></span> | <span data-ttu-id="d504e-661">Átvitel</span><span class="sxs-lookup"><span data-stu-id="d504e-661">Transfer</span></span>                  |
| <span data-ttu-id="d504e-662">Csekkes</span><span class="sxs-lookup"><span data-stu-id="d504e-662">Check</span></span>              | <span data-ttu-id="d504e-663">Csekk</span><span class="sxs-lookup"><span data-stu-id="d504e-663">Cheque</span></span>                    |
| <span data-ttu-id="d504e-664">Váltó</span><span class="sxs-lookup"><span data-stu-id="d504e-664">Bank Draft</span></span>         | <span data-ttu-id="d504e-665">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="d504e-666">Egyéb</span><span class="sxs-lookup"><span data-stu-id="d504e-666">Other</span></span>              | <span data-ttu-id="d504e-667">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="d504e-668">Bankszámla típusa</span><span class="sxs-lookup"><span data-stu-id="d504e-668">Bank account type</span></span>

<span data-ttu-id="d504e-669">Bankszámla-típusok az alkalmazottaknak történő elektronikus kifizetésekhez szolgálnak.</span><span class="sxs-lookup"><span data-stu-id="d504e-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="d504e-670">Bankszámla típusa a Dayforce-ba átutalási számlaadatként van rendelve.</span><span class="sxs-lookup"><span data-stu-id="d504e-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="d504e-671">A bankszámlatípusok szükség esetén konvertálva vannak az elfogadható értékekké az integráció során.</span><span class="sxs-lookup"><span data-stu-id="d504e-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="d504e-672">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-672">Human Resources</span></span>            | <span data-ttu-id="d504e-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="d504e-674">Folyószámla</span><span class="sxs-lookup"><span data-stu-id="d504e-674">Checking Account</span></span>  | <span data-ttu-id="d504e-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="d504e-675">CheckingAccount</span></span>           |
| <span data-ttu-id="d504e-676">Bérlista elszámolási számlája</span><span class="sxs-lookup"><span data-stu-id="d504e-676">Payroll Account</span></span>   | <span data-ttu-id="d504e-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="d504e-677">PayrollAccount</span></span>            |
| <span data-ttu-id="d504e-678">Megtakarítási számla</span><span class="sxs-lookup"><span data-stu-id="d504e-678">Savings Account</span></span>   | <span data-ttu-id="d504e-679">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="d504e-680">BankGirot-számla</span><span class="sxs-lookup"><span data-stu-id="d504e-680">BankGirot account</span></span> | <span data-ttu-id="d504e-681">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="d504e-682">PlusGirot-számla</span><span class="sxs-lookup"><span data-stu-id="d504e-682">PlusGirot account</span></span> | <span data-ttu-id="d504e-683">*Mexikó nem támogatja*</span><span class="sxs-lookup"><span data-stu-id="d504e-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="d504e-684">Bevételkódok</span><span class="sxs-lookup"><span data-stu-id="d504e-684">Earning codes</span></span>

<span data-ttu-id="d504e-685">A bevételkódok egyedi módon azonosítják a dolgozók által kapott fizetéstípusokat.</span><span class="sxs-lookup"><span data-stu-id="d504e-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="d504e-686">A kódoknak különböző paramétereket fednek le, amelyek a bevételekhez kapcsolódnak, például könyvelési szabályok, jelentési követelmények és bruttósítási lehetőségek.</span><span class="sxs-lookup"><span data-stu-id="d504e-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="d504e-687">Ha egy nem támogatott gyakoriság van használatban, a **Minden fizetés** gyakorisága van alapértelmezés szerint használva a kiszámításhoz.</span><span class="sxs-lookup"><span data-stu-id="d504e-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="d504e-688">Támogatott gyakoriságok</span><span class="sxs-lookup"><span data-stu-id="d504e-688">Supported frequencies</span></span>

- <span data-ttu-id="d504e-689">Összes</span><span class="sxs-lookup"><span data-stu-id="d504e-689">All</span></span>
- <span data-ttu-id="d504e-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="d504e-690">EVERYPAY</span></span>
- <span data-ttu-id="d504e-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="d504e-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="d504e-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="d504e-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="d504e-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="d504e-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="d504e-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-694">1OFMTH</span></span>
- <span data-ttu-id="d504e-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-695">LASTOFMTH</span></span>
- <span data-ttu-id="d504e-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-696">2OFMTH</span></span>
- <span data-ttu-id="d504e-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-697">3OFMTH</span></span>
- <span data-ttu-id="d504e-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-698">4OFMTH</span></span>
- <span data-ttu-id="d504e-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-699">5OFMTH</span></span>
- <span data-ttu-id="d504e-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-700">1N2OFMTH</span></span>
- <span data-ttu-id="d504e-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-701">3N4OFMTH</span></span>
- <span data-ttu-id="d504e-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-702">1N3OFMTH</span></span>
- <span data-ttu-id="d504e-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-703">1N4OFMTH</span></span>
- <span data-ttu-id="d504e-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-704">2N3OFMTH</span></span>
- <span data-ttu-id="d504e-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-705">2N4OFMTH</span></span>
- <span data-ttu-id="d504e-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="d504e-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="d504e-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="d504e-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="d504e-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="d504e-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="d504e-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="d504e-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="d504e-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="d504e-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="d504e-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="d504e-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="d504e-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="d504e-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="d504e-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="d504e-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="d504e-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="d504e-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="d504e-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="d504e-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="d504e-718">Címek</span><span class="sxs-lookup"><span data-stu-id="d504e-718">Addresses</span></span>

<span data-ttu-id="d504e-719">Az adott ország vagy régió, állam és megye (település) kódok specifikus formátumokat követelnek, hogy Dayforce és az országos és regionális szolgáltatók felismerjék azokat.</span><span class="sxs-lookup"><span data-stu-id="d504e-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="d504e-720">Annak ellenére, hogy a városok formátuma rugalmas, minden városnak társítva kell lennie egy államhoz.</span><span class="sxs-lookup"><span data-stu-id="d504e-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="d504e-721">Emberi erőforrások</span><span class="sxs-lookup"><span data-stu-id="d504e-721">Human Resources</span></span>              | <span data-ttu-id="d504e-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="d504e-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="d504e-723">Ország/régió</span><span class="sxs-lookup"><span data-stu-id="d504e-723">Country/Region</span></span>      | <span data-ttu-id="d504e-724">Országkód</span><span class="sxs-lookup"><span data-stu-id="d504e-724">Country Code</span></span>          |
| <span data-ttu-id="d504e-725">Irányítószám / postai kód</span><span class="sxs-lookup"><span data-stu-id="d504e-725">Zip/Postal Code</span></span>     | <span data-ttu-id="d504e-726">Irányítószám</span><span class="sxs-lookup"><span data-stu-id="d504e-726">Postal Code</span></span>           |
| <span data-ttu-id="d504e-727">Állami</span><span class="sxs-lookup"><span data-stu-id="d504e-727">State</span></span>               | <span data-ttu-id="d504e-728">Államkód</span><span class="sxs-lookup"><span data-stu-id="d504e-728">State Code</span></span>            |
| <span data-ttu-id="d504e-729">Város</span><span class="sxs-lookup"><span data-stu-id="d504e-729">City</span></span>                | <span data-ttu-id="d504e-730">Város</span><span class="sxs-lookup"><span data-stu-id="d504e-730">City</span></span>                  |
| <span data-ttu-id="d504e-731">Megye</span><span class="sxs-lookup"><span data-stu-id="d504e-731">County</span></span>              | <span data-ttu-id="d504e-732">Megye (Helyhatóság)</span><span class="sxs-lookup"><span data-stu-id="d504e-732">County (Municipality)</span></span> |
| <span data-ttu-id="d504e-733">Utca</span><span class="sxs-lookup"><span data-stu-id="d504e-733">Street</span></span>              | <span data-ttu-id="d504e-734">Cím 1. sora</span><span class="sxs-lookup"><span data-stu-id="d504e-734">Address Line 1</span></span>        |
| <span data-ttu-id="d504e-735">Utca, házszám</span><span class="sxs-lookup"><span data-stu-id="d504e-735">Street Number</span></span>       | <span data-ttu-id="d504e-736">Cím 2. sora</span><span class="sxs-lookup"><span data-stu-id="d504e-736">Address Line 2</span></span>        |
| <span data-ttu-id="d504e-737">Épületblokk</span><span class="sxs-lookup"><span data-stu-id="d504e-737">Building Complement</span></span> | <span data-ttu-id="d504e-738">Cím 5. sora</span><span class="sxs-lookup"><span data-stu-id="d504e-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="d504e-739">Útlevél száma</span><span class="sxs-lookup"><span data-stu-id="d504e-739">Passport number</span></span>

<span data-ttu-id="d504e-740">Az alkalmazottak útlevél adatokat is nyilatkozhatnak.</span><span class="sxs-lookup"><span data-stu-id="d504e-740">Employees can declare passport information.</span></span> <span data-ttu-id="d504e-741">Az információ a **Útlevél** azonosítótípusra vonatkozik, és az alkalmazott Mexikó-specifikus adataiként van a Dayforce-ba integrálva.</span><span class="sxs-lookup"><span data-stu-id="d504e-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="d504e-742">Azonosító típusa = „Útlevél”</span><span class="sxs-lookup"><span data-stu-id="d504e-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="d504e-743">Kibocsátás dátuma</span><span class="sxs-lookup"><span data-stu-id="d504e-743">Issued Date</span></span>
- <span data-ttu-id="d504e-744">Lejárat dátuma</span><span class="sxs-lookup"><span data-stu-id="d504e-744">Expiration Date</span></span>

<span data-ttu-id="d504e-745">Az alkalmazottak több azonosítószámot is megadhatnak az **Útlevél** azonosítótípushoz.</span><span class="sxs-lookup"><span data-stu-id="d504e-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="d504e-746">Azonban csak az aktuális aktív útlevélbejegyzés van integrálva a Dayforce-ba.</span><span class="sxs-lookup"><span data-stu-id="d504e-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="d504e-747">Ha az összes útlevélbejegyzés lejárt, a legutóbb kiállított lesz integrálva a Dayforce-ba.</span><span class="sxs-lookup"><span data-stu-id="d504e-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
