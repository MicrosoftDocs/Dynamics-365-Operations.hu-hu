...
A Számsorozatok lapon kiválaszthatja a következő rekordokhoz használt számsorozatokat: **Személyzeti szám**, **Beosztás**, **Felhasználói kérelem azonosítója**, **I-9-es** dokumentum, Pályázó, **·** **Vitafórum**, **·** **Juttatásazonosító és Személyzeti** művelet (ha ez a rekordtípus engedélyezve van).**·** A számsorozat-hivatkozások és a kódok fenntartásához használja a **Számsorozatok** listalapot. Az oldal megtalálásához használja az oldalkeresési funkciót. 
