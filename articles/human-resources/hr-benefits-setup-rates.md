...
---
# <a name="configure-rates"></a>Mértékek konfigurálása
...
3. Adjon meg értékeket a következő mezőkben:
   ...
   | Fizetési gyakoriság mértékének kiszámítása | A fizetési gyakorisági mértékének kiszámítási módja: normál vagy éves. |
