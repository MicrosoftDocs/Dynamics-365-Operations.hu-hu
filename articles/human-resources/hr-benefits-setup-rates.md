...
> [!IMPORTANT]
> A dolgozói rekord **Személyes adatok** részében található beállítás jelzi, hogy az alkalmazott dohányzó-e. Ha az alkalmazott dohányzóként van rögzítve, akkor a rendszer a dohányzási mértéket használja. (Az alkalmazottnak soha nem jelenik meg a dohányzó jelzés.)
