...
description: Ez a témakör leírja, hogyan követi nyomon a juttatáskezelés a 1095-B és a 1095-C nyomtatványon jelentett információkat a megfizethető ellátási törvény (ACA) munkáltatói mandátumához.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
