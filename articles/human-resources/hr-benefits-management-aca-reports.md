...
description: Ez a témakör azt írja le, hogy hogyan követi nyomon a juttatások kezelése az 1095-B űrlapon és az 1095-C űrlapon (ACA) a munkáltatói rendeletre vonatkozó 1095-C űrlapon jelentett információkat.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9337308"
---
# <a name="generate-aca-reports-in-benefits-management"></a>ACA-jelentések készítése a Juttatáskezelésben

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

A juttatások kezelése nyomon követi az 1095-B és 1095-C nyomtatványon jelentett információkat a Megfizethető ellátási törvény (ACA) munkáltatói mandátumához. A régi **Juttatások** munkaterületen történő ACA jelentéskészítési képességhez hasonlóan ez a funkció csak az Egyesült Államokban érvényes jogi személyekre vonatkozik.
...
2. Szükség szerint módosítsa a paramétereket, majd válassza az **OK** gombot.
    ...
    > [!NOTE]
    > Ha több mint 500 alkalmazottnak nyomtat 1095-C űrlapot, egynél több PDF-fájlt fog kapni. Javasoljuk, hogy a **Dokumentumkezelés paraméterei** lapon a **Maximális fájlméret megabájtban** mező értékét **150**-re növelje. (Az oldal gyors megnyitásához használja a navigációs sáv keresőmezőjét.)
    >
