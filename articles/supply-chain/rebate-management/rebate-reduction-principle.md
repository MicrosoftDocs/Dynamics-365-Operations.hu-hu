...
description: Ez a témakör a csökkentési elvek beállítását írja le. A csökkentési elvek befolyásolják a viselkedést, amikor több visszatérítés vonatkozik ugyanarra a cikkre vagy tranzakcióra.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
