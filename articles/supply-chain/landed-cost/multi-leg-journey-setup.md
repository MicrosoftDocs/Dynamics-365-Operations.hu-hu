...
description: Ez a témakör azt ismerteti, hogyan lehet több szakaszból álló utazásokat beállítani a Landed költségmodulhoz.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905834"
---
# <a name="multi-leg-journey-setup"></a>Többszakaszos út beállítása

[!include [banner](../../includes/banner.md)]

Ez a témakör azt ismerteti, hogyan lehet több szakaszból álló utazásokat beállítani a **Landed költségmodulhoz**.
