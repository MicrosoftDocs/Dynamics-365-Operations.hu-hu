...
description: Ez a témakör azt ismerteti, hogyan lehet beállítani a Landed költségmodulban feladásra, állapotfrissítésre, számsorozatra és működésre használt általános információkat és konfigurációs beállításokat.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
