...
Létrehozhatja saját attribútumtípusait. Ezenkívül a termékdimenziókat a Microsoft Dynamics 365 for Finance and Operations szolgáltatásból áthelyezheti az **Attribútumtípusok** oldalra.

1. Válassza ki az **Eszközkezelés** \> **Beállítás** \> **Attribútumtípusok** lehetőséget.
2. Ha első alkalommal hoz létre attribútumtípusokat, válassza ki a **Termékdimenziók létrehozása** elemet a szabványos Finance and Operations termékdimenziók automatikus áthelyezéséhez.
