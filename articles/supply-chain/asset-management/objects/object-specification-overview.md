...
1. Válassza ki az **Eszközkezelés** \> **Lekérdezések** \> **Eszközök** \> **Eszközattribútum áttekintése** lehetőséget.
2. Az **Eszköztípus** mezőben válasszon ki egy eszköztípust.
