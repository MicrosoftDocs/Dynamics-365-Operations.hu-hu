...
Mielőtt elkezdené a raktárkezelési terhelést, a rendszert elő kell készíteni az ebben a szakaszban leírt módon.

### <a name="deploy-a-scale-unit-with-the-warehouse-management-workload"></a>Skálaegység telepítése a raktárkezelési terheléssel
...
### <a name="turn-on-required-features-in-feature-management"></a>A funkciókezelés szükséges funkcióinak bekapcsolás.

A Funkciókezelés [munkaterületen](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) mindkét funkciót bekapcsolhatja. (Mindkét funkció felsorolása a következő alatt található: *Raktárkezelő* modul.)
...
A raktárkezelési terhelés a következő három termelési folyamaton keresztül támogatott a Raktárkezelés alkalmazásban:
...
A dolgozók a Készként jelentve **és** a Raktárkezelés alkalmazás elraktározási folyamatában készként jelentheti a termelési vagy kötegelt rendeléseket. A társ- és társtermékeket is készként jelenteni tudják a kötegrendelésben. Amikor egy feladatot készként jelent, a rendszer általában raktári munkát hoz létre a mérlegegységen. Ha nem igényli a berakodott munkát, a munka irányelveit be lehet állítani, hogy ne írják le.

### <a name="start-production-order"></a>Termelési rendelés indítása

A dolgozók a Raktárkezelés **alkalmazás** termelési rendelési folyamatának indítási folyamatában regisztrálják a termelési vagy kötegelt rendelést.

### <a name="register-material-consumption"></a>Anyagfelhasználás regisztrálása

A dolgozók a Raktárkezelés **alkalmazás** anyagfelhasználási folyamatának regisztrálása segítségével jelentést kaphatnak egy termelési vagy kötegelt rendelés anyagfelhasználási folyamatról. Ezt követően a skálaegységben a termelési vagy kötegrendelésben jelentett anyaghoz létrejön egy kitárolásilista-napló. A naplósorok fizikai foglalást hoznak létre a felhasznált készletre. Ha az adatokat a mérlegegység és a központ között szinkronizálja, akkor a központi példányra egy kitárolásilista-napló jön létre, és azt feladja a program.
...
- **Bevételezés áthozaata** – az tábla bevételezésének feldolgozása során
...
A mérlegegységek esetében jelenleg semmilyen más típusú forrásdokumentum-feldolgozás és raktári munka nem támogatott. Ha például egy mérlegegységen futtat egy raktár-végrehajtási terhelést, akkor az értékesítési visszárurendelés bevételi folyamata nem használható visszárurendelések feldolgozására. Ehelyett a központi példánynak kell feldolgoznia ezt a feldolgozást.
...
- A raktári munka szállítmányjegyzékekkel (például csomagolási jegyzékekkel) dolgozik a csomagolóállomáson.
...
| Csomagolóállomás manuális feldolgozása  | Nem  | Nem |
...
| Raktári rendelési sorok érvénytelen kérelmének kérése                      | Igen | Nem, de a kérést jóváhagyják vagy elutasítják. |
| <p>Átmozgatási rendelések kiadása bevételezéshez</p><p>Ez a folyamat automatikusan megtörténik az átszállítási rendelés szállítási folyamatának részeként. Ugyanakkor manuálisan is engedélyezheti az tábla fogadását mérlegegységben, ha a bejövő raktári rendeléssorokat visszavonták, vagy egy új terhelés-telepítési folyamat részeként.</p> | Igen | Nem|
<!--| A csomagolóállomás manuális feldolgozása, beleértve a "Csomagolt tároló kitárolása" munkát  | Nem  | Igen, de a TMS szállítmány jegyzékfájlja és az értékesítési szállítólevél feladása nélkül, illetve a csomagolási megjegyzések és a termékképek nélkül |-->
...
| Raktári rendelési sorok érvénytelen kérelmének kérése                            | Igen | Nem, de a kérést jóváhagyják vagy elutasítják. |
| Beszerzési rendelési forrásdokumentum termékbevételezésének feldolgozása                        | Igen | Nem |
...
| Beszerzési rendelés – Tábla bevétele és berakodva              | <p>Igen, ha nincs raktári rendelés</p><p>Nem, ha van raktári rendelés</p> | Nem |
| Átrendelt rendelés – táblás bevétel és berakodás             | Nem | Igen |
...
| Munka érvénytelenítése (bejövő)                                            | <p>Igen, ha nincs raktári rendelés</p><p>Nem, ha van raktári rendelés</p> | <p>Igen, de csak akkor, ha <b>nincs regisztrálva a bevételezés, ha törli a</b><b>munka beállítását a Raktárkezelési</b> paraméterek lapon.</p> |
...
| Feldolgozás | Központ | Raktári végrehajtási számítási feladat skálázási egységeken |
|---------|-----|----------------------------------------------|
| Termelési rendelés forrásdokumentumának feldolgozása    | Igen | Nem |
| Kiadás raktárba                           | Igen | Nem |
...
A központi telepítés során manuálisan karbantarthatja a következő kötegelt feladatokat:

- A Következő kötegelt feladatok kezelése a **Raktárkezelés Időszakos \> feladatai \> - Háttérirodás terheléskezelés**:

    - Skálázási egységből a központi üzenetfeldolgozóba
    - Rendelésiforrás-nyugták regisztrálása
    - Raktári rendelések befejezése
    - Hiányzó kimenő raktári rendelések létrehozása

- A Következő kötegelt feladatok kezelése a Raktárkezelés **időszakos feladatai – \> Terheléskezelés \>**:
...
A mérlegegység-telepítésekkel **a Következő kötegelt feladatok kezelhetők a Raktárkezelés \>\> időszakos feladatai – Terheléskezelés:**
