...
description: Ez a cikk a Munkasor részletei lapról nyújt tájékoztatást, amely a rendszerben található egyes munkasorok átfogó, rendezhető és szűrhető listáját tartalmazza.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
