...
description: Ez a témakör azt ismerteti, hogyan kell kezelni a Raktár mobil beolvasása alkalmazást a Android kompatibilis eszközökre.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905544"
---
# <a name="mobile-bar-code-support"></a>Mobil vonalkód-támogatás
...
A Raktárkezelés mobilalkalmazást Android alapú eszközök választékával teszteltek a vonalkódok beolvasása esetében. A tesztek csak a piacon elérhető eszközök egy részét fedték le.
