...
ms.locfileid: "1559186"
---
# <a name="install-and-configure-microsoft-dynamics-365-for-finance-and-operations-8211-warehousing"></a>A Microsoft Dynamics 365 for Finance and Operations &#8211; Raktárkezelés telepítése és konfigurálása
...
Ez a témakör leírja, hogyan telepítheti és konfigurálhatja a Microsoft Dynamics 365 for Finance and Operations - Raktárkezelés szolgáltatást.
...
> [!NOTE]
> A Zebra App Galleryt már megszüntették, ami azt jelenti, hogy a Finance and Operations – Raktárkezelés alkalmazás nem lesz letölthető erről a helyről.
...
2.  Társítsa az Azure Active Directory alkalmazást a raktározási alkalmazás felhasználójával.
    1.  A Finance and Operations szolgáltatásban lépjen a **Rendszerfelügyelet** &gt; **Beállítás** &gt; **Azure Active Directory alkalmazások** elemre.
...
3.  Adja meg a következő adatokat: 
    ...
    + **Azure Active Directory-erőforrás** - Az Azure AD könyvtár-erőforrás a Finance and Operations gyökér-URL-jét jeleníti meg. **Megjegyzés:**: ne zárja perjellel (/) ezt a mezőt. 
    + **Azure Active Directory-bérlő** – a Finance and Operations kiszolgálón használt Azure AD könyvtárbérlő: `https://login.windows.net/your-AD-tenant-ID`. Például: `https://login.windows.net/contosooperations.onmicrosoft.com.` 
...
További információkért a Dynamics 365 for Finance and Operations – Raktárkezelés beállításával kapcsolatban arra, hogy a mobileszköz kameráját vonalkódok leolvasására használja, lásd: [Vonalkódok beolvasása kamera használatával a Dynamics 365 for Finance and Operations – Raktárkezelés alkalmazásban](scan-bar-codes-using-a-camera.md)
