...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="aeb7d-123">Állítsa be a hullámsablon lehetőséget</span><span class="sxs-lookup"><span data-stu-id="aeb7d-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="aeb7d-139">A **Felhasználók** gyorslap **Új** elemét választva, hozzon létre egy mobileszköz-fiókot, majd állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="aeb7d-140">**Felhasználó azonosítója:** Adjon meg egy egyedi azonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-140">**User ID:** Enter a unique ID.</span></span>
...
### <a name="set-up-warehouse-management-parameters"></a><span data-ttu-id="aeb7d-157">Raktárkezelési paraméterek beállítása</span><span class="sxs-lookup"><span data-stu-id="aeb7d-157">Set up Warehouse management parameters</span></span>
...
### <a name="set-up-a-location"></a><span data-ttu-id="aeb7d-173">Hely beállítása</span><span class="sxs-lookup"><span data-stu-id="aeb7d-173">Set up a location</span></span>
...
1. <span data-ttu-id="aeb7d-192">Az **Általános** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="aeb7d-210">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-210">Select **OK**.</span></span>
...
1. <span data-ttu-id="aeb7d-226">Az **Áttekintés** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="aeb7d-227">**Raktár:** *62*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="aeb7d-245">A rendezéssel együtt használt munkaosztály beállítása.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="aeb7d-262">Az **Általános** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="aeb7d-279">Válassza a **Munkaosztályok** gyorslap **Új** elemét, majd állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-279">On the **Work classes** FastTab, select **New**, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="aeb7d-280">**Munkaosztály azonosítója:** *SORT*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="aeb7d-296">Egyetlen Termékváltozatirányelv beállítása</span><span class="sxs-lookup"><span data-stu-id="aeb7d-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="aeb7d-315">Válassza a **Helyutasítás-műveletek** gyorslap **Új** elemét, majd állítsa be a következő értékeket az új soron:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-315">On the **Location Directive Actions** FastTab, select **New**, and then set the following values on the new line.</span></span> <span data-ttu-id="aeb7d-316">Az összes többi mezőben hagyja meg az alapértelmezett értékeket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="aeb7d-317">**Sorozat:** *1*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="aeb7d-336">A **Mentés** gombra kattintva elérhetővé válik a **Sorok** gyorslap az eszköztáron.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="aeb7d-353">Lépjen a **Raktárkezelés \> Beállítás \> Munka \> Munkasablonok** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="aeb7d-371">Értékesítési rendelések és kitárolási munka létrehozása</span><span class="sxs-lookup"><span data-stu-id="aeb7d-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="aeb7d-407">A **Sor részletei** gyorslap **Szállítás** lapján állítsa be a **Szállítási mód** mezőt *Flowe-STD* értékre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="aeb7d-423">Munkaazonosítók beolvasása a munka részleteiből</span><span class="sxs-lookup"><span data-stu-id="aeb7d-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="aeb7d-440">Tekintse át a **Beszerzési rendelések – Betárolás** oldalon látható információkat.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-440">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="aeb7d-441">A **Hely** mezőnek jeleznie kell, hogy a kitárolt cikkek a *Csomagolás* helyre mennek.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-441">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
...
1. <span data-ttu-id="aeb7d-460">Tekintse át a **Beszerzési rendelések – Betárolás** oldalon látható információkat.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-460">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="aeb7d-461">A **Hely** mezőnek jeleznie kell, hogy a kitárolt cikkek a *Csomagolás* helyre mennek.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-461">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="aeb7d-462">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-462">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-463">A **Munkaazonosító/azonosítótábla azonosítójának beolvasása** oldalon egy „Munka elvégezve” üzenet jelenik meg.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-463">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="aeb7d-464">Ez az üzenet azt jelzi, hogy a 2. értékesítési rendelés 2. sorának munkaazonosítója el lett végezve.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-464">This message indicates that the work ID from line 2 of sales order 2 has been completed.</span></span>

### <a name="pack-sales-orders-into-containers"></a><span data-ttu-id="aeb7d-465">Értékesítési rendelések csomagolása tárolókba</span><span class="sxs-lookup"><span data-stu-id="aeb7d-465">Pack sales orders into containers</span></span>

#### <a name="pack-sales-order-1-into-containers"></a><span data-ttu-id="aeb7d-466">Az 1. értékesítési rendelés csomagolása tárolókba</span><span class="sxs-lookup"><span data-stu-id="aeb7d-466">Pack sales order 1 into containers</span></span>

1. <span data-ttu-id="aeb7d-467">Nyissa meg a **Raktárkezelés \> Csomagolási és tárolólétrehozás \> Csomagolás** menüt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-467">Go to **Warehouse management \> Packing and containerization \> Pack**.</span></span>

    <span data-ttu-id="aeb7d-468">Megjelenik a **Csomagolóállomás kiválasztása** párbeszédpanel.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-468">The **Select packing station** dialog box appears.</span></span> <span data-ttu-id="aeb7d-469">Alapértelmezés szerint a **Dolgozó** mezőt a korábban beállított dolgozó nevére kell állítani.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-469">By default, the **Worker** field should be set to the name of the worker that you set up earlier.</span></span>

1. <span data-ttu-id="aeb7d-470">Állítsa be a következő értékeket az adott csomagolásai helyen tervezett szállítmányok és tárolók megtekintéséhez és az azokkal történő munkához:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>

    - <span data-ttu-id="aeb7d-471">**Telephely:** *6*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-471">**Site:** *6*</span></span>
    - <span data-ttu-id="aeb7d-472">**Raktár:** *62*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-472">**Warehouse:** *62*</span></span>
    - <span data-ttu-id="aeb7d-473">**Hely:** *Csomag*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-473">**Location:** *Pack*</span></span>
    - <span data-ttu-id="aeb7d-474">**Csomagolási profil azonosítója:** *Rendezés*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-474">**Packing profile ID:** *Sort*</span></span>

1. <span data-ttu-id="aeb7d-475">Az **OK** gombbal zárja be a párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-475">Select **OK** to close the dialog box.</span></span>
1. <span data-ttu-id="aeb7d-476">A **Csomag** lap **Azonosítótábla vagy szállítmány** mezőjébe írja be az 1. értékesítési rendelés cél azonosítótábláját.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="aeb7d-477">Ezután a billentyűzet **Tab** vagy **Enter** gombjával lépjen ki a mezőből.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="aeb7d-478">A műveleti ablaktáblán kattintson az **Új tároló** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="aeb7d-479">Fogadja el az alapértelmezett beállításokat, majd válassza az **OK** gombot.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="aeb7d-480">Jegyezze fel a tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="aeb7d-481">A **Cikkcsomagolás** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="aeb7d-482">**Mennyiség:** *1*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="aeb7d-483">**Azonosító:** Cikk *A0001*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="aeb7d-484">A műveleti ablaktáblán kattintson az **Tároló bezárása** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="aeb7d-485">A **Tároló lezárása** párbeszédpanelen válassza a **Rendszertömeg beolvasása lehetőséget**, ha szeretné, hogy a rendszer frissítse a **Bruttó súly** mezőt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="aeb7d-486">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-486">Select **OK**.</span></span> <span data-ttu-id="aeb7d-487">A program áthelyezi a tárolót a *SORT* helyre, és készen áll a rendezésre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="aeb7d-488">Hozzon létre egy másik tárolót, és adja hozzá a második elemet az 1. értékesítési rendelés azonosítótáblájáról egy új tárolóhoz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="aeb7d-489">A műveleti ablaktáblán kattintson az **Új tároló** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="aeb7d-490">Fogadja el az alapértelmezett beállításokat, majd válassza az **OK** gombot.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="aeb7d-491">Jegyezze fel a tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="aeb7d-492">A **Cikkcsomagolás** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="aeb7d-493">**Mennyiség:** *1*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="aeb7d-494">**Azonosító:** Cikk *A0001*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="aeb7d-495">A műveleti ablaktáblán kattintson az **Tároló bezárása** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="aeb7d-496">A **Tároló lezárása** párbeszédpanelen válassza a **Rendszertömeg beolvasása lehetőséget**, ha szeretné, hogy a rendszer frissítse a **Bruttó súly** mezőt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="aeb7d-497">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-497">Select **OK**.</span></span> <span data-ttu-id="aeb7d-498">A program áthelyezi a tárolót a *SORT* helyre, és készen áll a rendezésre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="aeb7d-499">Az 2. értékesítési rendelés csomagolása tárolókba</span><span class="sxs-lookup"><span data-stu-id="aeb7d-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="aeb7d-500">A **Csomag** lap **Azonosítótábla vagy szállítmány** mezőjébe írja be a 2.. értékesítési rendelés első sorának cél azonosítótábláját.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="aeb7d-501">Ezután a billentyűzet **Tab** vagy **Enter** gombjával lépjen ki a mezőből.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="aeb7d-502">A műveleti ablaktáblán kattintson az **Új tároló** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="aeb7d-503">Fogadja el az alapértelmezett beállításokat, majd válassza az **OK** gombot.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="aeb7d-504">Jegyezze fel a tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="aeb7d-505">A **Cikkcsomagolás** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="aeb7d-506">**Mennyiség:** *1*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="aeb7d-507">**Azonosító:** Cikk *A0001*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="aeb7d-508">A műveleti ablaktáblán kattintson az **Tároló bezárása** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="aeb7d-509">A **Tároló lezárása** párbeszédpanelen válassza a **Rendszertömeg beolvasása lehetőséget**, ha szeretné, hogy a rendszer frissítse a **Bruttó súly** mezőt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="aeb7d-510">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-510">Select **OK**.</span></span> <span data-ttu-id="aeb7d-511">A program áthelyezi a tárolót a *SORT* helyre, és készen áll a rendezésre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="aeb7d-512">Az **Azonosítótábla vagy szállítmány** mezőbe írja be a 2. értékesítési rendelés második sorának cél azonosítótábláját.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="aeb7d-513">Ezután a billentyűzet **Tab** vagy **Enter** gombjával lépjen ki a mezőből.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="aeb7d-514">A műveleti ablaktáblán kattintson az **Új tároló** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="aeb7d-515">Fogadja el az alapértelmezett beállításokat, majd válassza az **OK** gombot.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="aeb7d-516">Jegyezze fel a tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="aeb7d-517">A **Cikkcsomagolás** gyorslapon állítsa be a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="aeb7d-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="aeb7d-518">**Mennyiség:** *1*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="aeb7d-519">**Azonosító mező:** Cikk *A0002*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="aeb7d-520">A műveleti ablaktáblán kattintson az **Tároló bezárása** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="aeb7d-521">A **Tároló lezárása** párbeszédpanelen válassza a **Rendszertömeg beolvasása lehetőséget**, ha szeretné, hogy a rendszer frissítse a **Bruttó súly** mezőt.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="aeb7d-522">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-522">Select **OK**.</span></span> <span data-ttu-id="aeb7d-523">A program áthelyezi a tárolót a *SORT* helyre, és készen áll a rendezésre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="aeb7d-524">A tároló adatainak megtekintéséhez nyissa meg a **Raktárkezelés \> Csomagolás és tárolólétrehozás \> Tárolók** lehetőséget, és keresse meg a csomagolás során létrehozott tárolóazonosítókat.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers**, and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="aeb7d-525">A tárolók rendezése</span><span class="sxs-lookup"><span data-stu-id="aeb7d-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="aeb7d-526">Amikor a mobilalkalmazás **Raklap összeállítása** menüjét megnyitja a kimenő rendszerezéshez, akkor egy **Teljes** feliratú gombot fog látni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="aeb7d-527">*Ne használja a **Teljes** gombot a pozíció rendezéséhez vagy lezárásához.*</span><span class="sxs-lookup"><span data-stu-id="aeb7d-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="aeb7d-528">A **Teljes** gomb alapértelmezésben elérhető, és nem lehet letiltani vagy eltávolítani a lapról.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="aeb7d-529">Ez a beállítás nem lehet a *Kimenő rendezés* funkcióhoz használni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="aeb7d-530">Az első tároló rendezése</span><span class="sxs-lookup"><span data-stu-id="aeb7d-530">Sort the first container</span></span>

1. <span data-ttu-id="aeb7d-531">A mobileszközön jelentkezzen be a *62-es* raktárba a forgatókönyvhöz létrehozott felhasználói azonosító (vagy egy meglévő demóadat-felhasználó) használatával.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="aeb7d-532">Válassza a főmenü **Kimenő** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="aeb7d-533">Válassza a **Kimenő** menü **Raklap összeállítása** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="aeb7d-534">Az **Azonosítótábla/con** mezőbe írja be az 1. értékesítési rendeléshez társított tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="aeb7d-535">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-535">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-536">Mivel jelenleg nem léteznek rendezési pozíciók, meg kell adnia egyet.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="aeb7d-537">A **Rendezési pozíció azonosítója** mezőbe írja be az *SP01* értéket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="aeb7d-538">Mivel jelenleg nincs azonosítótábla társítva az *SP01* rendezési pozícióhoz, meg kell adnia egy értéket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-538">Because no LP is currently associated with sort position *SP01*, you must specify one.</span></span> <span data-ttu-id="aeb7d-539">Az **Azonosítótábla** mezőben adja meg a *PLP01* értéket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="aeb7d-540">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-540">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-541">Mivel a rendezési pozíció ellenőrzése be van kapcsolva, újra meg kell adnia a rendezési pozíció azonosítóját.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="aeb7d-542">A **Rendezési pozíció azonosítója** mezőbe írja be az *SP01* értéket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="aeb7d-543">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-543">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-544">A „Munka befejezve” üzenet jelenik meg.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="aeb7d-545">Ha meg szeretné tekinteni a rendezési pozíciót és a benne lévő azonosítótáblát nyissa meg a **Raktárkezelés \> Csomagolás és tárolólétrehozás \> Kimenő rendezésipozíció-hozzárendelések** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="aeb7d-546">A **Kimenő rendezésipozíció-hozzárendelések** lap megjeleníti a jelenleg aktív összes rendezési pozíciót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="aeb7d-547">A **Rendezésipozíció-tranzakciók** mező megjeleníti az egyes pozíciókhoz társított azonosítótáblákat és a rendezési pozícióban lévő tárolókat.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="aeb7d-548">Figyelje meg, hogy jelenleg egy rendezési beosztás létezik, és a **Rendezési pozíció feltételei** gyorslap a **Szállítmány – Szállítmányozói szolgáltatás – Légi** kritériumot jeleníti meg.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="aeb7d-549">A fennmaradó tárolók rendezése</span><span class="sxs-lookup"><span data-stu-id="aeb7d-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="aeb7d-550">A mobileszközön jelentkezzen be a *62-es* raktárba a forgatókönyvhöz létrehozott felhasználói azonosító (vagy egy meglévő demóadat-felhasználó) használatával.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="aeb7d-551">Válassza a főmenü **Kimenő** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="aeb7d-552">Válassza a **Kimenő** menü **Raklap összeállítása** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="aeb7d-553">Az **Azonosítótábla/con** mezőbe írja be az 1. értékesítési rendeléshez társított második tárolóazonosítót.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="aeb7d-554">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-554">Select **OK**.</span></span> <span data-ttu-id="aeb7d-555">Mivel a rendezési sablon automatikus rendezésre van beállítva, és létezik egy megfelelő kritériumokkal rendelkező rendezési pozíció, automatikusn át lesz irányítva a helyes rendezési pozícióhoz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="aeb7d-556">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-556">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-557">Erősítse meg a rendezési pozíció azonosítóját, hogy jelezze, hogy a készlet a megfelelő helyen van.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="aeb7d-558">A **Rendezési pozíció azonosítója** mezőbe írja be az *SP01* értéket.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="aeb7d-559">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-559">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-560">A munka az 1. értékesítési rendelés második tárolóján végezhető el.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="aeb7d-561">Ezután a fennmaradó tárolókat a 2. értékesítési rendelésből rendezzük.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="aeb7d-562">Az **Azononsítótábla/Con** mezőbe írja be annak a tárolónak az azonosítóját, amelybe a 2. értékesítési rendelés *A0001* cikkét tartalmazza.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="aeb7d-563">Mivel a szállítmányozói szolgáltatás különbözik, a program kéri, hogy írjon be egy új rendezési pozíciót, és adjon hozzá egy azonosítótáblát ahhoz a pozícióhoz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="aeb7d-564">Használja az *SP02* rendezési pozíciót és a *PLP02* azonosítótáblát.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="aeb7d-565">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-565">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-566">A rendezési pozíció jóváhagyásához írja be az *SP02* értéket a **Rendezési pozíció azonosítója** mezőbe.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="aeb7d-567">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-567">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-568">A munka a tárolón fejeződik be.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="aeb7d-569">Az **Azononsítótábla/Con** mezőbe írja be a megmaradt tárolónak az azonosítóját, amelybe a 2. értékesítési rendelés *A0002* cikkét tartalmazza.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="aeb7d-570">Mivel a szállítmányozói szolgáltatás ugyanaz, mint az 1. értékesítési rendelés szállítmányozói szolgáltatása, a rendszer a megfelelő feltételekkel rendelkező meglévő rendezési pozíciót jeleníti meg.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="aeb7d-571">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-571">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-572">A rendezési pozíció jóváhagyásához írja be az *SP01* értéket a **Rendezési pozíció azonosítója** mezőbe.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="aeb7d-573">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-573">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-574">A munka a tárolón fejeződik be.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="aeb7d-575">A kimenő rendezési pozíciók lezárása</span><span class="sxs-lookup"><span data-stu-id="aeb7d-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="aeb7d-576">Ha minden készletet rendeztek, akkor a pozíciót a munka létrehozása előtt le kell zárni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="aeb7d-577">A program létrehoz egy rendezett készletkitárolási-munkát, hogy a készletet a raktárajtóhoz vigye.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="aeb7d-578">Pozíció lezárása a mobileszközből</span><span class="sxs-lookup"><span data-stu-id="aeb7d-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="aeb7d-579">A mobileszközön jelentkezzen be a *62-es* raktárba a forgatókönyvhöz létrehozott felhasználói azonosító (vagy egy meglévő demóadat-felhasználó) használatával.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="aeb7d-580">Válassza a főmenü **Kimenő** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="aeb7d-581">Válassza a **Kimenő** menü **Raklap összeállítása** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="aeb7d-582">Az **Azonosítótábla/Con** mezőbe írja be azt a tároló-azonosítót, amelyet az *SP01* rendezési pozícióhoz rendeltek.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="aeb7d-583">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-583">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-584">A következő üzenet jelenik meg: „A tároló már hozzá van rendelve az SP01 pozícióhoz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="aeb7d-585">Lezárja a pozíciót?”</span><span class="sxs-lookup"><span data-stu-id="aeb7d-585">Close the position?"</span></span> <span data-ttu-id="aeb7d-586">Válassza **Bezárás** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-586">Select **Close**.</span></span>

    <span data-ttu-id="aeb7d-587">A munka befejeződött.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="aeb7d-588">Pozíció lezárása a kimenő rendezési pozíció hozzárendeléseiből</span><span class="sxs-lookup"><span data-stu-id="aeb7d-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="aeb7d-589">Nyissa meg a **Raktárkezelés \> Csomagolás és tárolólétrehozás \> Kimenő rendezésipozíció-hozzárendelések** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="aeb7d-590">A bal oldali oszlopban válassza ki az **SP02** elemet.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="aeb7d-591">Ez a kimenő rendezési pozíció sora az, amelyet le fog zárni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="aeb7d-592">A műveleti ablaktáblán kattintson az **Pozíció lezárása** elemre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="aeb7d-593">A rendezési pozíció rekordja le van zárva, és már nem jelenik meg.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="aeb7d-594">Ha minden lezárt pozíció rekordját meg szeretné jeleníteni, jelölje be a **Lezártak megjelenítése** jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="aeb7d-595">Sorba rendezett készletkitárolás</span><span class="sxs-lookup"><span data-stu-id="aeb7d-595">Sorted inventory picking</span></span>

<span data-ttu-id="aeb7d-596">El kell végeznie a rendezett készlet kitárolási munkafolyamatát.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="aeb7d-597">Amikor ez befejeződött a készlet ki lesz tárolva az értékesítési rendeléshez.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="aeb7d-598">Ekkor minden egyéb raktári folyamat érvényes.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="aeb7d-599">A mobileszközön jelentkezzen be a *62-es* raktárba a forgatókönyvhöz létrehozott felhasználói azonosító (vagy egy meglévő demóadat-felhasználó) használatával.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="aeb7d-600">Válassza a főmenü **Kimenő** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="aeb7d-601">Válassza a **Kimenő** menü **Rakomány rendezésből** elemét.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="aeb7d-602">Adja meg a cél Azonosítótábla azonosítóját az első rendezési pozícióból, az *SP01*-ből.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="aeb7d-603">Állítsa az **Azonosító** mezőt *PLP01* értékre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="aeb7d-604">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-604">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-605">A **Rendezett készlet kitárolása: kitárolás** lap megjeleníti a kitárolási munkát, amelyet el kell végezni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="aeb7d-606">Válassza ki a *SORT* helyet, és a cél *PLP01* azonosítótáblát, amely több cikket és *3* mennyiséget tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-606">Pick from the *SORT* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="aeb7d-607">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-607">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-608">A **Rendezett készlet kitárolása: betárolás** lap megjeleníti a betárolási munkát, amelyet el kell végezni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="aeb7d-609">Tároljon be a *Baydoor* helyre, és a cél *PLP01* azonosítótáblát, amely több cikket és *3* mennyiséget tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-609">Put to the *Baydoor* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="aeb7d-610">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-610">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-611">A munka befejeződött.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-611">Work is completed.</span></span>

1. <span data-ttu-id="aeb7d-612">Adja meg a cél azonosítótábla azonosítóját a második rendezési pozícióból, az *SP02*-ből.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="aeb7d-613">Állítsa az **Azonosító** mezőt *PLP02* értékre.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="aeb7d-614">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-614">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-615">A **Rendezett készlet kitárolása: kitárolás** lap megjeleníti a kitárolási munkát, amelyet el kell végezni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="aeb7d-616">Válassza ki a *SORT* helyet, és a cél *PLP02* azonosítótáblát, amely több cikket és *1* mennyiséget tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-616">Pick from the *SORT* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="aeb7d-617">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-617">Select **OK**.</span></span>
1. <span data-ttu-id="aeb7d-618">A **Rendezett készlet kitárolása: betárolás** lap megjeleníti a betárolási munkát, amelyet el kell végezni.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="aeb7d-619">Tároljon be a *Baydoor* helyre, és a cél *PLP02* azonosítótáblát, amely több cikket és *1* mennyiséget tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-619">Put to the *Baydoor* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="aeb7d-620">Válassza ki az **OK** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-620">Select **OK**.</span></span>

    <span data-ttu-id="aeb7d-621">A munka befejeződött.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-621">Work is completed.</span></span>

<span data-ttu-id="aeb7d-622">Ekkortól minden egyéb raktári folyamat érvényes.</span><span class="sxs-lookup"><span data-stu-id="aeb7d-622">From this point forward, all other warehouse processes apply.</span></span>
