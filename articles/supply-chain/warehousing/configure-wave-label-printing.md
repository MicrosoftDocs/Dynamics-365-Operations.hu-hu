...
- <span data-ttu-id="5dc5d-124">A címkék érvénytelenítése (például rövid kitárolási helyzetekben), majd újranyomtatása.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-124">Void labels (for example, in short pick scenarios), and reprint them.</span></span>
...
- <span data-ttu-id="5dc5d-137">**Modul:** *Raktárkezelés*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-137">**Module:** *Warehouse management*</span></span>
...
### <a name="configure-a-wave-template"></a><span data-ttu-id="5dc5d-149">Hullámsablon konfigurálása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-149">Configure a wave template</span></span>
...
1. <span data-ttu-id="5dc5d-163">A műveleti panelen válassza a **hullámcímkék sorbeállításai** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-163">On the Action Pane, select **Wave label row settings**.</span></span>
    ...
    <span data-ttu-id="5dc5d-164">Megjelenik a **Hullámcímke sorbeállításai** lap.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-164">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="5dc5d-165">Itt beállítható a címke dinamikus része.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-165">Here, you can configure the dynamic part of the label.</span></span>
...
1. <span data-ttu-id="5dc5d-180">A lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-180">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="5dc5d-181">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-181">**Table:** *Work lines*</span></span>
...
<span data-ttu-id="5dc5d-200">A hullámcímkék típusaival a hullámcímkesablonok egy egységhez kapcsolhatók egy egységszekvencia-csoport soraiban.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-200">Wave label types are used to link wave label templates to a unit on unit sequence group lines.</span></span>
...
1. <span data-ttu-id="5dc5d-218">Az **általános** gyorslapon adja meg a **hullámcímke típusa** mezőt *kartondoboz* értékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-218">On the **General** FastTab, set the **Wave label type** field to *Carton*.</span></span>
...
1. <span data-ttu-id="5dc5d-233">A lekérdezésszerkesztő párbeszédpanelen, a **Rendezés** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-233">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="5dc5d-234">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-234">**Table:** *Work lines*</span></span>
...
### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="5dc5d-249">Értékesítési rendelés létrehozása és kiadása a raktárba</span><span class="sxs-lookup"><span data-stu-id="5dc5d-249">Create a sales order and release it to the warehouse</span></span>
...
## <a name="scenario-2-wave-label-printing-for-containerization-without-wave-label-records"></a><span data-ttu-id="5dc5d-285">2. eset: Hullámcímke-nyomtatás a tárolóra bontáshoz (hullámcímkerekordok nélkül)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-285">Scenario 2: Wave label printing for containerization (without wave label records)</span></span>
...
<span data-ttu-id="5dc5d-296">Ez a forgatókönyv a végpontok közötti folyamatot jeleníti meg.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-296">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-a-wave-label-layout"></a><span data-ttu-id="5dc5d-311">Hullámcímke elrendezésének létrehozása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-311">Create a wave label layout</span></span>
...
1. <span data-ttu-id="5dc5d-320">Adjon hozzá egy sort, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="5dc5d-328">**Sorok száma oldalanként** *5*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-328">**Rows per page:** *5*</span></span>
        ...
        <span data-ttu-id="5dc5d-329">Ez a mező határozza meg, hogy hány sort lehet nyomtatni az egyes címkékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-329">This field defines the number of rows that can be printed on each label.</span></span>
...
1. <span data-ttu-id="5dc5d-354">Ugrás a **Raktárkezelés \> Beállítás \> Dokumentumirányítás \> Hullámcímkesablonok** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-354">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
...
1. <span data-ttu-id="5dc5d-365">Nem kötelező: Ha ügyfélre vonatkozó címkét állít be, akkor egy lekérdezést kell létrehoznia, hogy megkeresse a vevő számláját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-365">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5dc5d-366">A **Hullámcímkesablon adatai** gyorslapján válassza a **lekérdezés szerkesztése** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-366">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5dc5d-367">Ezután a lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-367">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="5dc5d-372">Ha befejezte a munkát, az **OK** gombra kattintva zárja be a lekérdezéstervező párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-372">When you've finished, select **OK** to close the query editor dialog box.</span></span>
...
1. <span data-ttu-id="5dc5d-382">Adjon hozzá 5 értékesítésirendelési-sort:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="5dc5d-389">3. értékesítésirendelés-sor:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-389">Sales order line 3:</span></span>
...
<span data-ttu-id="5dc5d-415">A jelen forgatókönyv konfiguráció és az 1. eset konfigurációja közti legfontosabb különbség, a szünetcímkék engedélyezésén kívül, hogy több hullámcímketípust kell társítani a hullámcímkesablonokhoz és az egységszekvencia-csoportsorokhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-415">The main difference between the configuration of this scenario and the configuration of scenario 1, besides the fact that break labels are enabled, is that multiple wave label types must be associated with wave label templates and unit sequence group lines.</span></span> <span data-ttu-id="5dc5d-416">Ennek a konfigurációnak a végrehajtásához a következő elemeket kell beállítania erre az esetre:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-416">To accomplish this configuration, you set up the following elements for this scenario:</span></span>

- <span data-ttu-id="5dc5d-417">**A hullámfeldolgozási módok:** "ismételhető" módszerként jelöli meg a hullámcímkét, és adja hozzá két (vagy több) alkalommal a hullámsablonhoz, és adjon meg különböző hullámlépéskódokat.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-417">**Wave processing methods:** You will mark the wave label method as "repeatable," add it two (or more) times to the wave template, and set different wave step codes.</span></span>
- <span data-ttu-id="5dc5d-418">**Hullámcímkesablonok:** Beállítja a hullámcímkesablonokat, és csatolja őket a hullámsablonhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-418">**Wave label templates:** You will configure the wave label templates and link them to the wave template.</span></span> <span data-ttu-id="5dc5d-419">Minden hullámcímke sablonjának saját hullámcímketípusának kell lennie.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-419">Each wave label template has its own wave label type.</span></span>
- <span data-ttu-id="5dc5d-420">**Hullámcímke-elrendezések:** Több hullámcímke-elrendezést fog létrehozni.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-420">**Wave label layouts:** You will create multiple wave label layouts.</span></span> <span data-ttu-id="5dc5d-421">A címkék mindegyik "rétegét" külön címkeelrendezéssel kell ellátni, és a program egy szünetcímke elrendezést is tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-421">There will be a separate label layout for each "tier" of labels, and there will also be a break label layout.</span></span>

<span data-ttu-id="5dc5d-422">Ez a forgatókönyv a végpontok közötti folyamatot jeleníti meg.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-422">This scenario shows the end-to-end flow.</span></span>

### <a name="make-demo-data-available"></a><span data-ttu-id="5dc5d-423">A bemutató adatok elérhetővé tétele</span><span class="sxs-lookup"><span data-stu-id="5dc5d-423">Make demo data available</span></span>

<span data-ttu-id="5dc5d-424">A jelen forgatókönyv követéséhez a demó adatokat kell telepíteni, és az **USMF** demó jogi személyt kell használnia.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-424">To follow this scenario, you must have demo data installed, and you must select the **USMF** legal entity.</span></span>

### <a name="set-up-a-wave-process-method"></a><span data-ttu-id="5dc5d-425">Hullámfeldolgozási mód beállítása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-425">Set up a wave process method</span></span>

1. <span data-ttu-id="5dc5d-426">Ugorjon a **Raktárkezelés \> Beállítás \> Hullámok \> Hullámfeldolgozás módszerei** lehetőségre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-426">Go to **Warehouse management \> Setup \> Waves \> Wave process methods**.</span></span>
1. <span data-ttu-id="5dc5d-427">Győződjön meg róla, hogy a **waveLabelPrinting** szerepel a listán.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-427">Confirm that **waveLabelPrinting** is in the list.</span></span> <span data-ttu-id="5dc5d-428">Ha nincs, akkor a műveleti ablaktáblán válassza ki a **Metódusok újragenerálása** lehetőséget a hozzáadáshoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-428">If it isn't, select **Regenerate methods** on the Action Pane to add it.</span></span>
1. <span data-ttu-id="5dc5d-429">A **waveLabelPrinting** módszernél jelölje be a **metódus ismétlődővé tétele** jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-429">For the **waveLabelPrinting** method, select the **Make method repeatable** check box.</span></span>

### <a name="set-up-a-wave-template"></a><span data-ttu-id="5dc5d-430">Állítsa be a hullámsablon lehetőséget</span><span class="sxs-lookup"><span data-stu-id="5dc5d-430">Set up a wave template</span></span>

1. <span data-ttu-id="5dc5d-431">Ugorjon a **Raktárkezelés \> Beállítás \> Hullámok \> Hullámsablonok** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
2. <span data-ttu-id="5dc5d-432">Válasszon sablont, például a **62 Szállítási alapértelmezés** sablont.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-432">Select a template, such as **62 Shipping Default**.</span></span>
3. <span data-ttu-id="5dc5d-433">A **metódusok** gyorslapon helyezze át a **hullámcímke-nyomtatás** módszert a **kiválasztott metódusok** oszlopba.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-433">On the **Methods** FastTab, move the **Wave label printing** method to the **Selected methods** column.</span></span>
4. <span data-ttu-id="5dc5d-434">A **kiválasztott metódusok** oszlopában állítsa be a **hullámlépés kódja** értékét (például *kartondoboz*) a **Hullámcímke-nyomtatás** módhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-434">In the **Selected methods** column, assign a **Wave step code** value, such as *Carton*, to the **Wave label printing** method.</span></span> <span data-ttu-id="5dc5d-435">További tájékoztatás: [Hullámlépéskódok](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="5dc5d-435">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>
5. <span data-ttu-id="5dc5d-436">Ismét helyezze át a **Hullámcímke-nyomtatás** módszert a **kiválasztott metódusok** oszlopba.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="5dc5d-437">A **kiválasztott metódusok** oszlopában állítson be eltérő **hullámlépés kódja** értékét (például *raklap*) a második **Hullámcímke-nyomtatás** módhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="5dc5d-438">További tájékoztatás: [Hullámlépéskódok](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="5dc5d-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="5dc5d-439">Három hullámcímke-elrendezés létrehozása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="5dc5d-440">Ugrás a **Raktárkezelés \> Beállítás \> Dokumentumirányítás \> Hullámcímke-elrendezések** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="5dc5d-441">Hozzon létre egy második rekordot, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-442">**Címkeelrendezés azonosítója:** *Kartondoboz*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="5dc5d-443">**Leírás:** *Kartondoboz (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="5dc5d-444">A műveleti ablaktáblán válassza a **Mentés** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5dc5d-445">A műveleti panelen válassza a **hullámcímkék sorbeállításai** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="5dc5d-446">Megjelenik a **Hullámcímke sorbeállításai** lap.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="5dc5d-447">Itt beállítható a címke dinamikus része.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="5dc5d-448">Adjon hozzá egy sort, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-449">**Sorazonosító:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="5dc5d-450">**Sor táblaneve:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="5dc5d-451">**Sor kezdő pozíciója:** *0*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="5dc5d-452">Ez a mező azt a függőleges pozíciót határozza meg, ahol a sor a címkén kezdődik.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="5dc5d-453">**Sormagasság** *0*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-453">**Row height:** *0*</span></span>

        <span data-ttu-id="5dc5d-454">Ez a mező határozza meg az egyes sorok magasságát (pontban) a ZPL szabvány szerint.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="5dc5d-455">A sormagasság pozitív a vízszintes címkéknél, és negatív a függőleges címkéknél.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="5dc5d-456">Mivel ebben a példában csak egy sor van, az értéket *0* (nulla) értékre lehet megadni.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="5dc5d-457">**Sorok száma oldalanként** *1*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="5dc5d-458">Ez a mező határozza meg, hogy hány sort lehet nyomtatni az egyes címkékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="5dc5d-459">Ez a beállítás külön ZPL címkét fog okozni a hullámcímkék táblában szereplő mindegyik rekordhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="5dc5d-460">Zárja be a lapot.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-460">Close the page.</span></span>
1. <span data-ttu-id="5dc5d-461">A műveleti ablaktáblán válassza a **Lekérdezés szerkesztése** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="5dc5d-462">A lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-463">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-464">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-465">**Mező:** *Munkatípus*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="5dc5d-466">**Feltételek:** *Kitárolás*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="5dc5d-467">Ez a lekérdezés gondoskodik arról, hogy csak a kitárolás típusú munkasorok legyenek kinyomtatva a címkére, és ne legyenek betárolás típusú munkasorok.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="5dc5d-468">Ha azt szeretné, hogy a fuvarlevél-azonosító kinyomtatása megtörténjen, az **illesztések** lapon válassza ki a **munkasorok** táblát, majd a **szállítmányok** tábláját illessze hozzá.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="5dc5d-469">Zárja be a lekérdezéstervező párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="5dc5d-470">A **nyomtató szövegének elrendezése** gyorslap három szakaszból áll, ahol megadhatja a nyomtató kódját: **fejléc szakasz** , **szövegtörzs** és **lábléc szakasz**.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5dc5d-471">A **Fejléc szakasz** szakaszban a **Címkefejléc** mezőben adja meg a kívánt fejléc kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="5dc5d-472">Ha például Zebra nyomtatókat használ, a következő kódot használhatja.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="5dc5d-473">A **Szövegtörzs szakasz** szakaszban a **Címke szövegtörzse** mezőben adja meg a kívánt szövegtörzs ZPL kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="5dc5d-474">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-474">Here is an example.</span></span>
...
1. <span data-ttu-id="5dc5d-475">A **Szövegtörzs szakasz** szakaszban a **Címke lábléce** mezőben adja meg a kívánt lábléc ZPL kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="5dc5d-476">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="5dc5d-477">Ez a beállítás kinyomtatja az egyes címkék egy példányát.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="5dc5d-478">Ha több példányra van szükség (például egy példány a raklap mindkét oldalára), akkor állítsa be a lábléc **\^PQn** szakaszának **n** értékét a példányok szükséges számára.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="5dc5d-479">Ha például az egyes címkékből négy másolatot szeretne nyomtatni, adja meg: **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="5dc5d-480">Az első címke készen áll a használatra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="5dc5d-481">Hozzon létre egy második elrendezésrekordot, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-482">**Címkeelrendezés azonosítója:** *Raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="5dc5d-483">**Leírás:** *raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="5dc5d-484">A műveleti ablaktáblán válassza a **Mentés** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5dc5d-485">A műveleti panelen válassza a **hullámcímkék sorbeállításai** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="5dc5d-486">Megjelenik a **Hullámcímke sorbeállításai** lap.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="5dc5d-487">Itt beállítható a címke dinamikus része.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="5dc5d-488">Adjon hozzá egy sort, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-489">**Sorazonosító:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="5dc5d-490">**Sor táblaneve:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="5dc5d-491">**Sor kezdő pozíciója:** *0*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="5dc5d-492">Ez a mező azt a függőleges pozíciót határozza meg, ahol a sor a címkén kezdődik.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="5dc5d-493">**Sormagasság** *0*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-493">**Row height:** *0*</span></span>

        <span data-ttu-id="5dc5d-494">Ez a mező határozza meg az egyes sorok magasságát (pontban) a ZPL szabvány szerint.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="5dc5d-495">A sormagasság pozitív a vízszintes címkéknél, és negatív a függőleges címkéknél.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="5dc5d-496">Mivel ebben a példában csak egy sor van, az értéket *0* (nulla) értékre lehet megadni.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="5dc5d-497">**Sorok száma oldalanként** *1*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="5dc5d-498">Ez a mező határozza meg, hogy hány sort lehet nyomtatni az egyes címkékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="5dc5d-499">Ez a beállítás külön ZPL címkét fog okozni a hullámcímkék táblában szereplő mindegyik rekordhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="5dc5d-500">Zárja be a lapot.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-500">Close the page.</span></span>
1. <span data-ttu-id="5dc5d-501">A műveleti ablaktáblán válassza a **Lekérdezés szerkesztése** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="5dc5d-502">A lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-503">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-504">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-505">**Mező:** *Munkatípus*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="5dc5d-506">**Feltételek:** *Kitárolás*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="5dc5d-507">Ez a lekérdezés gondoskodik arról, hogy csak a kitárolás típusú munkasorok legyenek kinyomtatva a címkére, és ne legyenek betárolás típusú munkasorok.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="5dc5d-508">Ha azt szeretné, hogy a fuvarlevél-azonosító kinyomtatása megtörténjen, az **illesztések** lapon válassza ki a **munkasorok** táblát, majd a **szállítmányok** tábláját illessze hozzá.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="5dc5d-509">Zárja be a lekérdezéstervező párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="5dc5d-510">A **nyomtató szövegének elrendezése** gyorslap három szakaszból áll, ahol megadhatja a nyomtató kódját: **fejléc szakasz** , **szövegtörzs** és **lábléc szakasz**.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5dc5d-511">A **Fejléc szakasz** szakaszban a **Címkefejléc** mezőben adja meg a kívánt fejléc kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="5dc5d-512">Ha például Zebra nyomtatókat használ, a következő kódot használhatja.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="5dc5d-513">A **Szövegtörzs szakasz** szakaszban a **Címke szövegtörzse** mezőben adja meg a kívánt szövegtörzs ZPL kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="5dc5d-514">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-514">Here is an example.</span></span>
...
1. <span data-ttu-id="5dc5d-515">A **Szövegtörzs szakasz** szakaszban a **Címke lábléce** mezőben adja meg a kívánt lábléc ZPL kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="5dc5d-516">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="5dc5d-517">Ez a beállítás kinyomtatja az egyes címkék egy példányát.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="5dc5d-518">Ha több példányra van szükség (például egy példány a raklap mindkét oldalára), akkor állítsa be a lábléc **\^PQn** szakaszának **n** értékét a példányok szükséges számára.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="5dc5d-519">Ha például az egyes címkékből négy másolatot szeretne nyomtatni, adja meg: **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="5dc5d-520">A második címke készen áll a használatra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="5dc5d-521">Hozzon létre egy harmadik elrendezésrekordot, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-522">**Címkeelrendezés azonosítója:** *Szünet*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="5dc5d-523">**Leírás:** *Szünetcímke*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="5dc5d-524">A műveleti ablaktáblán válassza a **Mentés** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5dc5d-525">A **nyomtató szövegének elrendezése** gyorslap három szakaszból áll, ahol megadhatja a nyomtató kódját: **fejléc szakasz** , **szövegtörzs** és **lábléc szakasz**.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5dc5d-526">A **Fejléc szakasz** szakaszban a **Címkefejléc** mezőben adja meg a kívánt fejléc ZPL-kódját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="5dc5d-527">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-527">Here is an example.</span></span>
...
1. <span data-ttu-id="5dc5d-528">Ez alkalommal nem kell megadni szövegtörzset.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-528">This time, no body is required.</span></span> <span data-ttu-id="5dc5d-529">Ezért csak írja be a szükséges szöveget az **Lábléc szakasz** szakaszba.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="5dc5d-530">Íme, egy példa.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="5dc5d-531">A harmadik címke készen áll a használatra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5dc5d-532">Ez a harmadik címke egy szünetcímke, amely elválasztóként fog szerepelni a címketekercsek között.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="5dc5d-533">Két hullámcímke típus létrehozása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-533">Create two wave label types</span></span>

1. <span data-ttu-id="5dc5d-534">Ugrás a **Raktárkezelés \> Beállítás \> Dokumentumirányítás \> Hullámcímketípusok** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="5dc5d-535">Hozzon létre egy második rekordot, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-536">**Címke típusa:** *kartondoboz*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="5dc5d-537">**Leírás:** *Kartondoboz*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="5dc5d-538">Hozzon létre egy második rekordot, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-539">**Címke típusa:** *raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="5dc5d-540">**Leírás:** *raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="5dc5d-541">Egységszekvencia-csoportok beállítása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="5dc5d-542">Lépjen a **Raktárkezelés \> Beállítás \> Raktár \> Egységszekvencia-csoportok** részre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="5dc5d-543">Válassza ki vagy hozzon létre egy **Ea Box PL** csoportot.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="5dc5d-544">A **Doboz** sorban állítsa a **Hullámcímketípus** mezőt *Kartondoboz* értékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="5dc5d-545">A **PL** sorban állítsa a **Hullámcímketípus** mezőt *Raklap* értékre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="5dc5d-546">Hullámcímkesablonok létrehozása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-546">Create wave label templates</span></span>

1. <span data-ttu-id="5dc5d-547">Ugrás a **Raktárkezelés \> Beállítás \> Dokumentumirányítás \> Hullámcímkesablonok** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="5dc5d-548">Hozzon létre egy címkesablont, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-549">**Címkesablon neve:** *Kartondobozcímkék*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="5dc5d-550">**Leírás:** *Kartondobozcímkék*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="5dc5d-551">**Hullámlépés kódja:** *Kartondoboz*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="5dc5d-552">**Raktár:** *62*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5dc5d-553">Az **Általános** gyorslapon a **Hullámcímketípus** mezőben válasszon egy értéket, pl. az *Kartondoboz* lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="5dc5d-554">A **Hullámcímkesablon adatai** gyorslapján vegyen fel egy sort, amely a következő beállításokkal rendelkezik:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-555">**Címkeelrendezés azonosítója:** *Kartondoboz*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="5dc5d-556">**Nyomtató neve:** válassza ki a megfelelő ZPL nyomtatót.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="5dc5d-557">**Lekérdezés futtatása:** *Igen* (ez a beállítás nem kötelező, de ajánlott az optimális teljesítmény érdekében.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="5dc5d-558">A műveleti ablaktáblán válassza a **Mentés** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5dc5d-559">Nem kötelező: Ha ügyfélre vonatkozó címkét állít be, akkor egy lekérdezést kell létrehoznia, hogy megkeresse a vevő számláját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5dc5d-560">A **Hullámcímkesablon adatai** gyorslapján válassza a **lekérdezés szerkesztése** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5dc5d-561">Ezután a lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-562">**Tábla:** *Szállítmányok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="5dc5d-563">**Származtatott tábla:** *Szállítmányok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="5dc5d-564">**Mező:** *Számlaszám*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="5dc5d-565">**Feltételek:** Adja meg a megfelelő vevői számlaszámot.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="5dc5d-566">Ha befejezte a munkát, az **OK** gombra kattintva zárja be a lekérdezéstervező párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="5dc5d-567">A műveleti ablaktáblán válassza ki a **Lekérdezés szerkesztése** lehetőséget a lekérdezésszerkesztő párbeszédpanel megnyitásához a teljes címkesablonhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="5dc5d-568">A lekérdezésszerkesztő párbeszédpanelen, a **Rendezés** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-569">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-570">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-571">**Mező:** *Hivatkozási terhelési sor azonosítója (rekord azonosítója)*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="5dc5d-572">**Keresés iránya:** *Növekvő*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5dc5d-573">Adjon hozzá egy második sort, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-574">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-575">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-576">**Mező:** *Szállítmány azonosítója*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="5dc5d-577">**Keresés iránya:** *Növekvő*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5dc5d-578">Az lekérdezésszerkesztő párbeszédablak bezárásához kattintson az **OK** lehetőségre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="5dc5d-579">Egy üzenet jelenik meg, amely a csoportosítás-visszaállítási művelet jóváhagyását kéri.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="5dc5d-580">A folytatáshoz kattintson az **Igen** gombra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="5dc5d-581">A műveleti ablaktáblán válassza ki a **Hullámcímkesablon-csoport** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="5dc5d-582">A **Hullámcímkesablon-csoport** párbeszédpanel azon sorához, ahol a **hivatkozási mező neve** mező a *szállítmányazonosító* értékre van állítva, adja meg a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="5dc5d-583">**Szünet címkéjének nyomtatása:** jelölje be ezt a jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="5dc5d-584">**Címke elrendezésének azonosítója:** Jelöljön ki egy szünetcímkét.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="5dc5d-585">(Például válassza ki az ebben a helyzetben korábban létrehozott *Szünet* címkeelrendezést.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="5dc5d-586">**Nyomtató neve:** Válassza ki a szünet címkéjének nyomtatóját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="5dc5d-587">(A címkék felosztásának céljából általában ugyanaz a nyomtató van kiválasztva, mint a **hullámcímkesablon részletek** gyorslapon.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="5dc5d-588">Más forgatókönyvek azonban lehetségesek.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="5dc5d-589">Abban a sorban, ahol a **hivatkozási mező neve** mező a *hivatkozási rakománysor azonosítójára* van állítva , jelölje be a **címke-összeállítás azonosítója** jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5dc5d-590">Ez a beállítás egy címkesorozatot hoz létre („X 1. kartondoboz”) rakománysoronként az egész hullámban, a munkacsoportosítási beállítástól függetlenül.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="5dc5d-591">Ezt a címksorozatot a címke elrendezésére lehet nyomtatni.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="5dc5d-592">Ezenkívül a különböző szállítmányok címkéit a kiválasztott szünetcímke elválasztja.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="5dc5d-593">Az **OK** gombra kattintva zárja be a **Hullámcímkesablon csoportja** párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="5dc5d-594">Hozzon létre egy második címkesablont, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-595">**Címkesablon neve:** *Raklapcímkék*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="5dc5d-596">**Leírás:** *raklapcímkék*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="5dc5d-597">**Hullámlépés kódja:** *Raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="5dc5d-598">**Raktár:** *62*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5dc5d-599">Az **Általános** gyorslapon a **Hullámcímketípus** mezőben válasszon egy értéket, pl. az *Raklap* lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="5dc5d-600">A **Hullámcímkesablon adatai** gyorslapján vegyen fel egy sort, amely a következő beállításokkal rendelkezik:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-601">**Címkeelrendezés azonosítója:** *Raklap*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="5dc5d-602">**Nyomtató neve:** válassza ki a megfelelő ZPL nyomtatót.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="5dc5d-603">**Lekérdezés futtatása:** *Igen* (ez a beállítás nem kötelező, de ajánlott az optimális teljesítmény érdekében.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="5dc5d-604">A műveleti ablaktáblán válassza a **Mentés** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5dc5d-605">Nem kötelező: Ha ügyfélre vonatkozó címkét állít be, akkor egy lekérdezést kell létrehoznia, hogy megkeresse a vevő számláját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5dc5d-606">A **Hullámcímkesablon adatai** gyorslapján válassza a **lekérdezés szerkesztése** elemet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5dc5d-607">Ezután a lekérdezésszerkesztő párbeszédpanelen, a **Tartomány** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-608">**Tábla:** *Szállítmányok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="5dc5d-609">**Származtatott tábla:** *Szállítmányok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="5dc5d-610">**Mező:** *Számlaszám*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="5dc5d-611">**Feltételek:** Adja meg a megfelelő vevői számlaszámot.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="5dc5d-612">Ha befejezte a munkát, az **OK** gombra kattintva zárja be a lekérdezéstervező párbeszédpanelt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="5dc5d-613">A műveleti ablaktáblán válassza ki a **Lekérdezés szerkesztése** lehetőséget a lekérdezésszerkesztő párbeszédpanel megnyitásához a teljes címkesablonhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="5dc5d-614">A lekérdezésszerkesztő párbeszédpanelen, a **Rendezés** lapon adjon hozzá egy sort a következő beállításokkal.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-615">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-616">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-617">**Mező:** *Hivatkozási terhelési sor azonosítója (rekord azonosítója)*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="5dc5d-618">**Keresés iránya:** *Növekvő*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5dc5d-619">Adjon hozzá egy második sort, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-620">**Táblázat:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-621">**Származtatott tábla:** *Munkasorok*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5dc5d-622">**Mező:** *Szállítmány azonosítója*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="5dc5d-623">**Keresés iránya:** *Növekvő*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5dc5d-624">Az lekérdezésszerkesztő párbeszédablak bezárásához kattintson az **OK** lehetőségre.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="5dc5d-625">Egy üzenet jelenik meg, amely a csoportosítás-visszaállítási művelet jóváhagyását kéri.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="5dc5d-626">A folytatáshoz kattintson az **Igen** gombra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="5dc5d-627">A műveleti ablaktáblán válassza ki a **Hullámcímkesablon-csoport** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="5dc5d-628">A **Hullámcímkesablon-csoport** párbeszédpanel azon sorához, ahol a **hivatkozási mező neve** mező a *szállítmányazonosító* értékre van állítva, adja meg a következő értékeket:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="5dc5d-629">**Szünet címkéjének nyomtatása:** jelölje be ezt a jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="5dc5d-630">**Címke elrendezésének azonosítója:** Jelöljön ki egy szünetcímkét.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="5dc5d-631">(Például válassza ki az ebben a helyzetben korábban létrehozott *Szünet* címkeelrendezést.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="5dc5d-632">**Nyomtató neve:** Válassza ki a szünet címkéjének nyomtatóját.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="5dc5d-633">(A címkék felosztásának céljából általában ugyanaz a nyomtató van kiválasztva, mint a **hullámcímkesablon részletek** gyorslapon.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="5dc5d-634">Más forgatókönyvek azonban lehetségesek.)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="5dc5d-635">Abban a sorban, ahol a **hivatkozási mező neve** mező a *hivatkozási rakománysor azonosítójára* van állítva , jelölje be a **címke-összeállítás azonosítója** jelölőnégyzetet.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5dc5d-636">Ez a beállítás egy címkesorozatot hoz létre („X 1. kartondoboz”) rakománysoronként az egész hullámban, a munkacsoportosítási beállítástól függetlenül.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="5dc5d-637">Ezt a címksorozatot a címke elrendezésére lehet nyomtatni.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="5dc5d-638">Ezenkívül a különböző szállítmányok címkéit a kiválasztott szünetcímke elválasztja.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="5dc5d-639">Számsorozat-bővítések konfigurálása</span><span class="sxs-lookup"><span data-stu-id="5dc5d-639">Configure number sequence extensions</span></span>

<span data-ttu-id="5dc5d-640">A számsorozat-bővítések meghatározott számsorozatok GS1 megfelelőségét vezérlik.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="5dc5d-641">Ez a konfiguráció nem kötelező az aktuális forgatókönyv esetében.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="5dc5d-642">További tájékoztatás és konfigurációs utasítások: [a számsorozat-kiterjesztések konfigurálása](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="5dc5d-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="5dc5d-643">Értékesítési rendelés létrehozása és kiadása a raktárba</span><span class="sxs-lookup"><span data-stu-id="5dc5d-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="5dc5d-644">Ugorjon az **Értékesítés és marketing \> Értékesítési rendelés \> Összes értékesítési rendelés** pontra.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="5dc5d-645">Hozzon létre egy olyan értékesítési rendelést, amelynek beállításai a következők:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="5dc5d-646">**Vevőkód** *US-001*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="5dc5d-647">**Raktár:** *62*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5dc5d-648">Adjon hozzá 2 értékesítésirendelési-sort:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="5dc5d-649">1. értékesítésirendelés-sor:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-649">Sales order line 1:</span></span>

        - <span data-ttu-id="5dc5d-650">**Cikkszám:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="5dc5d-651">**Mennyiség:** *9024*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="5dc5d-652">**Egység:** *ea* (9024 ea = 376 Box = 47 PL)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="5dc5d-653">2. értékesítésirendelés-sor:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-653">Sales order line 2:</span></span>

        - <span data-ttu-id="5dc5d-654">**Cikkszám:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="5dc5d-655">**Mennyiség:** *9016*</span><span class="sxs-lookup"><span data-stu-id="5dc5d-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="5dc5d-656">**Egység:** *ea* (9016 ea = 322 Box = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="5dc5d-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="5dc5d-657">Az itt megadott cikkek és mennyiségek csak példák.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="5dc5d-658">A korábban megadott egységszekvencia-csoportot kell használnia, meg kell határozni a egységátváltást *ea* elemről *Box* elemről *PL* elemre, és rendelkezniük kell készlettel a *62.* raktárban.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="5dc5d-659">További tájékoztatás: [Mértékegység- és készletezési irányelvek](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="5dc5d-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="5dc5d-660">Jelölje ki az 1. értékesítésirendelés-sort.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-660">Select sales order line 1.</span></span> <span data-ttu-id="5dc5d-661">Ezután az **Értékesítési rendelés sora** szakasz **Készlet** menüjében válassza a **Foglalások** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="5dc5d-662">A **Foglalás** lap műveleti ablaktáblán válassza ki az **Adag foglalása** elemet, mjad zárja be az oldalt.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="5dc5d-663">Ismételje meg a 4. és 5. lépést a 2. értékesítésirendelési-sorhoz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="5dc5d-664">Válassza ki a művelet ablaktáblán a **Raktár** lapon a **Kiadás raktárba** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="5dc5d-665">A következő események zajlanak le:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-665">The following events occur:</span></span> 

    - <span data-ttu-id="5dc5d-666">A rendszer feldolgozza a létrehozott szállítmányt a címkenyomtatási lépést tartalmazó sablon használatával.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="5dc5d-667">A címke elrendezése a címke formátumának meghatározására szolgál, az eredmény pedig a címkesablonban kiválasztott nyomtatón kinyomtatott címke lesz.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="5dc5d-668">A hullámcímkék létrehozása és nyomtatása megtörténik.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="5dc5d-669">A címkék számának meg kell egyeznie a kartondobozok számával (ebben a példában 376 dobozcímke az 1. sorhoz, 322 dobozcímke a 2. sorhoz, 47 raklapcímke a 2. sorhoz és két szünetcímke, amely a szállítmány azonosítójával rendelkezik).</span><span class="sxs-lookup"><span data-stu-id="5dc5d-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="5dc5d-670">Létrejön egy új fuvarlevél-azonosító a szállítmányok számára.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="5dc5d-671">Ha beállította a számsorozat-kiterjesztéseket, akkor a hullámcímke-azonosítók az **SSCC-18** számformátumot követik.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="5dc5d-672">A következő lapokon megtekintheti és újranyomtathatja a hullámcímkéket:</span><span class="sxs-lookup"><span data-stu-id="5dc5d-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="5dc5d-673">Minden szállítmány \> Szállítmány adatai</span><span class="sxs-lookup"><span data-stu-id="5dc5d-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="5dc5d-674">Minden rakomány \> Rakomány adatai</span><span class="sxs-lookup"><span data-stu-id="5dc5d-674">All loads \> Load details</span></span>
- <span data-ttu-id="5dc5d-675">Minden hullám</span><span class="sxs-lookup"><span data-stu-id="5dc5d-675">All waves</span></span>
- <span data-ttu-id="5dc5d-676">Hullámcímkék</span><span class="sxs-lookup"><span data-stu-id="5dc5d-676">Wave labels</span></span>
- <span data-ttu-id="5dc5d-677">Hullámcímke előzményei</span><span class="sxs-lookup"><span data-stu-id="5dc5d-677">Wave label history</span></span>

<span data-ttu-id="5dc5d-678">A legtöbb ilyen lap esetében a megfelelő függvényt megtalálhatja, ha ki választja a műveleti ablaktábla **Szállítmányok** lapján a **Kapcsolódó információk** csoport **Hullámcímkék** elemét.</span><span class="sxs-lookup"><span data-stu-id="5dc5d-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
