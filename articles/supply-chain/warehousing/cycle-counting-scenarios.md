...
Az új Warehouse Management mobilalkalmazás használata előtt hozzá kell adni a támogatást a rendszerben. A rendszergazdák használhatják a [funkciókezelési](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) beállításokat a funkció állapotának ellenőrzéséhez, és bekapcsolásához. A **Funkció kezelése** munkaterületen a funkció a következő módon van listázva:
...
1. A **Raktár** gyorslapon állítsa be a következő értékeket:
    ...
    - **Raktárkezelési folyamat használata:** *Igen* (Ez az érték engedélyezi a raktárat a raktárkezelési folyamatok számára.)
