...
> [!NOTE]
> Ez a funkció már elavult. További információért lásd: [Eltávolított vagy elavult funkciók](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
