...
description: Ez a cikk a feltöltési stratégiával kapcsolatban tartalmaz tájékoztatást, és bemutatja, hogyan használható a Feltöltési stratégia mező a hullám igényfeltöltési sablon soraiban a feltöltési funkció kiválasztására.
author: Mirzaab
ms.date: 10/29/2020
ms.topic: article
ms.prod: ''
