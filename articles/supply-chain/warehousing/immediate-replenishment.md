...
description: Ez a témakör azt írja le, hogyan lehet azonnali feltöltést használni a készlet feltöltésére, ha egy hely-irányelvet nem sikerül felosztani a készletre.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
