...
|---|---|---|---|
| Tervezés | [A tervezésoptimalizálás támogatása képesség alapú erőforrás-felosztáshoz](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/planning-optimization-support-capability-based-resource-allocation) | [Ütemezés végtelen kapacitással](../master-planning/planning-optimization/infinite-capacity-planning.md) | Funkciókezelés (*Végtelen kapacitásütemezés a tervezési optimalizáláshoz*) |
