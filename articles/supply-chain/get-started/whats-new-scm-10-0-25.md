...
|---|---|---|---|
| Készlet&nbsp;és&nbsp;logisztika | Veszélyes anyagok fejlesztései | Ezek a fejlesztések a már meglévő veszélyes anyagokra építve segítik a vállalatokat a helyi szabályozások betartásában, amikor a veszélyes anyagokat különböző földrajzi helyekre szállítják. <!-- KFM: Update to 2022w1 link when published -->| Funkciókezelés:<br>*Veszélyes anyagok fejlesztései* |
| Készlet&nbsp;és&nbsp;logisztika | Csomagolási munka a csomagolási állomásokhoz | Ez a funkció nagy mértékben növeli a csomagolási és szállítási műveletek rugalmasságát és rugalmasságát. A csomagolási folyamat során a raktári dolgozók most már az azonos szállítmányhoz és rakományhoz kapcsolódó különálló csomagokat csomagolják és szállítják. Az ugyanannak a szállítmánynak a rendeléssorait nem feltétlenül kell együtt szállítani, ha vannak olyan cikkek, amelyek készen állnak a szállításra. Egyetlen rendelés több csomagba csomagolható és szállítható különböző szállítási időpontokban, így csökkenthető a várakozási idő és hozzáadható az agility.<!-- KFM: Update to 2022w1 link when published --> | Funkciókezelés:<br>*Csomagolási munka a csomagolási állomásokhoz* |
