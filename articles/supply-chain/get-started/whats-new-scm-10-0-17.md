...
description: Ez a témakör olyan funkciókat ismertet, amelyek újak Dynamics 365 Supply Chain Management vagy módosulnak a 10.0.17-es dokumentumban.
author: kamaybac
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
...
Ez a cikk felsorolja azokat a funkciókat, amelyek vagy újak, vagy módosulnak a Microsoft Dynamics 365 Supply Chain Management 10.0.17-es verziójában. Ennek a verziónak 10.0.761 a buildszáma, és a következő módon érhető el:
...
- [Termékszűrők konfigurálása a raktári tranzakciókhoz](../warehousing/filters-and-filter-codes.md)
...
- [Termeléstervezés](../master-planning/planning-optimization/production-planning.md)
...
A Microsoft Dynamics 365 Supply Chain Management 10.0.17 platformfrissítéseket tartalmaz. A további [tudnivalókat lásd a Pénzügyi és műveleti alkalmazások 10.0.17-es verziójának Platformfrissítései (2021. április)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-17.md).
