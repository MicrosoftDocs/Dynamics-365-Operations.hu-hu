...
ms.locfileid: "9429123"
---
# <a name="preview-of-dynamics-365-supply-chain-management-10030-november-2022"></a>A Dynamics 365 Supply Chain Management 10.0.30 előzetes verziója (2022. november)
...
|---|---|---|---|
| Gyártás | [Intelligencia (Intelligence) által tartalmazott berendezések figyelése](/dynamics365-release-plan/2022wave2/finance-operations/dynamics365-supply-chain-management/monitor-equipment-sensor-data-intelligence) | [Belső adatintelligencia honlapja](../sensor-data-intelligence/sdi-home-page.md) | Funkciókezelés:<br>*(Előzetes verzió) Érzékelő-adatintelligencia* |
| Raktárkezelés | Többszintű megkerülések a Warehouse Management mobilalkalmazáshoz <!-- KFM: Add link when RP updates --> | [Elterelések konfigurálása a mobileszközök menüelemeinek lépéseihez](../warehousing/warehouse-app-detours.md) | Funkciókezelés:<br>*Többszintű megkerülések a Warehouse Management mobilalkalmazáshoz* |
...
|---|---|---|
| Gyártásvezérlés | A kiadni tervezett termelési rendeléseken található, kiadáshoz szükséges adatok | Oszlop hozzáadása a kiadáshoz használt **termelési rendelések oldal sortételének aktuális készletmennyiségére**. |
...
A Microsoft Dynamics 365 Supply Chain Management 10.0.30 platformfrissítéseket tartalmaz. A további [tudnivalókat lásd a Pénzügy és műveletek alkalmazások 10.0.30-as verziójának Platformfrissítései (2022. november)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-30.md). <!--KFM: Confirm link -->
