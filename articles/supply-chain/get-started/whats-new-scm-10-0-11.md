...
Ez a témakör a Microsoft Dynamics 365 Supply Chain Management 10.0.11 előzetes változatának új vagy módosított szolgáltatásait írja le. Ennek a verziónak 10.0.464 a buildszáma, és a következő módon érhető el:

- **Előzetes kiadás**: 2020. április
- **Általános elérhetőség (saját frissítés):** 2020. május
- **Automatikus frissítés:** 2020. július
...
- [Készként történő jelentés a feladatkártya-eszközből származó kötegszámokhoz](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/report-as-finished-batch-numbers-job-card-device)
...
A Microsoft Dynamics 365 Supply Chain Management 10.0.11 platformfrissítéseket tartalmaz. További tájékoztatás: [Platform-frissítések az Finance and Operations alkalmazások 10.0.11 verziójához (2020. július)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md).

### <a name="bug-fixes"></a>Hibajavítások

Ha további tájékoztatást szeretne kapni a 10.0.11 részét képező frissítésekben található hibajavításokról, lépjen be a Lifecycle Services (LCS) szolgáltatásokba, és tekintse meg a [Tudásbázis cikket](https://fix.lcs.dynamics.com/Issue/Details?bugId=438264&dbType=3&qc=d7dbe350d53c7743949f6afa556ea8d19b4fc1d3e16824e1a2eef32e0c3b300a).
