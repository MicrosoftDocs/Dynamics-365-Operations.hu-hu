...
description: Ez a témakör olyan funkciókat ír le, amelyek vagy Dynamics 365 Supply Chain Management újak, vagy módosulnak a 10.0.11-ben.
author: kamaybac
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
Ez a cikk a Microsoft Dynamics 365 Supply Chain Management 10.0.11 verziójában új vagy módosult funkciókat sorol fel. Ennek a verziónak 10.0.464 a buildszáma, és a következő módon érhető el:
...
A Microsoft Dynamics 365 Supply Chain Management 10.0.11 platformfrissítéseket tartalmaz. A további [tudnivalókat lásd a Pénzügyi és üzemeltetési alkalmazások 10.0.11-es verziójának Platformfrissítései (2020. július)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md).
