...
A biztonsági készlet minden egyes cikkhez be van **állítva** a cikkfedezeti lapon. A feltöltés különböző típusait különböző fedezeti kódok ábrázolják. (További tájékoztatás: [Biztonsági készlet teljesítése a cikkekhez](safety-stock-replenishment.md).) Minden fedezeti kód azonban **az** **egyes** cikkekhez a Cikkfedezet lap Minimális mezőjében megadott értéket használja. A Minimum mező használata két **fő megközelítéssel alkalmazható**:
...
1. Ugrás az Alaptervezés **beállítása \> biztonsági \> készlet naplónevekkel.**
...
1. Az új sorban állítsa be a következő mezőket:
    ...
    A **Naplótípus mező** írásra van beolvasva, és a *Biztonsági készlet beállítás van beolvasva*.
