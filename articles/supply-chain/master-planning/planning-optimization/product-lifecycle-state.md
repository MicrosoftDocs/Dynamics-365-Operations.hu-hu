...
description: Ez a cikk bemutatja, hogyan lehet kizárni a termékeket az életciklusuk alapján a tervezési optimalizálási funkció használata esetén.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
