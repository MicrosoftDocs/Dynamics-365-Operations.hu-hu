...
Ha egy tervezési kategória alapján hoz létre új terméket, akkor egy *kiadott terméket* és egy kapcsolódó *megosztott terméket* is létre kell hoznia. A kiadott termékekre vonatkozó készenléti irányelvek feloldási módja attól függ, hogy be van-e kapcsolva a *Termék készenléti ellenőrzései* funkció. (További információ a cikk későbbi részén lévő [Készenléti ellenőrzés haszánálata normál termékekhez](#standard-products) szakaszban olvasható.)
...
### <a name="enable-readiness-checks-on-standard-products"></a>Normál termékek készenléti ellenőrzésének engedélyezése

A következő lépésekkel engedélyezheti, hogy a rendszer készenlét-ellenőrzést hajthasson végre a szabványos termékeken.

- Engedélyezze a Tervezési változáskezelés funkciót a [Tervezési változáskezelés áttekintése](product-engineering-overview.md) részben leírtak szerint.
- A [Szolgáltatáskezeléssel](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) kapcsolhatja be a *Termék készenléti ellenőrzései* szolgáltatást.
