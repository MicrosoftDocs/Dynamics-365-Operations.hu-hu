...
## <a name="use-electronic-signatures-to-approve-and-active-boms-and-routes"></a>Elektronikus aláírás használata az aktív és jóváhagyott AKK-ok és útvonalak jóváhagyásához

Az elektronikus aláírások az anyagjegyzékek jóváhagyásához és/vagy aktiválásához, illetve az útvonal-módosítások jóváhagyásához és/**\> vagy aktiválásához a Szervezet felügyelete – Beállítás \> elektronikus aláírási \> elektronikus aláírási követelményeknél oszlhatnak meg**. Ezután győződjön meg róla, hogy a következő elemek mindegyikéhez **Igen az** Aláírás *szükséges beállítás*:

- Tervezési módosítási utasításhoz tartozó termék-anyagjegyzék aktiválása
- Tervezési módosítási utasításhoz tartozó termék útvonalfejléceinek aktiválása
- Tervezési módosítási utasításhoz tartozó termék anyagjegyzékének jóváhagyása
- Tervezési módosítási utasításhoz tartozó termékútvonal jóváhagyása
- DBJ tervezési verziók és DBJ verziók jóváhagyása
- Mérnöki verzió és útvonalverzió jóváhagyása
