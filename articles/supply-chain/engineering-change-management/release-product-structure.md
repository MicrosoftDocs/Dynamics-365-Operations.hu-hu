...
description: Ez a cikk bemutatja, hogy hogyan lehet a termékek műszaki verzióival együtt kiadni a teljes termékszerkezeteket. Így biztosíthatja, hogy a mérnökileg releváns termékadatokat könnyen újra fel lehessen használni a különböző jogi személyekben.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
