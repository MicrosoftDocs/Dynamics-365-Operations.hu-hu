...
description: Ez a cikk bemutatja, hogy hogyan lehet egy vagy több mérnöki vállalatot használni annak biztosítására, hogy a termékek alapadatai központilag létrejönnek és karbantartva legyen. Egy mérnöki vállalat képviseli a mérnöki termékeket birtokló vállalatot, és ez mérnöki szempontból releváns adatait.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
