...
- A **CustomerGroupId** leképezést innen: **CDS &gt; Cél** érvényes értékre kell frissíteni a Finance and Operations megoldásban. Meghatározhat egy alapértelmezett értéket, vagy az érték beállítható egy Értékmegfeleltetés használatával. Az alapértelmezett sablonérték **10**.
- **A cím, ország, terület kódja** kell lennie a pénzügyi és a műveletek. Szinkronizációs hibák elkerülése érdekében alapértelmezett értéket adhat a **CD &gt;Cél** forrású hozzárendelésnek. Az alapértelmezett érték akkor használatos, ha a mező üres, az értékesítési.
