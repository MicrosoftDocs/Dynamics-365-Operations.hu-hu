...
description: Ez a cikk a licencelés részleteit és a vevői portál beállítási útmutatását tartalmazza.
author: Henrikan
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
Miután elvégezte a szükséges licencek megadását, a [kettős írás kezdeti szinkronizálási útmutatóban](../../fin-ops-core/dev-itpro/data-entities/dual-write/enable-entity-map.md) leírtaknak megfelelően beállíthatja a kettős írást.
