...
|Fontos feladatokat           | Elsődleges lapok                         |Népszerű jelentések              |
|--------------------------|---------------------------------------|-----------------------------|
|Szolgáltatási szerződések teljesítése|Szolgáltatási szerződések                     |Szervizrendelés árrése         |
|Vevői kérések kezelése |Szervizrendelések                         |Munkaleírás             |
|                          |Diszpécserközpont                         |Tranzakció - előfizetés   |
|                          |                                       |Előfizetési díj tranzakciói|
