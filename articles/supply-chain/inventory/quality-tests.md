...
description: Ez a témakör azt mutatja be, hogyan lehet teszteket létrehozni, amelyek a Microsoft minőségi rendelésekkel használhatók Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857605"
---
# <a name="quality-management-tests"></a>Minőségbiztosítási tesztek

[!include [banner](../includes/banner.md)]

Ez a témakör azt mutatja be, hogyan lehet teszteket létrehozni, amelyek a Microsoft minőségi rendelésekkel használhatók Dynamics 365 Supply Chain Management.
