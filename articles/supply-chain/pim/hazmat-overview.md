...
description: Ez a cikk áttekintést nyújt a termékinformációk kezelése és a raktárkezelés során a veszélyes anyagok kezelésével és dokumentálával kapcsolatos funkciókról.
author: t-benebo
ms.date: 06/10/2020
ms.topic: overview
ms.prod: ''
...
A veszélyes anyagokra vonatkozó szabályozások és értékek beállításának, valamint az értékeknek a vonatkozó termékekhez való hozzárendelésével kapcsolatos további tudnivalókat lásd a következő cikkekben:
