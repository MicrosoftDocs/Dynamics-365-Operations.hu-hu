...
description: Ez a témakör azt ismerteti, hogyan lehet beállítani olyan termékszám-névnómenknációt, amely felülírja a rögzített [Alaptermékszám - Konfiguráció - Méret - Szín - Stílus] formátumot.
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
