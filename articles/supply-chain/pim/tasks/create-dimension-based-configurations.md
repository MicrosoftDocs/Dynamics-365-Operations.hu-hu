...
1. Kattintson **Konfigurációk karbantartása** elemre a **Műszaki tervezés** műveleti ablaktábláján.
...
1. A listában jelölje meg a kiválasztott sort.
1. A **Konfiguráció** mezőben adjon meg egy értéket.
