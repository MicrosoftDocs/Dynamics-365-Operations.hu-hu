...
A Finance and Operations és a Retail terméknek ugyanaz a tartalomjegyzéke a dokumentumok webhelyen, ami lehetővé teszi az ügyfelek számára, hogy lássák az aktuális témakör kontextusát. Emellett lehetővé teszi a tartalomjegyzék feletti szűrő vezérlőelem használatát a kívánt témakörök megkereséséhez. 

Segítséget más Dynamics 365 termékekre vonatkozó a keresésükkel érhet el, vagy a Dynamics 365 webhely-navigációs elemére kattintva a központi lapon. 
...
A Microsoft feladatútmutató-könyvtárakat a Finance and Operations 2017 decemberi kiadásához szállított. A [Feladat-útmutatók elérése a Súgó ablakból](help-overview.md#accessing-task-guides-from-the-help-pane) szakasz azt mutatja be, hogyan találhatja meg a termékének megfelelő feladat-útmutatókat. 
...
| [Docs.microsoft.com/korábbi verziók](https://docs.microsoft.com/en-us/previous-versions/dynamics/)                                             | A korábbi kiadások tartama.                                                                                                                                                                       |
