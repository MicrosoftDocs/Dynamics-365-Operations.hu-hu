...
- Válassza ki a **Kijelölés** eszközt, hogy lássa, hogy fog kinézni az oldal a kiválasztott elemek elrejtésével. 
...
- Válassza ki a **Bezár** gombot az eszköztár bezárásához és ahhoz, hogy az oldal visszatérjen korábbi interaktív állapotába. 
...
Néhány munkaterület számozott csempét tartalmaz (olyan csempéket, amelyeken számok vannak), amelyeket lehet, hogy az irányítópulton is látni szeretne. A munkaterületen kattintson a jobb gombbal egy csempére, válassza a **Személyre szabás** elemet, majd a **Kitűzés az irányítópultra** lehetőséget. Ha a következő alkalommal a kiválasztott irányítópultra navigál (vagy frissíti az oldalt), láthatja a számot a munkaterület navigációs csempéje alatt az irányítópulton.
...
- **Alkalmazás** – Importálhat vagy kiválaszthat egy személyre szabási beállítást egy vagy több felhasználó számára. Személyre szabás egy vagy több felhasználóra való alkalmazásához válassza ki a szerepkört és a szerepkör felhasználóit, majd válasszon egy meglévő személyre szabást vagy importáljon egy személyre szabási fájlt a kiválasztott felhasználókra történő alkalmazáshoz. A rendszer ellenőrzi a személyre szabást, és alkalmazza az összes kijelölt felhasználóra, amikor azok legközelebb megnyitják a kijelölt lapot.

- **Törlés** – A lap vagy a munkaterület személyre szabása egy vagy több felhasználó esetében is törölhető. Válasszon egy oldalt, hogy megtekinthesse azon felhasználók listáját, akik személyre szabták ezt az oldalt. Ezután válassza ki azokat a felhasználókat, akiknek az adott oldalhoz tartozó személyre szabását törölni kell, majd válassza a **Törlés** elemet. A kiválasztott felhasználók által a kiválasztott lapra vagy munkaterületre alkalmazott valamennyi személyre szabási beállítás törlődik. Ez a művelet nem vonható vissza. Ugyanakkor ha a lapnak vagy a munkaterületnek létezik mentett személyre szabási beállítása, ez a beállítás visszaimportálható.

- **Kezelés felhasználónként** – Válasszon egy felhasználót, hogy megtekinthesse az általa személyre szabott oldalak listáját.  Ezután kiválaszthatja, hogy engedélyezze vagy letiltsa a személyre szabott képességek használatát bizonyos oldalakon vagy az egész rendszerben.  Emellett törölhet, importálhat és exportálhat személyre szabásokat ennek a felhasználónak a számára.

- **Rendszer:** – Itt tudja ideiglenesen letiltani a rendszerben szereplő személyes beállításokat az összes felhasználó számára. Ezzel nem törli a személyre szabásokat, hanem egyszerűen az összes felhasználónál visszaállítja az összes oldalt az alapértelmezett állapotra. Amennyiben később újra engedélyezi a személyes beállításokat, a rendszer minden személyre szabást újra alkalmaz. Véglegesen is törölheti a rendszerben szereplő személyes beállításokat az összes felhasználó számára. A lépés előtt ügyeljen arra, hogy minden személyes beállítást exportáljon, amire később esetleg szükség lehet, mivel később nem lehet visszaállítani a törölt személyes beállításokat. 
