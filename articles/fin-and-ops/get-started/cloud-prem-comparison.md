...
+ Dynamics 365 for Finance and Operations, Enterprise edition (helyszíni)
...
| | SOC 1 1. típusú tanúsítvány| Igen | Nincs |
| Költségkönyvelés | | Igen | Igen |
| | Költségkönyvelés Power BI-tartalomcsomag| Igen | Nincs |
| | Költségkönyvelés munkaterülete mobil alkalmazáshoz| Igen | Nincs |
...
| | Elektronikus jelentés (ER) – LCS-integrálás | Igen | Nincs|
| | Elektronikus jelentés (ER) – SharePoint-integrálás | Igen | Nincs|
...
| | Kiadás külső katalógusba beszerzési igénylésből| Igen | Nincs |
| | Beszerzési kiadások elemzése Power BI-jelentések| Igen | Nincs |
| Termékinformációk kezelése | | Igen | Igen |
| Alaptermékadatok| | Igen | Igen|
| Termelés | | Igen | Igen |
| | Termelési teljesítmény Power BI-jelentések| Igen | Nincs |
| Projektvezetés és könyvelés|  | Igen | Igen |
| Értékesítés| | Igen | Igen |
| | Értékesítési és nyereségességi teljesítmény Power BI-jelentések| Igen | Nincs |
| Biztonság | | Igen | Igen |
