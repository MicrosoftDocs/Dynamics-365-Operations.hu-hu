...
#### [Finance and Operations, Enterprise kiadás 7.3](get-started/whats-new-application-7.3-update.md)
...
#### [Költségobjektum egyenlegének megtekintése (feladat-útmutató)](../supply-chain/cost-management/tasks/view-cost-object-balance.md)
#### [Készletkimutatás és költségobjektumonkénti KPI megtekintése (feladat-útmutató)](../supply-chain/cost-management/tasks/view-inventory-statement-kpi-cost-object.md)
#### [Költségbejegyzés](../supply-chain/cost-management/cost-entries.md)
#### [Költségobjektum költségbejegyzéseinek megtekintése (feladat-útmutató)](../supply-chain/cost-management/tasks/view-cost-entries-cost-object.md)
...
#### [Jelenlegi folyamatban lévő munka állapotának megtekintése egy termelési rendelésen (feladat-útmutató)](../supply-chain/cost-management/tasks/view-current-wip-status-production-order.md)
#### [Az aktív, becsült és realizált költségek összevetése egy termelési rendelésen (feladat-útmutató)](../supply-chain/cost-management/tasks/compare-active-estimated-realized-costs.md)
...
#### Darabjegyzék-számítások költségszámítási táblázat használatával (feladat-útmutatók sorrendben az ismertetőhöz)
##### [Késztermék létrehozása (csak 2016. február)](../supply-chain/cost-management/tasks/create-finished-product-2016-02.md)
##### [Félkész termék létrehozása (csak 2016. február)](../supply-chain/cost-management/tasks/create-semi-finished-product-2016-02.md)
##### [Nyersanyagok létrehozása (csak 2016. február)](../supply-chain/cost-management/tasks/create-raw-materials-2016-02.md)
##### [Anyagjegyzékek létrehozása (csak 2016. február)](../supply-chain/cost-management/tasks/create-boms-2016-02.md)
##### [Útvonalak létrehozása (csak 2016. február)](../supply-chain/cost-management/tasks/create-routes-2016-02.md)
...
## [Adatkezelés](../dev-itpro/data-entities/data-entities-data-packages.md)
...
#### [Adatentitások: Készletgazdálkodás](../dev-itpro/data-entities/data-entities-inventory-management.md)
...
#### [Költségfelosztási irányelv létrehozása és hozzárendelése egy költségellenőrző-egységhez (feladat-útmutató)](../financials/cost-accounting/tasks/create-assign-cost-allocation-policy-cost-control-unit.md)
...
#### [Az alkalmazáscsomag jelentéseinek testreszabása kiterjesztésekkel](../dev-itpro/analytics/customize-app-suite-reports-with-extensions.md)
#### [Az alkalmazáscsomag jelentési adathalmazainak kibontása](../dev-itpro/analytics/expand-app-suite-report-data-sets.md)
...
### [Készletszámlálási folyamatok meghatározása (feladat-útmutató)](../supply-chain/inventory/tasks/define-inventory-counting-processes.md)
...
### [Cikkek és nyersanyagok követése](../supply-chain/inventory/trace-items-raw-materials-inventory-production-sales.md)
...
## [Termelés](../supply-chain/production-control/production-process-overview.md)
...
##### [Termelés feladása](../supply-chain/cost-management/production-posting.md)
#### Árucikkgyártási feladatok
##### [Árucikkgyártási erőforráscsoport meghatározása (feladat-útmutató)](../supply-chain/production-control/tasks/define-discrete-manufacturing-resource-group.md)
##### [Meglévő tevékenység hozzáadása a termelési folyamat verziójához (feladat-útmutató)](../supply-chain/production-control/tasks/add-existing-activity-production-flow-version.md)
##### [A termelési folyamat verziójának inaktiválása (feladat-útmutató)](../supply-chain/production-control/tasks/deactivate-production-flow-version.md)
##### [Lejárati dátum megadása a termelési folyamat verziójához (feladat-útmutató)](../supply-chain/production-control/tasks/define-expiry-date-production-flow-version.md)
##### [Termelési folyamatmodellek meghatározása (feladat-útmutató)](../supply-chain/production-control/tasks/define-production-flow-models.md)
##### [Munkaidő-ütemezési tulajdonságok létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-working-time-scheduling-properties.md)
##### [Munkaidősablonok létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-working-time-templates.md)
##### Termelési rendelés életciklusának kezelése
###### [Termelési rendelés létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-production-order.md)
###### [Termelési rendelés becslése (feladat-útmutató)](../supply-chain/production-control/tasks/estimate-production-order.md)
###### [Termelési rendelés ütemezése (feladat-útmutató)](../supply-chain/production-control/tasks/schedule-production-order.md)
###### [Termelési rendelés kiadása (feladat-útmutató)](../supply-chain/production-control/tasks/release-production-order.md)
###### [Termelési rendelés indítása (feladat-útmutató)](../supply-chain/production-control/tasks/start-production-order.md)
###### [Termelési rendelés jelentése készként (feladat-útmutató)](../supply-chain/production-control/tasks/report-production-order-finished.md)
###### [Termelési rendelés befejezése (feladat-útmutató)](../supply-chain/production-control/tasks/end-production-order.md)
###### [Művelet- és feladatütemezéssel rendelkező termelési rendelés ütemezése (feladat-útmutató)](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
##### [Üzemi erőforrás létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-operations-resource.md)
##### [Erőforrásokhoz rendelt képességek meghatározása (feladat-útmutató)](../supply-chain/production-control/tasks/define-resource-capabilities.md)
##### [Munkaidő és jelenlét bérlistafolyamatának engedélyezése (feladat-útmutató)](../supply-chain/production-control/tasks/payroll-process-time-attendance.md)
##### [Jelentés készként egy azonosítótábla-vezérelt helyre (feladat-útmutató)](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
##### [Jelentéskészítés egy mobil feladatvégző eszközön elért haladásról (feladat-útmutató)](../supply-chain/production-control/tasks/report-progress-mobile-job-device.md)
##### [A biztonsági készlet naplójának használata a minimális fedezet frissítésére (feladat-útmutató)](../supply-chain/production-control/tasks/use-safety-stock-journal-update-minimum-coverage.md)
##### [Dolgozó konfigurálása mobil feladatvégző eszközzel (feladat-útmutató)](../supply-chain/production-control/tasks/worker-mobile-job-device.md)
##### [Mértékegység kezelése (feladat-útmutató)](../supply-chain/pim/tasks/manage-unit-measure.md)

### Lean manufacturing (lean gyártás) 
#### [Lean manufacturing (lean gyártás) áttekintése](../supply-chain/production-control/lean-manufacturing-overview.md)
...
##### [Termelési visszajelzés](../supply-chain/production-control/production-feedback.md)
#### Lean manufacturing (lean gyártási) feladatok
##### [Lean manufacturing (lean gyártás) munkacelláinak meghatározása (feladat-útmutató)](../supply-chain/production-control/tasks/define-lean-manufacturing-work-cells.md)
##### [Lean ütemezési csoportok meghatározása (feladat-útmutató)](../supply-chain/production-control/tasks/define-lean-schedule-groups.md)
##### Termelési folyamatok és tevékenységek a lean manufacturingban (lean gyártásban) 
###### [A termelési folyamat verziójának létrehozása (feladat-útmutatók)](../supply-chain/production-control/tasks/create-production-flow-version.md)
###### [Lean manufacturing (lean gyártási) folyamattevékenységek létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-process-activities-lean-manufacturing.md)
###### [Lean manufacturing (lean gyártási) átviteli tevékenységek létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-transfer-activities-lean-manufacturing.md)
###### [Termelési folyamat és verzió érvényesítése (feladat-útmutató)](../supply-chain/production-control/tasks/validate-production-flow-version.md)
###### [A termelési folyamat verziójának aktiválása (feladat-útmutató)](../supply-chain/production-control/tasks/activate-production-flow-version.md)
###### [Tevékenységkapcsolat létrehozása: Követő (feladat-útmutató)](../supply-chain/production-control/tasks/create-activity-relation-successor.md)
###### [Előd hozzáadása a termelési folyamat tevékenységéhez (feladat-útmutató)](../supply-chain/production-control/tasks/add-predecessor-production-flow-activity.md)
###### [Érték-előállítási folyamat létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-value-stream.md)
##### [Lean igénykövetés az értékesítési rendelésekből (feladat-útmutató)](../supply-chain/production-control/tasks/lean-pegging-sales-orders.md)
##### [Alvállalkozói munkacella létrehozása a lean manufacturing (lean gyártás) számára (feladat-útmutató)](../supply-chain/production-control/tasks/create-subcontracted-work-cell-lean-manufacturing.md)
##### [Kanbanmennyiség-számítási irányelv hozzáadása kanbanszabályhoz (feladat-útmutató)](../supply-chain/production-control/tasks/add-kanban-quantity-calculation-policy-kanban-rule.md)
##### [Kanbanmennyiség-javaslatok kiszámítása (feladat-útmutató)](../supply-chain/production-control/tasks/calculate-kanban-quantity-suggestions.md)
##### [Kanbanszabályok módosítása egy feldolgozási feladat számára (feladat-útmutató)](../supply-chain/production-control/tasks/change-kanban-rules-process-job.md)
##### [Anyagjegyzéksor esemény kanbanszabályának létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-bom-line-event-kanban-rule.md)
##### [Rögzített mennyiségű kanbanszabály létrehozása gyártáshoz (feladat-útmutató)](../supply-chain/production-control/tasks/create-fixed-quantity-kanban-rule-manufacturing.md)
##### [Kanbanszabály létrehozása kanbansoresemény használatával (feladat-útmutató)](../supply-chain/production-control/tasks/create-kanban-rule-kanban-line-event.md)
##### [Kanbanszabály létrehozása minimális készletesemény használatával (feladat-útmutató)](../supply-chain/production-control/tasks/create-kanban-rule-minimum-stock-event.md)
##### [Kanbanszabály létrehozása több tevékenységhez (feladat-útmutató)](../supply-chain/production-control/tasks/create-kanban-rule-multiple-activities.md)
##### [Új kanbanszabály létrehozása egy meglévő kanbanszabály másolásával (feladat-útmutató)](../supply-chain/production-control/tasks/create-new-kanban-rule-duplicating-existing-kanban-rule.md)
##### [Helyettesítő kanbanszabály létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-replacement-kanban-rule.md)
##### [Értékesítési esemény kanbanszabályának létrehozása (feladat-útmutató)](../supply-chain/production-control/tasks/create-sales-event-kanban-rule.md)
##### [Visszavonási kanbanszabály létrehozása (fe (feladat-útmutató)ladat-útmutató)](../supply-chain/production-control/tasks/create-withdrawal-kanban-rule.md)
##### [Kanbanfeldolgozási feladatok végrehajtása (feladat-útmutató)](../supply-chain/production-control/tasks/execute-kanban-process-jobs.md)
##### [Beütemezett kanbanfeladatok mozgatása (feladat-útmutató)](../supply-chain/production-control/tasks/move-scheduled-kanban-jobs.md)
##### [Feldolgozási kanbanfeladat előkészítése, amikor az anyagok elérhetők a munkacellához (feladat-útmutató)](../supply-chain/production-control/tasks/prepare-kanban-job-materials.md)
##### [Feldolgozási kanbanfeladat előkészítése, amikor az anyagok nem érhetők el a munkacellához (feladat-útmutató)](../supply-chain/production-control/tasks/prepare-process-kanban-job-materials-not-available.md)
##### [Kanbanfeladat eltávolítása az ütemezésből (feladat-útmutató)](../supply-chain/production-control/tasks/remove-kanban-job-schedule.md)
##### [Kanbanfeladat állapotának visszaállítása (feladat-útmutató)](../supply-chain/production-control/tasks/revert-kanban-job-status.md)
##### [Kanbanfeladatok ütemezése (feladat-útmutató)](../supply-chain/production-control/tasks/schedule-kanban-jobs.md)
##### [Anyagok átvitele kanbanfeladatokkal (feladat-útmutató)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
##### [Kanbanállapot frissítése (feladat-útmutató)](../supply-chain/production-control/tasks/update-kanban-status.md)
...
##### [Receptúra létrehozása meglévő receptúra másolásával (feladat-útmutató)](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Kötegelt rendelések életciklusa a létrehozástól az indításig (feladat-útmutató)](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Termelési feladatok sorrendje a folyamatgyártáshoz (feladat-útmutató)](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)




## [Termékinformáció-kezelés](../supply-chain/pim/product-information.md)
### [Termékinformációk](../supply-chain/pim/product-information.md)
#### [Termékosztályozási hierarchia létrehozása (feladat-útmutató)](../supply-chain/pim/tasks/create-hierarchy-product-classification.md)
#### [Termék besorolása kategóriahierarchiák segítségével (feladat-útmutató)](../supply-chain/pim/tasks/classify-product-category-hierarchies.md)
...
#### [Konfigurálható termékek attribútum-alapú árképzésének beállítása (feladat-útmutató)](../supply-chain/pim/tasks/set-up-attribute-based-pricing-configurable-products.md)
#### [Anyagjegyzék-számítások](../supply-chain/cost-management/bom-calculations.md)
### [Termékkonfigurációs modellek](../supply-chain/pim/build-product-configuration-model.md)
