...
### [Dynamics 365 for Finance and Operations videók](get-started/videos.md) 
...
### [Szolgáltatási kérelem benyújtása](../dev-itpro/lifecycle-services/submit-request-dynamics-service-engineering-team.md?toc=/fin-and-ops/toc.json)
...
#### [Konfigurációs kulcsok és adatentitások](../dev-itpro/data-entities/config-key-entities.md?toc=/fin-and-ops/toc.json)
...
##### [Szállítói számla áfatartalmának kiszámítása és kiigazítása](../financials/general-ledger/tasks/calculate-adjust-sales-tax-vendor-invoice.md)
...
##### [A kötelezettségek számlaegyeztetésének hitelesítésbeállítása](../financials/accounts-payable/tasks/set-up-accounts-payable-invoice-matching-validation.md)
...
##### [Üzletitevékenység-kimutatás (BAS)](../financials/localizations/apac-aus-business-activity-statement.md)
##### [Jelentési mezők hozzáadása és a BAS elkészítése](../financials/localizations/tasks/add-bas-report-boxes.md)
##### [Alacsony értékű csoport értékcsökkenése](../financials/localizations/apac-aus-low-value-pool-depreciation.md)
##### [BAS-okkódok beállítása](../financials/localizations/tasks/set-up-reason-codes-australia-bas.md)
#### Kína
...
###### [Nap alapú pénzügyi naptár beállítása](../financials/localizations/tasks/apac-ind-day-based-calendar.md)
...
##### [Előlegre jogosultak tranzakciói](../financials/localizations/emea-advance-holders-transactions.md)
...
#### [Számla feldolgozása](../financials/localizations/emea-invoice-processing.md)
...
##### [Féléves értékcsökkenés a további beszerzéseken](../financials/localizations/emea-aut-half-year-depreciation.md)
...
##### [PRODCOM beállítása és karbantartása](../financials/localizations/emea-bel-prodcom-report.md)
...
###### [Féléves értékcsökkenés a tárgyi eszköz értékesítésén](../financials/localizations/emea-cze-half-depreciation-fixed-asset-disposal.md)
###### [Értékcsökkenés felfüggesztése (ünnepek)](../financials/localizations/emea-cze-depreciation-suspension-holidays.md)
###### [Értékcsökkenés módjai tárgyi eszközöknél](../financials/localizations/emea-cze-fixed-assets-depreciation.md)
###### [Előzetes beszerzés feladása](../financials/localizations/emea-pre-acquisition-acquisition-fixed-asset.md)
##### [Időszaki naplók közzététele](../financials/general-ledger/tasks/post-periodic-journals.md)
##### [Aláírók beállítása a nyomtatási képernyőkhöz](../financials/localizations/emea-set-up-signers-for-printing-forms.md)
...
###### [Áfa az értékesítési ajánlatokban](../financials/localizations/tasks/br-00057-brazilian-taxes-sales-quotation.md)
###### [Adóelőlegek ](../financials/localizations/tasks/br-00009-brazilian-withholding-taxes.md)
...
#### Mexikó
##### [Honosítás köre](../financials/localizations/latam-mex-scope.md)
...
### Közel-Kelet
#### [Áfa](../financials/localizations/apac-sau-sales-tax.md)
...
#### [Entitástár karbantartása](../dev-itpro/analytics/entity-store-maintenance.md)
...
#### [Beszerzési rendelések manuális létrehozása](../supply-chain/procurement/purchase-order-creation.md)
...
## [Szolgáltatáskezelés](../supply-chain/service-management/service-management-home-page.md)
### Vevőszolgáltatás beállítása
#### [Szolgáltatási szerződések beállítása](../supply-chain/service-management/service-agreement-groups.md)
##### [Szolgáltatási szerződések létrehozása](../supply-chain/service-management/create-service-agreements.md)
##### [Szolgáltatás intervallumai](../supply-chain/service-management/service-intervals.md)
##### [Szolgáltatás intervallumainak beállítása](../supply-chain/service-management/set-up-service-intervals.md)
##### [Időablakok](../supply-chain/service-management/time-windows.md)
##### [Időablakok létrehozása](../supply-chain/service-management/create-time-windows.md)
##### [Szolgáltatássablon-csoport létrehozása](../supply-chain/service-management/create-service-template-group.md)
#### [Szervizfeladatok beállítása](../supply-chain/service-management/service-tasks.md)
##### [Szervizfeladat-kapcsolatok létrehozása](../supply-chain/service-management/create-service-task-relations.md)
#### [Szolgáltatási tárgyak beállítása](../supply-chain/service-management/service-objects.md)
##### [Szolgáltatási objektumok létrehozása](../supply-chain/service-management/create-service-task-relations.md)
##### [Készletcikkek hozzárendelése a szolgáltatás tárgyához](../supply-chain/service-management/attach-inventory-items-service-objects.md)
##### [A szolgáltatás tárgyainak csoportjai](../supply-chain/service-management/service-object-groups.md)
##### [Sablon beállítása objektumok jelölésére vevőoldalon](../supply-chain/service-management/set-up-template-to-represent-objects-at-customer-site.md)
##### [A szolgáltatás tárgyának kapcsolatai](../supply-chain/service-management/service-object-relations.md)
##### [Szolgáltatásiobjektum-kapcsolat létrehozása](../supply-chain/service-management/create-service-object-relations.md)
##### [Sablon darabjegyzékek](../supply-chain/service-management/template-boms.md)
##### [Sablon darabjegyzék létrehozása](../supply-chain/service-management/create-template-bom.md)
##### [Sablonok csatolása szolgáltatásobjektumokhoz](../supply-chain/service-management/attach-templates-service-objects.md)
#### [Okkódok meghatározása a szervizrendelésekhez](../supply-chain/service-management/reason-codes-service-orders.md)
##### [A szervizrendelések fokozatai](../supply-chain/service-management/service-order-stages.md)
##### [Szervizrendelési fokozatok beállítása](../supply-chain/service-management/set-up-service-order-stages.md)
##### [Okkódok létrehozása](../supply-chain/service-management/create-reason-codes.md)
#### [Szolgáltatási szerződések és előfizetések beállítása](../supply-chain/service-management/service-level-agreements.md)
##### [Eőfizetés eladási árai](../supply-chain/service-management/subscription-sales-prices.md)
##### [Előfizetési csoportok](../supply-chain/service-management/subscription-groups.md)
##### [Előfizetési csoportok beállítása](../supply-chain/service-management/set-up-subscription-groups.md)
##### [Állapot okkódjainak használata](../supply-chain/service-management/use-stage-reason-codes.md)
##### [Szolgáltatási szerződések és projektek integrálása](../supply-chain/service-management/integration-service-agreements-projects.md)
#### [A javításkezelés beállítása](../supply-chain/service-management/repair-management.md)
#### [Vevői visszáru beállítása](../supply-chain/service-management/disposition-and-return-reason-codes.md)
##### [Intézkedési kódok beállítása](../supply-chain/service-management/set-up-disposition-codes.md)
##### [Visszaadási okkódok beállítása](../supply-chain/service-management/set-up-return-reason-code.md)
##### [A visszaadott cikkek kivezetési módjának megadása](../supply-chain/service-management/specify-how-to-dispose-of-returned-items.md)
### [A vevőknek nyújtott szolgáltatások használata](../supply-chain/service-management/working-with-customer-service.md)
#### [Szolgáltatási szerződések teljesítése](../supply-chain/service-management/fulfill-service-agreements-overview.md)
##### [Szerződés kialakítása és megkötése](../supply-chain/service-management/service-agreements.md)
###### [Szolgáltatási szerződések létrehozása](../supply-chain/service-management/create-service-agreements.md)
###### [Szolgáltatási előfizetések](../supply-chain/service-management/service-subscriptions.md)
###### [Szolgáltatási sablonok](../supply-chain/service-management/service-template.md)
###### [Szolgáltatási sablonok sorainak másolása](../supply-chain/service-management/copy-service-template-lines.md)
##### [Szervizrendelés fokozatának módosítása](../supply-chain/service-management/change-service-order-stage.md)
##### Szerződés frissítése és kiértékelése
###### [Darabjegyzéksablonok kezelése tárgykapcsolatokon](../supply-chain/service-management/manage-template-boms-on-object-relations.md)
###### [Szolgáltatási darabjegyzék törlése](../supply-chain/service-management/delete-service-bom.md)
###### [Indexelt eladási árak](../supply-chain/service-management/indexed-sales-prices.md)
###### [Előfizetési díjak napjainak csökkentése](../supply-chain/service-management/reduce-the-days-on-subscription-fees.md)
###### [Csökkentési napok – Példa](../supply-chain/service-management/reduction-days-example.md)
###### [Előfizetési árak frissítése és indexelése](../supply-chain/service-management/update-and-index-subscription-sales-prices.md)
#### [Vevői kérések kezelése](../supply-chain/service-management/fulfill-service-agreements-overview.md)
##### [Szervizrendeléshez kapcsolódó időrögzítés elindítása és leállítása](../supply-chain/service-management/start-and-stop-time-recording-on-a-service-order.md)
##### [Szervizrendelés kezdési időpontjának és tartamának megtekintése](../supply-chain/service-management/view-the-start-time-and-duration-of-a-service-order.md)
##### [Állapot okkódjainak megtekintése](../supply-chain/service-management/view-stage-reason-codes.md)
##### [A szolgáltatásiszint-szerződésnek való megfelelés ellenőrzése](../supply-chain/service-management/view-compliance-with-service-level-agreements.md)
#### Vevői visszáru engedélyezése
##### [Intézkedési kódok és visszaadási okkódok](../supply-chain/service-management/disposition-and-return-reason-codes.md)
##### [Visszáru önköltségi ára és visszáru adagazonosítója](../supply-chain/service-management/return-cost-price-and-return-lot-id.md)
##### [Visszárurendelés visszavonása](../supply-chain/service-management/cancel-return-order.md)
##### [Csererendelés létrehozása egy cikkre vonatkozóan](../supply-chain/service-management/create-item-replacement-order.md)
##### [Visszárurendelés törlése](../supply-chain/service-management/delete-return-order.md)
##### [A visszaadott cikkek továbbadása vizsgálatra](../supply-chain/service-management/pass-returned-items-on-to-inspection.md)
##### [Érkezési napló feladása a visszaküldött termékekhez](../supply-chain/service-management/post-arrival-journal-for-returned-products.md)
##### [Visszaadott cikkek részleges szállításának bevételezése](../supply-chain/service-management/receive-partial-deliveries-returned-items.md)
##### [Visszaadott cikkek bevételezése](../supply-chain/service-management/receiving-returned-items.md)
##### [A visszaadott cikkek bevételezésének rögzítése](../supply-chain/service-management/register-the-receipt-of-returned-items.md)
##### [A visszaadott cikkek vizsgálatának végigvitele](../supply-chain/service-management/take-returned-items-through-inspection.md)
##### [Visszárura vonatkozó csomagjegyzék-frissítés](../supply-chain/service-management/packing-slip-updates-returns.md)
##### [Visszárura vonatkozó számlafrissítés végrehajtása](../supply-chain/service-management/perform-invoice-updates-for-returns.md)
#### Szolgáltatások nyújtása 
##### Szervizrendelések tervezése és felosztása
###### [Szervizrendelések](../supply-chain/service-management/service-orders.md)
###### [Szervizrendelések automatikus létrehozása](../supply-chain/service-management/auto-create-service-orders.md)
###### [A szolgáltatási állapot és az állapotjelző mező közötti kapcsolat](../supply-chain/service-management/service-status-and-progress-field-interaction.md)
###### [Szervizrendelések automatikus létrehozása](../supply-chain/service-management/create-service-orders-automatically.md)
###### [Cikkszükséglet létrehozása szervizrendelésekhez](../supply-chain/service-management/create-item-requirements-service-orders.md)
###### [Szervizrendelés cikkszükségletei](../supply-chain/service-management/service-order-item-requirements.md)
###### [Előfizetési munkafolyamat áttekintése](../supply-chain/service-management/subscription-workflow-overview.md)
###### [Szolgáltatásrendelések kombinálása](../supply-chain/service-management/combine-service-orders.md)
###### [Szolgáltatási előfizetés létrehozása előfizetési csoportból](../supply-chain/service-management/create-service-subscriptions-from-subscription-group.md)
###### [A szolgáltatási szerződéshez csatolt projektek](../supply-chain/service-management/project-attached-to-service-agreement.md)
###### [Szolgáltatási előfizetések létrehozása projektből](../supply-chain/service-management/create-service-subscriptions-from-project.md)
##### Szervizrendelési tevékenységek hozzárendelés
###### [Szolgáltatási tevékenységek](../supply-chain/service-management/service-activities.md)
###### [Diszpécserközpont](../supply-chain/service-management/dispatch-board.md)
###### [Szerviztevékenység-típusok beállítása](../supply-chain/service-management/set-up-service-activity-types.md)
###### [Preferált technikus beállítása](../supply-chain/service-management/set-up-preferred-technician.md)
###### [Kiszálló csoportok beállítása](../supply-chain/service-management/set-up-dispatch-teams.md)
###### [Szervizrendelések prioritásának megállapítása](../supply-chain/service-management/prioritize-service-orders.md)
###### [A szervizrendeléssor állapotának megtekintése](../supply-chain/service-management/view-the-status-of-service-orders.md)
###### [Szolgáltatási tevékenységek figyelése](../supply-chain/service-management/monitor-service-activities.md)
###### [Tevékenységek ismételt hozzárendelése](../supply-chain/service-management/reassign-activities.md)
###### [Változtatások visszavonása egy diszpécserközpontban](../supply-chain/service-management/reverse-changes-in-a-dispatch-board.md)
###### [Hozzá nem rendelt szervizrendelések megtekintése](../supply-chain/service-management/view-undispatched-service-orders.md)
###### [Szolgáltatási darabjegyzék módosítása ](../supply-chain/service-management/modify-service-bom.md)
##### Szolgáltatás nyújtása
###### [Előfizetési tranzakciók jóváírása](../supply-chain/service-management/credit-subscription-transactions.md)
###### [Előfizetési díj tranzakcióinak létrehozása](../supply-chain/service-management/create-subscription-fee-transactions.md)
###### [Előfizetések könyvelése](../supply-chain/service-management/accruing-subscriptions.md)
###### [Szervizrendeléssorok áthelyezése](../supply-chain/service-management/move-service-order-lines.md)
###### [Szervizrendelések érvénytelenítése](../supply-chain/service-management/cancel-service-orders.md)
###### [Szervizrendelések létrehozása manuálisan](../supply-chain/service-management/create-service-orders-manually.md)
###### [Előfizetési bevétel könyvelése](../supply-chain/service-management/accrue-subscription-revenue.md)
###### [Szervizrendelések törlése](../supply-chain/service-management/delete-service-orders.md)
###### [Előfizetési tranzakciók számlázása](../supply-chain/service-management/invoice-subscription-transactions.md)
...
#### [Terhelési kihasználtság ütemezése](../supply-chain/warehousing/schedule-load-utilization.md)
#### [Ütemezés terhelési kapacitása](../supply-chain/warehousing/schedule-workload-capacity.md)
...
### Részleges kiadás és a részleges szállítmány
#### [Szállítási rakomány részleges szállítása](../supply-chain/warehousing/partial-shipping-of-transport-loads.md)
...
#### [Mobileszköz-menüelem beállítása a beszerzési rendelés munkájának befejezéséhez](../supply-chain/warehousing/tasks/set-up-mobile-device-menu.md)
#### [Mobileszköz-menüelem beállítása a bevételezett elemek regisztrálásához](../supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items.md)
...
#### [Vegyes azonosítótábla fogadása a mobileszközön](../supply-chain/warehousing/mixed-license-plate-receiving.md)
...
#### [Raktárkezelési folyamatok frissítése a Microsoft Dynamics AX 2012-ről a Finance and Operations alkalmazásra](../supply-chain/warehousing/upgrade-migration-warehouse-management-processes.md)
### A regisztráció és a betárolás bevételezési jegyei 
