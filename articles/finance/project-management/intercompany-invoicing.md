...
description: Ebben a cikkben tudnivalók és példák találhatóak a projektekre vonatkozó vállalatközi számlázásról.
author: KimANelson
manager: AnnBe
ms.date: 09/14/2017
ms.topic: article
...
ms.locfileid: "2174886"
---
# <a name="intercompany-invoicing"></a>Vállalatközi számlázás

[!include [banner](../includes/banner.md)]

Ebben a cikkben tudnivalók és példák találhatóak a projektekre vonatkozó vállalatközi számlázásról.
...
További tudnivalókért lásd: [Vállalatközi projektszámlázás konfigurálása](tasks/configure-intercompany-project-invoicing.md).
