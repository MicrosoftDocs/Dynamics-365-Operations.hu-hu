...
description: Ez a cikk bemutatja, hogyan lehet adókódokat beállítani a forrásnál levont adóhoz (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
