...
description: Ez a cikk felsorolja a naplók levont adója kiszámításának lépéseit a forrásnál (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863033"
---
# <a name="calculate-tds-on-invoices-using-journals"></a>TDS kiszámítása számlákon naplók segítségével

[!include [banner](../includes/banner.md)]

Ez a cikk felsorolja a naplók levont adója kiszámításának lépéseit a forrásnál (TDS).
