...
description: Ez a témakör információt biztosít az Intrastat árukereskedelemről és esetenként az Európai Unió (EU) országainak/régióinak szolgáltatásairól szóló jelentésekről.
...
Ez a témakör információt biztosít az Intrastat árukereskedelemről és esetenként az Európai Unió (EU) országainak/régióinak szolgáltatásairól szóló jelentésekről. Ez a témakör áttekintést nyújt a jelentéskészítési folyamatról, valamint leírja a szükséges beállításokat és előfeltételeket.
...
### <a name="enter-a-transaction-that-crosses-the-border-of-another-eu-countryregion"></a>Adjon meg egy olyan tranzakciót, amely átlépi egy másik EU-ország/terület határát
...
### <a name="use-the-intrastat-journal-to-generate-information-about-trade-among-eu-countriesregions"></a>Az Intrastat-napló használatával információkat generálhat az EU országok/régiók közötti kereskedelemről.
...
### <a name="use-the-intrastat-journal-to-report-information-about-trade-among-eu-countriesregions"></a>Az Intrastat-napló használatával lehet jelenteni az EU országok/régiók közötti kereskedelemről szóló információkat.
...
| Vegyes költségek | Állítsa be a vegyes költségek kódját, hogy a számlaösszeg, a statisztikai összeg vagy mindkettő tartalmazza azt. A **Költségkódok** oldalon, a **Külkereskedelem** lapon, engedélyezze az **Intrastat számlaérték** -et, hogy a költségek összegét is tartalmazza a számlaérték, és engedélyezze **Intrastat statisztikai érték** -et, hogy a költségek összegét is tartalmazza a statisztikai érték.</br>A további tudnivalókat tekintse át a Tranzakciókódok és a Vegyes költségek példa [szerint](#transaction-codes-and-miscellaneous-charges). |
...
| Raktárkészlet-nyilvántartás | Társítsa a szállítói számlákat a raktárkódokkal adómentességi szám kitöltésére az átmozgatási rendelés átvitelekor.</br>További tájékoztatás: Átviteli rendelés – [példa](#transfer-order).|
...
5. A Név mezőben adja meg az **Összes** **beszerzés/értékesítés** mezőt.
...
4. Állítsa Az Intrastat számla értékét és az Intrastat statisztikai érték beállítását **a** **·** **Külkereskedelmi gyorsnyelven (Foreign Trade FastTab)** Igen **értékre**.
...
5. Ugrás **a Kötelezettségek** > **szállítóihoz –** > **Minden** szállító.
...
12. Válassza **a** **·** **·** **DE-001** et az Általános gyorshivatkozási csoport Hivatkozás szakaszában a Szállítói számla mezőben.

#### <a name="create-a-transfer-order"></a>Átmozgatási rendelés létrehozása

1. Ugrás a **Készletkezelés** > **kimenő rendelés átviteli** > **rendeléséhez**
2. A Műveleti ablaktáblán kattintson az **Új** elemre.
...
4. Válassza a Hozzáadás lehetőséget a Sorok lap **Átátviteli** rendelés **sorai** **gyorslapon.**
5. A **Cikkszám** mezőben válassza ki a **D0001** cikkszámot. Ezt követően az Áthozott **mennyiség mezőbe írja be a** **2-es** adatokat.
...
8. A Szállítás párbeszédpanel Áttekintés lapján, a Frissítés mezőben **válassza** az **Összes** **·** **lehetőséget**.
...
1. Ugorjon a következőre: **Adó** > **Nyilatkozatok** > **Külkereskedelem** > **Intrastat**.
2. A Műveletpanelen válassza az **Átvitel** lehetőséget.
3. Az **Intrastat (Átvitel) párbeszédpanelen állítsa Az Átrendelés lehetőséget Igen, az összes többi beállítást Pedig Állítsa** **Nem** **·** **beállításra**.
4. Válassza az **OK** lehetőséget a tranzakciók átviteléhez, és tekintse át az Intrastat naplót.
...
6. Ugrás **a Kötelezettségek** > **szállítóihoz –** > **Minden** szállító.
...
1. Ugrás a Szervezet **felügyelete** > **–** > **Egységátváltások** > **beállításához**.
2. Az **Osztályközi átalakítások** lapon válassza az Új **lehetőséget**.
3. Válassza **az** **·** **F00007 gombra az Egységátváltás párbeszédpanel Termék** mezőjében.
4. A From **Unit** mezőben válassza ki az **ea** ot.
5. Válassza a GRM lehetőséget a To **egység** **mezőben**.
...
10. Válassza a GRM gombra a Készlet gyorsétét gombra a Készlet szakaszban található **Egység** **·** **·** **mezőben**.
...
2. Válassza ki a listából az **Intrastat** listában.
