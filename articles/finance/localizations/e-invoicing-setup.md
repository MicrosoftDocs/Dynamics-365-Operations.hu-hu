...
A következő ábra bemutatja az elektronikus számlázásbővítmény-funkció fő elemeit.
...
## <a name="set-up-the-electronic-invoicing-add-on-feature"></a>Az Elektronikus számlázásbővítmény-funkció beállítása

A beállítási folyamatot az RCS-környezetben kell végrehajtani. A következő lépések végrehajtásával hozzon létre egy új Elektronikus számlázásbővítmény-funkciót.

1. Jelentkezzen be az RCS-környezetébe.
2. A **Globalizációs funkciók** munkaterületen a **Funkciók** szakaszban válassza ki az **Elektronikus számlázás bővítmény** csempét.
3. Az **Elektronikus számlázásbővítmény-funkciók** lapon válassza az **Importálás** lehetőséget az ER-adatmodell-konfiguráció Globális adattárból való importálásához.
4. A **Hozzáadás** lehetőség kiválasztásával létrehozhatja az Elektronikus számlázásbővítmény-funkciót. Létrehozhatja a funkciót az alapoktól, vagy származtathatja egy létező elektronikus számlázásbővítmény-funkcióból.
...
> [!NOTE]
> Új Elektronikus számlázásbővítmény-funkció létrehozásakor verziószámmal rendelkezik, és az alapértelmezett állapot a **Piszkozat** értékre van állítva .

### <a name="configurations"></a>Konfigurációk

A konfigurációk rendelkeznek az átalakításokhoz szükséges ER-formátumkonfigurációkkal, és a harmadik fél webszolgáltatásaival folytatott kommunikáció során kicserélendő fájlok létrehozásához szükséges beállításokkal. Az Elektronikus számlázásbővítmény-funkciónak a webszolgáltató által biztosított integrációs technikai előírás alapján tetszőleges számú ER-fájlformátum-konfigurációja lehet.

A következő lépések végrehajtásával adjon hozzá ER-formátumokat az új Elektronikus számlázásbővítmény-funkcióhoz.

1. Az **Elektronikus számlázásbővítmény-funkciók** oldalon, a **Konfigurációk** lapon válassza ki a **Hozzáadás** lehetőséget az ER-fájlformátum-konfiguráció Elektronikus számlázásbővítmény-funkcióhoz való hozzáadásához.
...
3. A fájlformátum-konfiguráció módosításához használja a **Formátumtervező** lapot. További információ: [Elektronikus dokumentum-konfigurációk létrehozása](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/analytics/electronic-reporting-configuration).
...
A funkcióbeállítások a kommunikációra és a biztonságra vonatkozó szabályokat egy harmadik fél webszolgáltatásával ágyazzák be. Az Elektronikus számlázásbővítmény-funkció az elérni kívánt üzleti szabály alapján tetszőleges számú funkcióbeállítással rendelkezhet.

A következő lépések végrehajtásával adjon hozzá funkcióbeállításokat az új Elektronikus számlázásbővítmény-funkcióhoz.

1. Az **Elektronikus számlázásbővítmény-funkciók** oldalon, a **Beállítások** lapon válassza ki a **Hozzáadás** lehetőséget a funkcióbeállítások Elektronikus számlázásbővítmény-funkcióhoz való hozzáadásához.
    ...
    > [!NOTE]
    > Amikor az alapoktól hozza létre az Elektronikus számlázásbővítmény-funkciót, akkor manuálisan kell hozzáadnia az összes kívánt funkcióbeállítást. Ha egy meglévő funkcióból származtat egy Elektronikus számlázásbővítmény-funkciót, akkor a rendszer automatikusan létrehozza az összes funkcióbeállítást, mivel ezek az eredeti Elektronikus számlázásbővítmény-funkcióból öröklődnek.
...
Az Elektronikus számlázásbővítmény környezethez társítani, és engedélyezni is kell az Elektronikus számlázásbővítmény-funkciót. Az Elektronikus számlázásbővítmény környezeteket előzetesen létre kell hozni, és közzé kell tenni a szervezet RCS-fiókjának Globalizációs funkciók konfigurációján keresztül.

Az Elektronikus számlázásbővítmény környezet Elektronikus számlázásbővítmény-funkcióhoz való engedélyezéséhez kövesse az alábbi lépéseket.

1. Az **Elektronikus számlázásbővítmény-funkciók** oldalon, a **Környezetek** lapon válassza ki az **Engedélyezés** lehetőséget egy Elektronikus számlázásbővítmény környezet hozzáadásához.
...
Az Elektronikus számlázásbővítmény-funkció több szervezet között is megosztható.

- Az **Elektronikus számlázásbővítmény-funkciók** oldal **Szervezetek** lapján válassza ki a **Megosztás vele:** lehetőséget ahhoz, hogy hozzáadhassa azt a szervezetet, amellyel meg szeretné osztani az Elektronikus számlázásbővítmény-funkciót.

Ha nem szeretné többé megosztani a szervezettel az elektronikus számlázásbővítmény-funkciót, akkor válassza ki a **Megosztás visszavonása** lehetőséget.
...
1. Az **Elektronikus számlázásbővítmény-funkciók** oldalon, a bal oldali rácsban válassza ki az Elektronikus számlázásbővítmény-funkciót.
2. A **Verziók** lapon válassza az **Új** lehetőséget, ha új verziót szeretne hozzáadni az Elektronikus számlázásbővítmény-funkcióhoz.

### <a name="change-the-status-of-the-electronic-invoicing-add-on-feature"></a>Az Elektronikus számlázásbővítmény-funkció állapotának módosítása

A következő lépések végrehajtásával kezelheti az új Elektronikus számlázásbővítmény-funkció életciklusát.
...
3. A program megkéri, hogy erősítse meg, hogy az Elektronikus számlázás-bővítmény funkciót és annak összes összetevőjét szeretné befejezni. A művelet megerősítéséhez válassza az **Igen** lehetőséget, a visszavonásához pedig a **Nem** lehetőséget.

    > [!NOTE]
    > Ha az **Igen** lehetőséget választja, akkor a konfigurációverziók állapota – amely az Elektronikus számlázás-bővítmény funkció összetevője – automatikusan átvált a **Piszkozat** értékről **Befejezett** értékre.

4. Válassza ki az **Állapot módosítása** lehetőséget, majd a **Befejezett** értékről állítsa **Közzététel** értékre az állapotot.
5. A program megkéri, hogy erősítse meg, hogy az Elektronikus számlázás-bővítmény funkciót és annak összes összetevőjét szeretné közzétenni a Globális adattárban. A művelet megerősítéséhez válassza az **Igen** lehetőséget, a visszavonásához pedig a **Nem** lehetőséget.
