...
7. A Regisztrációtípus **részletei párbeszédpanel** Név **mezőjébe** írja be az új regisztrációtípus nevét. Például adja meg a **Regont**.
...
3. A munkaablakban válassza ki a **regisztrációs edd-eket**.
...
4. A Város **mezőben** adja meg a Mezőjét **.**
...
7. A Beállítás **szakasz** Általános **gyorsgombgombján** **állítsa** a Folytonos lehetőséget Nem beállításra.**·**
...
1. Hozzon létre egy szállítási módot.
    ...
    4. A Leírás **mezőbe** írja be a **Átviteli gombra.**
...
1. Menjen a **Követelések** > **Ügyfelek** > **Minden ügyfél** pontra.
2. A rácsban válassza a **DE-016 et**.
3. Ellenőrizze a **Számla és szállítás** gyorsétét az **Áfa** szakaszban, **·** **hogy az Adószám mező beállítása DE9012- e.**
...
10. A Külkereskedelem lap Sor részletei gyorslapján ellenőrizze, **·** **hogy a Tranzakciókód mező 11-e**,**·** **az** Árucikk mező beállítása 100 200 30, **az Származási ország/** **terület mező beállítása POL.** **·** **·**
...
15. A Fájlformátum-megfeleltetés szakaszban ellenőrizze, **hogy a Nyilatkozat típusa** mező beállítása **Deklaráció**.**·**
16. A Bizonylat **létrehozásának városa mezőbe** írja be **a Bizonylat létrehozása mezőt**.
17. A Dokumentum **létrehozásának dátuma** **mezőben válassza a 2021** . 19. 10-et (2021. október 19.).
18. A Bizonylat **no mezőjébe** írja be a **11-et**.
19. A Dokumentumverzió **mezőbe** írja be a **22-est**.
...
4. A Webhely **mezőben** válassza az **1 lehetőséget**.
...
13. Írja be **a** **·** **·** **00010 számot a Szállítói számla fejlécének gyorskódok mezőjéBen a Számlaazonosító szakasz Szám mezőjébe.**
...
11. A Fájlformátum-megfeleltetés szakaszban ellenőrizze, **hogy a Nyilatkozat típusa** mező beállítása **Deklaráció**.**·**
12. A Bizonylat **létrehozásának városa mezőbe** írja be **a Bizonylat létrehozása mezőt**.
13. A Dokumentum **létrehozásának dátuma** **mezőben válassza a 2021** . 19. 10-et (2021. október 19.).
14. A Bizonylat **no mezőjébe** írja be a **11-et**.
15. A Dokumentumverzió **mezőbe** írja be a **22-est**.
16. Válassza **az OK** gombra, és tekintse át a jelentést a létrehozott XML-formátumban. A következő táblázat a példajelentésben szereplő értékeket mutatja.
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>A dokumentummal kapcsolatos információk</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Vállalat adatai</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>A jóra vonatkozó információk</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Kapcsolattartó adatai</strong></p>
    </td>
    </tr>
    <tr>
    <td>
