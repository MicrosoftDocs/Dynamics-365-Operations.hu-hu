...
description: Ez a cikk bemutatja, hogyan lehet adókódokat beállítani az adószámítási szolgáltatásban.
author: wangchen
ms.date: 11/30/2021
...
ms.locfileid: "8862928"
---
# <a name="set-up-tax-codes"></a>Adókódok beállítása

[!include [banner](../includes/banner.md)]

Ez a cikk bemutatja, hogyan lehet adókódokat beállítani az adószámítási szolgáltatásban. Egy egyszerű helyzet beállítását is tartalmazza az adókódok munkához, illetve információk az összetett helyzetekben használható speciális adókód-funkciókról.

> [!IMPORTANT]
> Az adószámítási szolgáltatásban az adókódok beállítása jogi személy–nem független. Ezt a beállítást csak egyszer lehet végrehajtani az RCS (Regulatory Configuration Service) szolgáltatásban. Az adókódok szinkronizálása Microsoft Dynamics automatikusan megtörténik a 365 Pénzügy űrlapon, amikor engedélyezi a kiválasztott jogi személy adószámítási szolgáltatását a Pénzügyben.
...
Ha a Bruttó **összeg alapján lehetőséget** **választja** a Számítás eredete mezőben, az adó összegét a bruttó értékesítési összeg százalékaként számítja ki a program. A bruttó összeg a **sor** nettó összege plusz a sor összes adója és díja, kivéve azt az adót, amelyben a Számítás eredete **mező beállítása Bruttó összeg**.
...
### <a name="by-quantity"></a>Mennyiség szerint
...
Az alapadat-keresés engedélyezhető a Mentességi **kód mezőben**. Így választhat a Pénzügyben megadott mentességi kódértékek közül. Az alapadat-keresés engedélyezéséről az Alapadat-keresés [engedélyezése az adószámítási konfigurációban található](tax-service-set-up-environment-master-data-lookup.md).
...
A további tudnivalókat lásd [az Árak adószámítása, ha az árak tartalmazzák az adókat](global-exclude-from-tax-base-amount-calculation.md).
