...
description: Ez a cikk bemutatja, hogy hogyan lehet beállítani a forrásnál levont adó (TDS) jogi személyek regisztrációs számát.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8859737"
---
# <a name="set-up-tds-registration-numbers-for-legal-entities"></a>Jogi személyek TDS-regisztrációs számának beállítása

[!include [banner](../includes/banner.md)]

Ez a cikk bemutatja, hogy hogyan lehet beállítani a forrásnál levont adó (TDS) jogi személyek regisztrációs számát.
