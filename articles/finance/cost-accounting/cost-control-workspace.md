...
description: Ez a cikk a Költségellenőrzés munkaterületről nyújt tájékoztatást. Ez a munkaterület központi pont, ahol a menedzserek, akik felelősek egy költségobjektum vagy egy költségobjektum-készlet egy dimenzióban vagy dimenziókon belüli vezérléséért, hozzáférhetnek a jelentésekhez.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
