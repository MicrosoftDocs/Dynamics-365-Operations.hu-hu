...
description: Ez a témakör a tárgyieszköz-tranzakciók létrehozására használható különböző módszereket ismerteti.
author: moaamer
ms.date: 08/10/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8883358"
---
# <a name="fixed-asset-transaction-options"></a>Tárgyieszköz-tranzakciók beállításai

[!include [banner](../includes/banner.md)]

Ez a témakör a tárgyieszköz-tranzakciók létrehozására használható különböző módszereket ismerteti.
