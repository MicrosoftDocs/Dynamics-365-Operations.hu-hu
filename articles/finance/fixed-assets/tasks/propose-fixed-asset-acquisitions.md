...
Ez a témakör leírja, hogyan szerezhető be tárgyi eszköz a Tárgyi eszközök naplójában található Beszerzési javaslat segítségével. Ez a könyvelői szerepkört és a bemutató adatokat használja a USMF jogi személyhez.

1. A navigációs ablaktáblán nyissa meg a **Modulok > Tárgyi eszközök > Naplóbejegyzések > Befektetett eszközök naplója** elemet.
...
7. Válassza a **Szűrő** elemet. A korábbi értékek törléséhez kattintson az **Alaphelyzetbe állítás** pontra.
