...
description: Ez a cikk bemutatja, hogy hogyan lehet beállítani az elektronikus jelentéssel az pozitív fizetést.
author: panolte
ms.date: 03/20/2022
ms.topic: article
ms.prod: ''
...
Ez a cikk bemutatja, hogyan lehet beállítani az elektronikus jelentés segítségével az pozitív fizetést és a fizetési fájlokat.
