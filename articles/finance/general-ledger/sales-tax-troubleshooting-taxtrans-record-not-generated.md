...
description: Ez a témakör olyan hibaelhárítási információkat tartalmaz, amelyek segítséget nyújtnak, ha egy TaxTrans rekordot nem generálnak.
author: qire
ms.date: 04/13/2021
ms.topic: article
ms.prod: ''
