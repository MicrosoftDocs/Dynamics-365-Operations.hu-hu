...
> [!NOTE]
> Egyes országokban vagy régiókban egyes tranzakciótípusok esetén az ilyen tranzakciótípusokhoz kapcsolódó mezőkből is lehet szöveget tartalmazni. A tranzakciótípusok és az országok és régiók listája tekintetében lásd: [Választható: Szövegek más alapértelmezett leírások](#optional-add-other-text-to-default-descriptions) szakasz a témakör későbbi részében.
