...
<tr>
<td><strong>Likviditási számla a kifizetésekhez</strong></td>
<td>Válassza ki <strong>a pénzforgalmi előrejelzésekhez</strong> használt likviditási főkönyvi számlát. Ez a mező csak akkor jelenik meg, ha engedélyezve vannak a pénzforgalmi előrejelzések.</td>
</tr>
<tr>
<td><strong>Áfaelőlegek</strong></td>
<td><p>Válassza ki az előre törlesztett kifizetések forgalmi adójának számlaszámát.</p>
<p><strong>Megjegyzés:</strong>  A Kinnlevőségek <b></b> paraméterei lapon adja meg azt a feladási profilt, amely akkor használatos, amikor egy kifizetés előlegként van megjelölve.</p>
</td>
</tr>
<tr>
...
Az alábbi táblázat példákat mutat be az alapértelmezett feladási típusokra a minta fő számlákkal és leírásokkal. A **Tartozik/Követel** oszlop jelzi, hogy a tranzakciót általában Tartozik vagy Követel tételek, vagy bizonyos esetekben fel lehet-e majd adja fel. Az **Elszámolószámla** oszlopban a feladás típusa elszámolószámla. Ez azt jelenti, hogy egy későbbi tranzakció feladása során a program automatikusan sztornírozi az erre a számlára feladott összeget. 
