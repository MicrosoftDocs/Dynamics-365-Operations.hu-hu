...
ms.locfileid: "8872586"
---
# <a name="deferral-default-transactions"></a>Halasztás alapértelmezett tranzakciói

Ez a témakör olyan tranzakciókat ír le, amelyek bevétel- és kiadás halasztásokat engedélyeznek. A halasztások ütemezése mindig egy eredeti dokumentumon vagy számlázási ütemezésen alapul, és attól függ. A halasztások ütemezésének létrehozása az alapértelmezések alapján történik, és nem lehet külön megadni vagy létrehozni.
