...
A legpontosabb költségtervezési tervezés érdekében létrehozhat előre jelzett beosztásokat létező beosztásokból származó részletes adatok használatával a rendszerben, függetlenül attól, hogy a beosztás jelenleg be van-e töltve vagy nem. 
...
[![„Kompenzációs csoport hozzárendelése” grafikon](./media/graphic4.png)](./media/graphic4.png) 
