...
description: Ez a témakör azt írja le, hogyan jelez előre a pénzforgalmi előrejelzési funkció a szervezet adott időpontban várható készpénzpozícióját. Leírja a különböző időszakok előrejelzésének megjelenítésére használható beállításokat is.
