...
Egy költségobjektum egyenlegének mások költségobjektumokhoz rendeléséhez használatos egy felosztási alap alkalmazásával. A Finance and Operations a reciprokális felosztási módszert támogatja. A reciprokális felosztási módszer esetében a segédköltség-objektumok által kicserélt kölcsönös szolgáltatások teljes mértékben elismertek. A rendszer automatikusan meghatározza a felosztások végrehajtásának sorrendjét, majd végigmegy rajtuk. A költségobjektumok egyenlegének felosztása egyetlen felosztási alap szerint történik. A rendszer támogatja a költségobjektum-dimenziók és a hozzájuk tartozó tagok közötti felosztásokat. A felosztás sorrendjét a költség ellenőrzőegysége vezérli.
...
|  Statisztikai dimenziótagok | Igen  | Nincs  | Nincs  |
