...
# <a name="customer-transaction-list-page"></a>Vevői tranzakciók listája oldal
...
1. Válassza a **Kinnlévőségek \> Ügyfelek** lehetőséget.
2. Válasszon ki egy vevőt, amelyekhez tranzakciók tartoznak, majd válassza a **Vevő \> Tranzakciók** lehetőséget.
3. Válasszon egy tranzakciót a kutatáshoz
4. Válassza ki a **Kiegyenlítések megjelenítése** lapot a műveleti panelen.

    A **Kiegyenlítések megjelenítése** párbeszédpanel mutatja a kijelölt tranzakciót minden dokumentumot, amelyek ki lettek egyenlítve vele szemben. Ezen a párbeszédpanelen hasonlít a kiegyenlítési előzmények nézetre, de az összes kapcsolódó dokumentumot tartalmazza. 
