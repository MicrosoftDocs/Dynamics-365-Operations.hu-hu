...
- <span data-ttu-id="2f504-109">Az áfakódok leírásának nyomtatásához az értékesítési számlákra, szabadszöveges számlákra vagy projektszámla-jelentésekre, állítsa be az adózási irányelv áfakódokra vonatkozó hivatkozásszövegét.</span><span class="sxs-lookup"><span data-stu-id="2f504-109">To print a description of sales tax codes on a sales invoice, free text invoice, or project invoice report, set up the Tax Directive reference text on the sales tax codes.</span></span>
- <span data-ttu-id="2f504-110">A jóváírások esetében az eredeti számla számát és dátumát a javítás okával együtt nyomtatja a rendszer.</span><span class="sxs-lookup"><span data-stu-id="2f504-110">For credit notes, the number and date of the original invoice are printed along with the reason for correction.</span></span>
