...
# <a name="synchronize-project-contracts-and-projects-from-project-service-automation-directly-to-project-contracts-and-projects-in-finance-and-operations"></a>Projektszerződések és projektek szinkronizálása a Project Service Automation alkalmazásból a Finance and Operations projektszerződéseibe és projektjeibe
...
> [!NOTE]
> Mielőtt használhatná a Project Service Automation és Finance and Operations integrációs megoldást, meg kell ismerkednie a Dynamics 365 adatintegrációs funkciójával.
...
| Rendeléssorok                      | Integrációs entitás projektszerződéssorhoz.          |
...
Microsoft Power Query-t kell használnia az adatok szűréséhez, ha teljesülnek a következő feltételek:
