...
3. Az Áfacsoport kód mezőbe írjon be egy értéket.
...
11. Zárja be a lapot.
12. Ugorjon az Adó > Közvetett adók > Áfa > Áfakódcsoportok pontra.
13. Kattintson az Új lehetőségre.
14. A Cikkáfacsoport kód mezőbe írjon be egy értéket.
