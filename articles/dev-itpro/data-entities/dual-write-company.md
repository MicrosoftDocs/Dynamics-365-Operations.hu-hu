...
A Microsoft Dynamics 365 for Finance and Operations alkalmazásban a *vállalat* koncepciója egyszerre jogi fogalom és üzleti fogalom. Mindemellett adatok biztonsági és láthatósági határa is. A felhasználók mindig egyetlen vállalat kontextusában dolgoznak, és az adatok nagy részét vállalat szerint van kezelve.

A Common Data Service nem rendelkezik ezzel egyenértékű koncepcióval. A legközelebbi koncepció a *részleg*, amely elsősorban biztonsági és láthatósági határ a felhasználói adatok számára. Ez a fogalom nem rendelkezik ugyanazokkal a jogi vagy üzleti vonatkozásokkal, mint a vállalat koncepciója a Finance and Operations megoldásban.

Mivel a részleg és a vállalat nem egyenértékű fogalmak, nem lehetséges egy-az-egyhez (1:1) leképzés kényszerítése hozzájuk a Common Data Service integráció céljából. Mivel azonban a felhasználóknak alapértelmezés szerint meg kell tudniuk tekinteni ugyanazokat a rekordokat a Finance and Operations és a Common Data Service magoldásokban, a Microsoft egy új entitást vezetett be a Common Data Service megoldásban, amelynek neve cdm\_Company. Ez az entitás egyenértékű a Vállalat entitással a Finance and Operations alkalmazásban. Annak garantálására, hogy a rekordok láthatósága alapértelmezetten megegyezzen a Finance and Operations és a Common Data Service között, a következő beállításokat javasoljuk a Common Data Service adatai számára:
...
+ Alapértelmezés szerint a Finance and Operations megoldásban létrehozott, és a a Common Data Service szolgáltatásban duplán írt rekordok tulajdonosa a hozzárendelt részleghez kapcsolódó „DW Owner” csoport.
...
+ Csak a vállalati adatokat tartalmazó rekordok alkalmasak a Finance and Operations és a Common Data Service közötti kettős írásra.
