...
Ez a témakör a hely- és raktáradatok integrációját ismerteti a Finance and Operations és a Common Data Service között. Az üzemeltetési helyszínek és a raktárak közös fogalmak az ellátásilánc-kezelési alkalmazásban. Ezek a vállalat ellátási láncának modellezésére használatosak.
...
## <a name="operational-sites"></a>Üzemeltetési helyek

A működésihelyek a következő hozzárendelések segítségével érhetők el a Common Data Service szolgáltatásban.
...
## <a name="warehouses"></a>Raktárak

A raktárak a következő hozzárendelések segítségével érhetők el a.
