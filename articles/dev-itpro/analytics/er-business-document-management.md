...
Az Excel vagy Word formátumú sablonoknak a Microsoft Office asztali alkalmazások segítségével történő szerkesztéséhez az üzleti dokumentumkezelés használatával a Microsoft Office 2010 vagy újabb verziót kell telepítenie. Ez a Finance and Operations felhőalapú és helyszíni verziójában is támogatott.
...
Az üzleti dokumentumok sablonokat tartalmazó ER-konfigurációkat importálnia kell az aktuális Finance and Operations példányba. A következő fájlok letöltésével és helyben történő tárolásával hajthatja végre ezt a műveletet.
...
Az új funkciók aktiválásával kapcsolatos további tudnivalókat lásd [Funkciókezelés áttekintése](../../fin-and-ops/get-started/feature-management/feature-management-overview.md).
...
A szükséges dokumentumkezelési paraméterek és dokumentumtípusok beállításával kapcsolatos tudnivalókat lásd: [Dokumentumkezelés konfigurálása.](../../fin-and-ops/organization-administration/configure-document-management.md).
...
1. Az **Üzleti dokumentum paraméterei** lapjához való hozzáféréssel rendelkező felhasználóként jelentkezzen be a Finance and Operations alkalmazásba.
...
1. A **Hozzáférési engedélyek konfigurátora** laphoz való hozzáféréssel rendelkező felhasználóként jelentkezzen be a Finance and Operations alkalmazásba.
...
1. Az Üzleti dokumentumok kezelése munkaterülethez való hozzáféréssel rendelkező felhasználóként jelentkezzen be a Finance and Operations alkalmazásba.
...
Megnyílik **BDM sablonszerkesztő** lap a Finance and Operations alkalmazásból. A kiválasztott sablon elérhetővé válik az online szerkesztéshez a Office 365 használatával.
...
1. A Finance and Operations szolgáltatásban módosítsa a vállalatot **USMF** értékre.
...
2. Ha az **OK** gombra kattint a közzététel megerősítéséhez, akkor a származtatott **Customer FTI report (GER) másolat** ER formátum amely a módosított sablont tartalmazza, befejezettként lesz megjelölve. A módosított sablon elérhetővé válik a Finance and Operations többi felhasználója számára. Az ER formátum befejezett verziói csak a sablon legutóbbi aktív felülvizsgálatát fogják megtartani. A többi változat törölve lesz. Egyéb lehetőségek megismeréséhez válassza a **Mégsem** lehetőséget.
...
Ez egy ismert probléma Office 365 és a Finance and Operations átirányításával kapcsolatosan. Ez akkor fordulhat elő, ha első alkalommal jelentkezik be az Office 365 rendszerbe. A hiba megkerüléséhez válassza a böngészőben a **Vissza** gombját a Finance and Operations megoldásba történő visszatéréshez.
...
Valószínűleg olyan Azure AD tartományból jelentkezett be a Finance and Operations megoldásba, amely eltér a Finance and Operations ezen példányának telepítéséhez használt Azure AD tartománytól. Mivel a SharePoint szolgáltatás, amely sablonokat tárol az Office asztali alkalmazásokkal történő szerkesztésre, a program ugyanazon tartományhoz tartozik, mint a Finance and Operations nincs jogosultságunk a SharePoint szolgáltatás eléréséhez. A probléma megoldásához a megfelelő Azure AD tartománnyal rendelkező felhasználó hitelesítő adataival jelentkezzen be az aktuális Finance and Operations példányba.
