...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs"></a>Formátum létrehozása dokumentumkezelési fájlok használatára formátumkimenetekben
