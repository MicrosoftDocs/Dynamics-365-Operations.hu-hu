...
## <a name="register-connected-dynamics-365-for-finance-and-operations-application"></a>Összekapcsolt Dynamics 365 for Finance and Operations alkalmazás regisztrálása
1. Zárja be a lapot. 
2. Zárja be a lapot. 
