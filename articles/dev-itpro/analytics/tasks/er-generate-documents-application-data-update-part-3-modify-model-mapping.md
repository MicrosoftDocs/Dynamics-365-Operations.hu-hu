...
---
# <a name="modify-model-and-mapping-to-generate-documents-with-application-data"></a>Modell és feltérképezés módosítása dokumentumoknak alkalmazásadatokkal történő létrehozásához
