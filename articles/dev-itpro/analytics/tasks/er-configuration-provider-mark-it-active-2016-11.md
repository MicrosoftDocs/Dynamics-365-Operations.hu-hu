...
---
# <a name="create-a-configuration-providand-mark-it-as-active-for-electronic-reporting-er"></a>Konfigurációszolgáltató létrehozása és megjelölése aktívként az elektronikus jelentéskészítéshez (ER)
...
4. A Név mezőbe írja be a „Litware, Inc.” nevet.
    * Litware, Inc.  
5. Az internetcím mezőbe ezt írja be: http://www.litware.com.
