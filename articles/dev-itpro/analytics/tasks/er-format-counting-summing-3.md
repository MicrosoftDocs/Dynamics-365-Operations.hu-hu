...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Számítások használata a számlálás és összegzés kimenetéhez az elektronikus jelentéskészítéshez (ER)
