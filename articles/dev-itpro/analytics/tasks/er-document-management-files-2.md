...
---
# <a name="extend-data-model-to-use-document-management-files-in-format-outputs"></a>Adatmodell kiterjesztése dokumentumkezelési fájlok használatához formátumkimenetekben
