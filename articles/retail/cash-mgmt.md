...
1. Lépjen a **Kiskereskedelem \> Csatorna beállítása \> Pénztár beállítása \> Pénztárprofilok \> Funkcióprofilok** menüpontra, és válasszon ki egy olyan működési profilt, amely azokhoz az üzletekhez van kapcsolva, amelyekre vonatkozóan elérhetővé szeretné tenni a készpénzgazdálkodás fejlesztéseit.
...
3. A széfek beállításához nyissa meg **Kiskereskedelem \> Csatornák \> Kiskereskedelmi üzletek \> Összes kiskereskedelmi üzlet** pontot, és válasszon az üzletek közül.
...
- Amikor egy felhasználó egy műszak zárását választja, a Retail ellenőrzi, hogy nincsenek-e nem egyeztetett készpénzgazdálkodási tranzakciók a műszakban. A felhasználó nem zárhatja le a műszakot, amíg nem egyeztetett tranzakciók vannak.
