...
A pénztárfelhasználó nyelvének beállítása a **Minden dolgozó** részben történik a **Dolgozó** lapon, a **Kiskereskedelem &gt; Nyelv** alatt.  Ez nem a fő profil lapon. POS nem használja ezt a beállítást. A felhasználó nyelve nincs beállítva, vagy a változó értéke egy nyelvet Ha fordítások nem állnak rendelkezésre, ha az üzlet nyelv visszaáll a POS-nál.  
