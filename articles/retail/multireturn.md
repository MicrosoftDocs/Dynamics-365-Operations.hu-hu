...
## <a name="configure-retail-to-support-returns-across-multiple-customer-order-and-invoices"></a>A Retail konfigurálása a több vevői rendelést és számlát érintő visszáruk támogatásához
