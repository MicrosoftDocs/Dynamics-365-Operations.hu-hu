...
A **Kiskereskedelem \> Központ beállítása \> Paraméterek \> Kiskereskedelmi paraméterek** oldalon lépjen a **Vevői rendelések** lapra. A **Költségek** gyorslapon állítsa a **Speciális automatikus költségek használata** beállítást **Igen** értékre.
...
Ha speciális automatikus költségek engedélyezve vannak, a meglévő **Kiskereskedelmi paraméterek**, amelyek a **Szállítási költségek kódja** és **Szállítási költségek visszatérítése** pontokhoz tartoznak, nem használatosak. Ezek a paraméterek csak akkor érvényesek, ha a **Speciális automatikus költségek használata** paraméter értéke **Nem**.
...
Küldje el a módosításokat a Retail Server/csatorna-adatbázishoz, hogy a pénztár használhassa őket a **1040 elosztási ütemezés** feladat futtatásával.
...
Küldje el a költségeket a Retail Server/csatorna-adatbázishoz, hogy a pénztár használhassa őket a **1040 elosztási ütemezés** feladat futtatásával.
...
- **Sor szállítási költségei** – Ez a sorszintű elem az olyan specifikus költségkódok összefoglalására hazsnálatos, amelyeket az értékesítési sorra alkalmaztak. Itt csak az olyan költségkódok jelennek meg, amelyet **Szállítási** költségként jelöltek meg a **Költségkód** oldalon.
