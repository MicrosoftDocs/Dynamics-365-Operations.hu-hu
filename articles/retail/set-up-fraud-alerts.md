...
A **Rendelés teljesítésének engedélyezése** opció konfigurálásán túlmenően a csalásellenőrzési funkciót a hívásközpont paraméterei között is konfigurálnia kell. Lépjen ide: **Kiskereskedelem**\>**Csatorna beállításait**\>**Hívásközponti beállítása**\>**Hívásközponti paraméterei**. A **Hívásközponti paraméterei** oldalon, a **Várakoztatás** lapon állítsa a **Csalásellenőrzés** opciót **Igenre**.
