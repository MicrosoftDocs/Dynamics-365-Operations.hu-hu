...
| Funkció            | Leírás |
|---------------------|-------------|
| Normál              | Használja a **Normál** funkciót a fizetési módon, amikor olyan kifizetési módokat ad meg, mint a készpénz vagy a bizonylatok. Az ilyen típusú fizetések értékesítési rendelésre alkalmazásakor a hívásközpont, azonnal fel lesznek adva előlegként a vevői számlára. Az előlegbizonylat a vevői tranzakciók előzményeinél lesz feladva, ahol rendszeresen elszámolják az értékesítési rendelés számlájával szemben a számla létrehozásakor. |
| Csekkes               | Használja a **Csekk** funkciót, ha a fizetés formájaként határozza meg a banki csekk eszközt. Ha ezt a kifizetési típust alkalmazzák egy értékesítési rendelésre, a felhasználónak az kifizetésalkalmazás feldolgozásának részeként meg kell adnia a vevő csekkszámát. A csekkes fizetést mindig előlegként kezeli a program, ha alkalmazzák. Ahogy a **Normál** kifizetési funkció esetében, ezeket az előlegbizonylatokat rendszeresen elszámolják az értékesítési rendelés számlájával szemben a számla létrehozásakor. |
