...
description: Ez a cikk a Pénzügy és műveletek (Dynamics 365) mobilalkalmazást ismerteti, és hivatkozásokat tartalmaz a szervezetben való implementációt segítő erőforrásokra.
author: ChrisGarty
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
