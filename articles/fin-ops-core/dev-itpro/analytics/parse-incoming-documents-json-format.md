...
description: Ez a cikk bemutatja, hogyan lehet beállítani az elektronikus jelentési (ER) formátumokat a bejövő dokumentumok JavaScript object Notation (JSON) formátumban történő feldolgozásához.
author: kfend
ms.date: 05/20/2019
ms.topic: article
ms.prod: ''
