...
description: Ez a cikk bemutatja, hogy hogyan használhatók a vállalatközi adatforrások az elektronikus jelentéskészítésben (ER).
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
- [ER modellkonfiguráció - CrossCompanyDataAccessModel.xml](https://download.microsoft.com/download/4/2/5/4258f891-7054-4821-aedd-3721ba25fdd5/CrossCompanyDataAccessModel.xml)
- [ER-formátumkonfiguráció - CrossCompanyDataAccessFormat.xml](https://download.microsoft.com/download/3/2/1/321deb75-3ba9-4323-99bf-207a52c60b5c/CrossCompanyDataAccessFormat.xml)
