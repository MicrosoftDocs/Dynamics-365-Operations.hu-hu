...
4. Figyelje meg, hogy a kiválasztott **BACS (UK)** ER-formátumon kívül más szükséges ER-konfigurációk importálása is megtörtént. Győződjön meg arról, hogy a konfigurációs fában a következő ER-konfigurációk érhetők el:
    ...
    - **Fizetési modell** – ez a konfiguráció a fizetési üzleti tartomány adatszerkezetét képviselő ER adatmodell-összetevőt tartalmazza.
    - **Fizetési modell megfeleltetése 1611** – ez a konfiguráció tartalmazza a modell-hozzárendelés ER összetevőjét, amely leírja, hogyan kell az adatmodellt futásidőben kitölteni az alkalmazás adataival.
    - **BACS (UK)** – ez a konfiguráció az ER-összetevők formátum- és formátum-hozzárendelését tartalmazza. A formátum összetevő meghatározza a jelentés elrendezését. A formátumleképezési összetevő tartalmazza a modell-adatforrást, és meghatározza, hogy a jelentés elrendezését milyen módon kell kitölteni ennek az adatforrásnak a használatával futásidőben.
