...
4.  <span data-ttu-id="3679d-162">Az **Excel-tartomány** mezőbe írja be: **CompanyURL_Value**.</span><span class="sxs-lookup"><span data-stu-id="3679d-162">In the **Excel range** field, enter **CompanyURL_Value**.</span></span>
