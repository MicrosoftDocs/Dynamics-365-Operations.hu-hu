...
description: Ez a cikk magyarázatot ad a Microsoft Dynamics 365 Pénzügy pénzügyi jelentésének megtekintésére és létrehozására.
author: jcart1106
ms.date: 11/21/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9799518"
---
# <a name="view-and-design-financial-reports"></a>Pénzügyi jelentések tervezése és megtekintése

[!include [banner](../includes/banner.md)]

Ez a cikk magyarázatot ad a Microsoft Dynamics 365 Pénzügy pénzügyi jelentésének megtekintésére és létrehozására. A pénzügyi jelentések egyrészt az alkalmazáson belüli megtekintésből, másrészt az egy kattintással használható jelentéstervezőből állnak, amellyel pénzügyi jelentéseket hozhat létre és szerkeszthet.
...
7. Módosítsa az alapévet 2021-re és válassza a **Létrehozás** opciót. Amikor jelentés kerül létrehozásra a jelentés tervezőből, a böngészőben új lapon fog megnyílni. Böngészheti a jelentést az új böngésző lapon, vagy átválthat az eredeti böngésző lapra és megnyithatja a jelentést onnan a **Pénzügyi jelentések** listából történő kiválasztással.
...
11. Válassza ki ugyanazon vagy egy másik számlát és a **Bizonylati tranzakciók megnyitása** opciót. A bizonylat tranzakciók a kiválasztott számlára vonatkozó időszak, év és a számla + dimenzió kombináció szerint kerül szűrésre. A Bizonylattranzakciók **közül** választhat, hogy egyéb információkat is fel tud-e tárni a tranzakcióval kapcsolatban.
12. Bizonylattranzakciók **bezárása**. Egy pénzügyi jelentésen belül megtekintheti az adatokat egy eltérő időszakra és évre, vagy különböző attribútumokat és dimenziókat alkalmazva. Ez a **Jelentés beállítások** használatával hajtható végre.
...
15. Írja be **a 001-et** a mezőbe, és válassza az **OK gombra**. A jelentés most már kizárólag a 001 Üzleti egység adatait jeleníti meg. Ez egy testreszabott nézete a jelentésnek, és mások számára nem megtekinthető.
16. Zárja be a szűrt jelentést. A pénzügyi jelentések bármilyen pénznemben megjeleníthetők, amelyet hozzáadtak az alkalmazáshoz.
...
4. Válassza **a fájlt**, majd **mentse másként,** és nevezze el a jelentést **a részletes próbaegyenleget attribútumokkal**.

    > [!NOTE]
    > Bármikor frissül a pénzügyi jelentések listája, **amikor** új jelentést hoz létre a jelentéstervezőben.
...
Ebben a gyakorlatban meglévő alapértelmezett jelentést fog módosítani. Egy jelentési fát hoz létre, és egy jelentésdefiníciót ad hozzá a **költségközpont/részleg eredményki kimutatásának létrehozásához**. Ha elkészültek a frissítések, létrehozhatja a **Költségközpont/Divízió** kimutatást, és a jelentés fa segítségével fedezheti fel a jelentést. A pénzügyi jelentések listájáról **indulunk** .
...
6. A Költségközpont kivételével minden dimenzió jelölőnégyzetének **jelölése.**
...
8. **A** költségközpontok névvel **mentheti az eredményül kapott fát.** Most, hogy a jelentési fa létrehozásra került, módosítani fogja a jelentési fát úgy, hogy tartalmazzon három új összesítő egységet; Marketing, Műveletek és Kiskereskedelem.
9. Az **Ablak** menüben kattintson a **Költséghelyek részleg szerint** elemre. (Ha a jelentési fa le van zárva, válassza ki a **Jelentési fa definícióit** a navigációs ablakban.)
...
23. Kattintson a **Szolgáltatási műveletek** elemre a grafikus kijelzőn. Nyomja meg és tartsa lenyomva az egér bal oldali gombját amíg felhúzza az egységet a **Műveletek** elemhez. Engedje fel a bal egérgombot az egységnek a Műveletek összesítőjébe való beleejtéséhez. Ismételje meg a **Termelés**, a **Minőség-ellenőrzés**, a **Logisztika**, a **Beszerzés** és az **Adminisztráció** esetében .
...
29. Módosítsa az alapévet a **2021** értékre, **mentse** a módosításokat és **hozza létre** a jelentést. A jelentés létrehozásának és megnyitásának befejeződése után böngészhet a jelentésben.
...
5. Módosítsa az alapévet a következőre: 2021.
...
A következő gyakorlatban fog létrehozni új jelentés. A jelentés akkor egymás mellett megyei eredménykimutatásban. Használni egy korábbi sordefiníciót fog, de új jelentésdefiníciót és új oszlopdefiníció használó dimenzió szűrők létrehozása. A pénzügyi jelentések listájáról **indulunk** .
...
8. A párbeszédpanel **Egyéni vagy tartomány** szakaszában · kattintson az **Űrlap** mező **három pontjára** a részlegek listájának megjelenítéséhez.
...
16. Módosítsa az alapévet a következőre: **2021**.
...
[Pénzügyi jelentéskészítés](../../../finance/general-ledger/financial-reporting-getting-started.md)
