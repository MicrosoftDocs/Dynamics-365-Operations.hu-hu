...
A kiválasztott tárolási séma alkalmazásához az összes ER-konfiguráció címkéinek a jelenlegi Finance-példányban való tartásához hajtsa végre a következő lépéseket.
