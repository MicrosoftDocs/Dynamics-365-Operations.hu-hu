...
## <a name="ActivateAdvEditor">A speciális receptúraszerkesztő aktiválása</a>
...
## <a name="Autoformatting">Kód automatikus formázása</a>
...
## <a name="CodeCompletion">Kódkiegészítés</a>
...
## <a name="CodeNavigation">Kódnavigáció</a>
...
## <a name="CodeStructuring">Kód strukturálása</a>
...
## <a name="FindAndReplace">Keresés és csere</a>
...
## <a name="DataPasting">Az adatforrások és a funkciók beillesztése</a>
...
## <a name="SyntaxColorization">Szintaxis szerinti színezés</a>
