...
description: Ez a témakör ismerteti, hogy mi szerepel a Raktár teljesítménytartalomban Power BI.
author: Mirzaab
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8851922"
---
# <a name="warehouse-performance-power-bi-content"></a>Raktári teljesítmény Power BI tartalom

[!include [banner](../includes/banner.md)]

Ez a témakör ismerteti, hogy mi szerepel a Raktár **teljesítménytartalomban** Microsoft Power BI. Leírja, hogy hogyan kell hozzáférni a Power BI-jelentésekhez, és információkat nyújt a tartalomcsomag összeállításához korábban használt entitásokkal és adatmodellekkel kapcsolatban.
