...
description: Ez a témakör ismerteti, hogyan lehet új elektronikusjelentés-modell-hozzárendelési konfigurációkat tervezni, és a beépített ER-funkciókat használni a hatékony összesített számításokhoz.
author: NickSelin
ms.date: 12/12/2017
