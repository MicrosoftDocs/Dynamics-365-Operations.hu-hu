...
description: Ez a témakör azt mutatja be, hogyan lehet olyan konfigurációkat tervezni, amelyek beágyazott képeket tartalmazó Excel- és Word-formátumban generálnak elektronikus dokumentumokat.
author: kfend
ms.date: 04/23/2021
