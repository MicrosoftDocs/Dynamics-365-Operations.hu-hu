...
Emellett le kell töltenie és helyben mentenie kell a következő fájlokat: [Dynamics 365 Finance elektronikus jelentéskészítés példák](https://go.microsoft.com/fwlink/?linkid=862266): 1099model.xml, 1099formatcsv.xml, 1099entriescsv.csv.
...
5. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..*` csomópontot.
...
6. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case` csomópontot.
...
7. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Header: Sequence 1..1` csomópontot.
...
8. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)` csomópontot.
...
9. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\TransactionDate: DateTime` csomópontot.
...
10. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\CountryCode: String 0..1` csomópontot.
...
11. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\Remark: Sequence 1..1 (,)` csomópontot.
...
12. A fastruktúrában válassza ki a `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Unparsed: Sequence 1..1` csomópontot.
...
6. A fastruktúrában bontsa ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)` csomópontot.
7. A fastruktúrában bontsa ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)` csomópontot.
8. A fastruktúrában bontsa ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)` csomópontot.
9. A fastruktúrában bontsa ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data` csomópontot.
10. A fastruktúrában bontsa ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\CountryCode: String 0..1 (CountryCode)` csomópontot.
11. A fastruktúrában válassza ki a `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\TransactionDate: DateTime(TransactionDate)` csomópontot.
