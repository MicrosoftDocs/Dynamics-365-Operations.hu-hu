---
title: Az XML-elemek végrehajtásának elhalasztása az ER-formátumokban
description: Ez a cikk bemutatja, hogyan lehet elhalasztni egy XML-elem végrehajtását az elektronikus jelentés (ER) formátumban.
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
Az Elektronikus jelentéskészítési [(ER)](general-electronic-reporting.md)[keretrendszer](./tasks/er-format-configuration-2016-11.md) Művelettervezője segítségével konfigurálhatja egy XML-formátumú kimenő dokumentumok előállításához használt ER-megoldás formátumösszetevőjét. A konfigurált formátum-összetevő hierarchikus szerkezete különböző típusú formátumelemeket tartalmaz. Ezek a formátumelemek a létrejövő dokumentumok kitöltéséhez használhatók a szükséges információval, futásidőben. Alapértelmezés szerint, amikor egy ER-formátumot futtat, a formátum elemeit ugyanabban a sorrendben futtatja a rendszer, ahog a formátumhierarchiában vannak: egyesével, fentről lefelé haladva. A tervezéskor azonban bármikor módosíthatja a konfigurált formátum-összetevő bármely XML-elemének végrehajtási sorrendjét.
...
Ha még nem fejeződött [be az ER-formátumokban szekvenciaelemek végrehajtásának elhalasztása példáját,](er-defer-sequence-element.md#Example)[töltse le az ER-minta](general-electronic-reporting.md#Configuration) megoldás következő konfigurációit.
