...
Ez a cikk bemutatja, hogyan tölthetők [le az Elektronikus jelentéskészítés (ER)](general-electronic-reporting.md#Configuration) konfigurációi a konfigurációs szolgáltatás globális tárházból. További tájékoztatás: [Microsoft Dynamics 365 Finance - Regulatory Services, Configuration Service](/business-applications-release-notes/october18/dynamics365-finance-operations/regulatory-service-configuration).
