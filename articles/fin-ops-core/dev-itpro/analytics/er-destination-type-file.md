---
title: Fájl ER céltípusa
description: Ez a témakör információkkal szolgál egy fáljcélhely konfigurálásáról az ER-formátumhoz.
author: NickSelin
manager: AnnBe
ms.date: 01/27/2020
ms.topic: article
...
ms.locfileid: "4679630"
---
# <a name="file-destination"></a>Fájl célja

[!include [banner](../includes/banner.md)]

Beállíthat egy fájlcélt a kimenő dokumentumok létrehozásához konfigurált elektronikus jelentési (ER) formátumú fájlok MAPPA vagy FÁJL összetevőihez. A célhely beállítása alapján a webböngészőből letölthető egy generált dokumentum.
