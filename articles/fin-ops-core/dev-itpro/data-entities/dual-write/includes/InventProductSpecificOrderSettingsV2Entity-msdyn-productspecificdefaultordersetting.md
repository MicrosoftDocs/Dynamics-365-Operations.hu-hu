## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Az msdyn_productspecificdefaultordersettings alapértelmezett V2 termékrendelési beállításai
