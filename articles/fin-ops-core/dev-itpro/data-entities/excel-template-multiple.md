...
description: Ez a témakör azt mutatja be, hogyan lehet adatokat importálni az Excel-adatentitás-sablonok segítségével a pénzügyekbe és műveletekbe.
author: peakerbl
ms.date: 01/01/2018
ms.topic: article
ms.prod: ''
