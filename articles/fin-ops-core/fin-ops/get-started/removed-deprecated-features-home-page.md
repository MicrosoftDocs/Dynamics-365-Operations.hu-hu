...
## <a name="removed-or-deprecated-features-in-finance-and-operations-apps"></a>Eltávolított vagy elavult funkciók a Finance and Operations alkalmazásokban
Az alábbi témakörök a Finance and Operations alkalmazások eltávolított és elavult funkcióival kapcsolatban tartalmaznak tájékoztatást:

- [Eltávolított vagy elavult funkciók a Dynamics 365 Commerce szolgáltatásban](../../../commerce/get-started/removed-deprecated-features-commerce.md)
...
A következő témakör a Microsoft Power Platform rendszerben elavult funkciókról nyújt információkat.

- [Fontos változások (elavult funkciók) a Power Apps, a Power Automate rendszerekben és az ügyfélkapcsolati alkalmazásokban](/power-platform/important-changes-coming)