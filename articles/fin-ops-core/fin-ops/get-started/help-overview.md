...
description: Ez a témakör áttekintést nyújt a Pénzügy és műveletek súgórendszerről.
author: edupont04
ms.date: 07/20/2021
ms.topic: overview
ms.prod: ''
...
A docs.microsoft.com webhely ([docs.microsoft.com/dynamics365/](/dynamics365/)) a termékdokumentáció alapértelmezett forrása az imént felsorolt alkalmazásokhoz. Ez a webhely a következő funkciókat ajánlja:
...
Ha a Pénzügy és műveletek alkalmazáson keresztül a docs.microsoft.com tartalomra vonatkozó összes frissítésre szeretne előfizetést használni, használja a következő hivatkozásokat:
...
- [Ellátási lánc](/api/search/rss?$filter=scopes%2fany(t%3A%20t%20eq%20%27dynamics365-supplychain%27)&locale=en-us)  
- [Tehetség](/api/search/rss?$filter=scopes%2fany(t%3A%20t%20eq%20%27dynamics365-talent%27)&locale=en-us)  
...
A további tudnivalókat lásd a [Docs közreműködői útmutatóban](/contribute), amelyet a docs.microsoft.com webhelyét összeállító csoport publikál.
