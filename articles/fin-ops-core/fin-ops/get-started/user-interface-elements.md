...
description: Ez a témakör ismerteti az alkalmazás felhasználói felületének elemeit.
author: tlefor
ms.date: 08/09/2019
ms.topic: article
ms.prod: ''
...
Ez a témakör ismerteti a felhasználói felületnek az alkalmazásban használt elemeit. Mielőtt a felhasználók navigálni tudnak a kezelőfelületen, fontos tudni a felületet alkotó elemek neveit és funkcióit.
