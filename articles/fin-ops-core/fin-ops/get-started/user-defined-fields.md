...
description: Ez a cikk bemutatja, hogyan hozhat létre egyéni mezőket a felhasználói felületen, hogy a program testre szabja az alkalmazásokat.
author: jasongre
ms.date: 05/24/2021
ms.topic: article
ms.prod: ''
