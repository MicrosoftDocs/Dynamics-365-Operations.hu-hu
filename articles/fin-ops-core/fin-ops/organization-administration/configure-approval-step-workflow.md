...
description: Ez a cikk bemutatja a jóváhagyási lépés tulajdonságainak konfigurálját.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Ez a cikk bemutatja a jóváhagyási lépés tulajdonságainak konfigurálját.
