...
description: Ez a cikk bemutatja a munkafolyamatok különféle tulajdonságainak konfigurálját.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
Ez a cikk bemutatja a munkafolyamatok különféle tulajdonságainak konfigurálját.
