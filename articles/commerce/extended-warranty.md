---
title: Kiterjesztett garanciák létrehozása és konfigurálása
description: Ez a cikk a kiterjesztett garanciákra vonatkozik, és bemutatja, hogyan lehet létrehozni és konfigurálni őket Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268368"
---
# <a name="create-and-configure-extended-warranties"></a>Kiterjesztett garanciák létrehozása és konfigurálása

[!include [banner](includes/banner.md)]

Ez a cikk a kiterjesztett garanciákra vonatkozik, és bemutatja, hogyan lehet létrehozni és konfigurálni őket Microsoft Dynamics 365 Commerce.
...
1. Lépjen a **Kiskereskedelem és kereskedelem \> Termékek és kategóriák \> Garancia \> Garanciacsoportok** helyre.
