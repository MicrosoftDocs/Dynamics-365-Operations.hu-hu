...
[Webalkalmazás regisztrálása az Azure Active Directory B2C alkalmazásban](https://docs.microsoft.com/azure/active-directory-b2c/tutorial-register-applications?tabs=app-reg-ga#register-a-web-application)
