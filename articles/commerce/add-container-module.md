...
A tárolómodul egy modul, amely a többi modult tárolja. Ez a Dynamics 365 Commerce alkalmazásban használt legáltalánosabb tároló. A tárolómodul elsődleges célja, hogy a számára beállított tulajdonságokon keresztül meghatározza a benne található modulok elrendezését. Ezek a modulok például egymás mellett kétoszlopos, háromoszlopos, négyoszlopos vagy hatoszlopos elrendezésében jelenhetnek meg. A tárolók szélességére korlátozódhatnak, vagy kitölthetik a képernyőt. Minden tárolómodulhoz hozzáadhat egy fejlécet is.

A tárolómoduloknak három típusa van: tároló, tároló 2 hellyel és tároló 3 hellyel. Bármilyen típusú modult el lehet helyezni ezekben a tárolókban. Léteznek speciális típusú tárolómodulok is, például forgótár, tartalomgazdag blokk, tartalomelhelyezés, kosár, fizetés, vásárlásmező, fejléc és lábléc. Ezeknek a tárolóknak konkrét rendeltetésük van, és csak a különböző támogatott típusú modulok helyezhetők el bennük.

Javasoljuk, hogy a modulokat tárolóban helyezze el, hogy azok a konténerek szélességére korlátozódjanak.
...
1. A tárolómodulban adjon hozzá funkciómodult.
...
1. A tárolómodul tulajdonságlapján adja meg az **Oszlopok száma** tulajdonságnak az **1**, a **Szélesség** tulajdonságnak pedig a **Tárolóhoz igazított** értéket.
1. A tárolómodulban adjon hozzá funkciómodult.
1. A funkciómodul tulajdonságlapján konfigurálja a fejlécet.
...
1. A tárolómodulban adjon hozzá két további funkciómodult.
1. Mentse a lapot, és tekintse meg az előnézetét. Most három egymás mellett megjelenő funkciómodult kell látnia.
1. Miután elérte a kívánt elrendezést, végezte a kívánt elrendezést, adja be és tegye közzé a lapot.
