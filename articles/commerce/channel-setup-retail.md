...
description: Ez a témakör azt ismerteti, hogyan lehet új kiskereskedelmi csatornát létrehozni a következőben:Microsoft Dynamics 365 Commerce
author: samjarawan
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8847732"
---
# <a name="set-up-a-retail-channel"></a>Retail-csatorna beállítása

[!include [banner](includes/banner.md)]

Ez a témakör azt ismerteti, hogyan lehet új kiskereskedelmi csatornát létrehozni a következőben:Microsoft Dynamics 365 Commerce
