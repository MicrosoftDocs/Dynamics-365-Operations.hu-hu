...
A következő táblázatban a Modern POS és a Cloud POS rendszerekben rendelkezésre álló műveleteket találja. A tábla azt is meghatározza, hogy az alkalmazásban hol lehet meghívni a műveleteket, és hogy elérhetők-e, ha a POS offline módban van.
