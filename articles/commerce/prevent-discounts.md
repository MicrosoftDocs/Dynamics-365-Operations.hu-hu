...
A következő opciók, amelyek a kiadott termékek **Commerce** lapján találhatók, lehetővé teszik a termék konfigurálását az összes vagy a manuális kedvezmények megakadályozása érdekében. A beállítások kategóriaszinten is meghatározhatók a kiskereskedelmi kategóriák hierarchiájából.
