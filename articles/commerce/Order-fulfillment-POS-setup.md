---
title: Rendelésteljesítés beállítása az áruházak esetében
description: Ez a cikk az áruházi rendelés teljesítésének beállítására nyújt áttekintést.
author: BrianShook
ms.date: 10/30/2017
ms.topic: article
ms.prod: ''
