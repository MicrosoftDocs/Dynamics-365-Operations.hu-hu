...
description: Ez a témakör áttekintést nyújt a Norvégiában használható pénztárgép funkciókról, és a funkciók beállításával kapcsolatban Microsoft Dynamics 365 Commerce tartalmaz irányelveket.
...
ms.locfileid: "7944940"
---
# <a name="cash-register-functionality-for-norway"></a>Pénztárgép funkciói Norvégia esetén

[!include[banner](../includes/banner.md)]

Ez a témakör áttekintést nyújt a Norvégiában használható pénztárgép funkciókról Dynamics 365 Commerce. A szolgáltatások beállítására vonatkozó irányelveket is tartalmaz. A funkció a következő részekből áll:
...
Az alábbi Norvégia-specifikus POS-funkciók engedélyezve vannak, ha a POS funkcióprofil ISO-kód paraméterének **értéke** **Nem**.
...
Létre kell hoznia áfakódokat, áfacsoportokat és cikkadócsoportokat. A termékekre és szolgáltatásokra vonatkozó áfaadatokat is be kell állítani. Az áfa beállítását és használatával kapcsolatos további tudnivalókat lásd: [Áfa](../../finance/general-ledger/indirect-taxes-overview.md) áttekintése.
...
Adja hozzá a Nyelv szöveglapon a következő rekordokat a nyugtaelrendezések **egyéni mezőinek** címkéihez. Ne feledje, hogy a táblázatban látható nyelvazonosító, szövegazonosító és szöveges értékek **csak** **·** **példák**. A beállításokat az igényeknek megfelelően módosíthatja.

| Nyelvazonosító | Szöveg                   | Szövegazonosító |
|-------------|------------------------|---------|
| hu-USA       | Nyugta címe          | 900011  |
| hu-USA       | Ajándékutalvány           | 900012  |
| hu-USA       | Összesen (értékesítés)          | 900013  |
| hu-USA       | Összes adó (értékesítés)      | 900014  |
| hu-USA       | Összesen adóval (értékesítés) | 900015  |
| hu-USA       | Adóösszeg (értékesítés)     | 900016  |
| hu-USA       | Készpénztranzakció azonosítója    | 900017  |
