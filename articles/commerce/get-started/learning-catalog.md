...
---
# <a name="dynamics-365-commerce-learning-catalog"></a>Dynamics 365 Commerce képzési katalógus 

Keresse meg a megfelelő online képzést, személyes workshopokat és rendezvények az Ön szerepéhez, a Dynamics 365 Commerce felhasználójaként.
...
<!-- ![Universal Windows Platform (UWP)](images/platform-uwp.png)  -->  
    ...
    [Kereskedelem](learning-catalog-business-user.md#commerce)

    [e-Kereskedelem](learning-catalog-business-user.md#e-commerce)
...
:::row:::
    ...
    [Kereskedelem](learning-catalog-administrator.md#commerce)

    [e-Kereskedelem](learning-catalog-administrator.md#e-commerce)
...
:::row:::
    ...
    [Kereskedelem](learning-catalog-developer.md#commerce)
    ...
    [Kereskedelem](learning-catalog-functional-consultant.md#commerce)

    [e-Kereskedelem](learning-catalog-functional-consultant.md#e-commerce)
...
:::row:::
    ...
    [Kereskedelem](learning-catalog-partner-sales.md#commerce)

    [e-Kereskedelem](learning-catalog-partner-sales.md#e-commerce)
    ...
    [Kereskedelem](learning-catalog-solution-architect.md#commerce)
