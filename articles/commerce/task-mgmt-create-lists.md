...
Mielőtt elindítja a feladatlista létrehozásának folyamatát, győződjön meg róla, [hogy befejezte a konfigurálásokat a Feladatkezelés konfigurálása cikkben](task-mgmt-configure.md). Feladatlista létrehozásához kövesse az alábbi lépéseket.
