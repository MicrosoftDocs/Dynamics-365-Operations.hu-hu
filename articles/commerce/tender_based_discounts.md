...
description: Ez a cikk áttekintést nyújt olyan funkciókról, amelyek segítségével a kiskereskedők meghatározott fizetési típusokhoz engedményeket konfigurálnak.
author: bebeale
ms.date: 10/30/2019
ms.topic: article
ms.prod: ''
