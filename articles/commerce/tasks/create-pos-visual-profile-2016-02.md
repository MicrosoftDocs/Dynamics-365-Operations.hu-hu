...
1. Menjen a **Kiskereskedelem és kereskedelem > Csatorna beállítása > POS beállítás > POS profilok > Vizuális profilok** lehetőségre.
2. Kattintson az **Új** elemre.
3. A **Profilszám** mezőbe írjon be egy értéket.
4. Írjon egy értéket a **Leírás** mezőbe.
5. Az **Alkalmazás típusa** mezőben kattintson a legördülő gombra a kereső megnyitásához.
6. A listában kattintson a kijelölt sorban lévő hivatkozásra.
7. A **Téma** mezőben kattintson a legördülő gombra a kereső megnyitásához.
8. A listában kattintson a kijelölt sorban lévő hivatkozásra.
9. Az **Hangsúlyszín** mezőben kattintson a legördülő gombra a kereső megnyitásához.
10. A kívánt rekord megkeresése és kijelölése a listán
11. A listában kattintson a kijelölt sorban lévő hivatkozásra.
12. Kapcsolja át a **Bejelentkezés háttér** szakasz kibontását.
13. A **Tájképazonosító** mezőben válasszon ki vagy írjon be egy képazonosítót.
14. A **Portré képazonosító** mezőben válasszon ki vagy írjon be egy képazonosítót.
15. Kapcsolja át a **Háttér** szakasz kibontását.
