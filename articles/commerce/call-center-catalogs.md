...
description: Ez a témakör a katalógusok hívásközpont-specifikus funkcióit ismerteti a következőben:Dynamics 365 Commerce
author: josaw1
ms.date: 05/15/2018
ms.topic: article
ms.prod: ''
...
Ez a témakör a katalógus funkcióihoz kapcsolódó hívásközpont-specifikus funkciókat ismerteti Dynamics 365 Commerce.
