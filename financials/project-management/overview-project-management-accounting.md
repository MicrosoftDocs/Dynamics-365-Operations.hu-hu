...
Projekt olyan tevékenységek, amelyek célja, hogy a szolgáltatás, egy termék vagy egy eredmény elérése érdekében. Projektek erőforrásait használják, és a bevételek vagy az eszközök formájában pénzügyi eredményeket generál.

## <a name="projects-across-industries"></a>Projektek ágazatokban között
A projektvezetési és könyvelési funkció több ágazatban is használható a következő ábrán látható módokon. [![Projektek közötti iparágak](./media/projects-accross-industries.jpg)](./media/projects-accross-industries.jpg) 

Egy telefonos ügyfélszolgálat esetében, ún. „ticket” használható, amely összefoglalja azt az eljárásmenetet, amely végrehajtásával az adott probléma megoldható. Tevékenységük projektként tanácsadó vállalatok, mint a kezelés műszaki konzultációt szervezetek vagy hirdetési ügynökségek, vonatkoznak. Marketing, kampány jelöl munka kell szállítani. Projekt-alapú gyártás esetén, a termelési rend határozza meg a késztermék előállításához elvégezendő különböző munkafolyamatokat. Bármilyen nevet használja őket, ezeket a projekteket érintő erőforrások, ütemezések és költségeket, és a projektvezetési és könyvelési funkció a Microsoft Dynamics 365 műveletek segítségével, a tervezési, végrehajtási és ezek a projektek elemzése.
...
Projekt kezdeményezése, során néhány kulcsfontosságú folyamat fordul elő. Projektajánlat segítségével anyagok, a költségek és a becsült munka kommunikációhoz az ügyfélnek. Rögzítheti a számlázási feltételek, korlátozások és megállapodások a projektszerződés. A munkalebontási szerkezet (WBS) segítségével tervezése és becslése a munkát. A projekt végrehajtásának irányításához állíthat be előrejelzések és költségvetések. A következő ábrán a projekt szerkezetét. [![a projekt szerkezetét](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
A Microsoft Dynamics 365 műveletek hat típusú projektek hozhat létre. Minden projekt típusának beállítása eltérően a költségek és bevételek elszámolása. A projekttípus kiválasztása a projekt célkitűzésétől függ. A következő táblázat ismerteti az egyes projekttípusok jellemző használatát.
...
| Rögzített ár       | A rögzített árú projekteknél a számlák részszámlázási tranzakciók áll. A rögzített árú projekt számlázásakor a projektszerződés alapuló számlázási ütemterv szerint. Rögzített árú projekteknél a jövedelem a projekt során a teljesített munka százaléka alapján kiszámítható. Ezen kívül a jövedelem a projekt befejeztekor, a teljesített szerződés-módszertannal is kiszámítható. A vállalatoknak gyakran előnyös lehet a folyamatban lévő munka értékének használata a projekt vagy projektcsoport feldolgozottsági fokának kiszámításához.                                                                                                                                     |
| Befektetés        | A beruházási projektek olyan projektek, amelyekből nem származik azonnali bevétel. Ezeket általában hosszú távú belső projektekhez használják, amelyekben a költségeket tőkésíteni kell. Egy beruházási projektnél csak eszközök, munkaórák, és költségek regisztrálhatók. Egy beruházási projekt költségei a Becslés funkcióval ellenőrizhetők és nyomon követhetők. A beruházási projektek igény szerint tőkésítési maximum értékkel láthatóak el. Egy beruházási projekt előrehaladtával a költségeket a folyamatban lévő termelési (WIP) könyvekben kell rögzíteni, ahol a költségek addig maradnak rögzítve, amíg a projekt be nem fejeződik. A projekt megszüntetésekor a WIP-értéket tárgyi eszközbe, főkönyvi számlára vagy új projektbe kell átvinni.
> [!NOTE] 
> Beruházási projektek tranzakciói nem jelennek meg a **költségek feladása**, **elhatárolt bevétel**, vagy **számlajavaslatok létrehozása** oldalon.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | Költségprojekt |}] Beruházási projektek, mint a költségprojektek általában belső projekteket, és csak órák, költségek nyomon követésére használt, és elemeket lehet rögzíteni azokat. A költségprojektek általában rövidebb idejűek, mint a beruházási projektek. A beruházási projektekkel ellentétben a költségprojektek nem tőkésíthetők mérlegszámlákra. Ehelyett a projekttranzakcióik csak eredményszámlákra adhatók fel. 
[!NOTE] 
> Költségprojektek tranzakciói nem tükrözi a **költségek feladása**, **elhatárolt bevétel**, vagy **számlajavaslatok létrehozása** oldalon. Költségprojektek általában belső projektek nyomon követésére használt, mert általában nincs tartozó vevőkód. Ha azonban a telepítő megköveteli, hogy cikkszükségleteket hozzon létre a beszerzési rendelésekhez, akkor mégis hozzá kell rendelni a költségprojektet a vevőhöz. Ennek oka, hogy a cikkszükségleteket értékesítési rendeléssorokként kezeli, és a rendszer megköveteli, hogy a vevő meg legyen adva. Ez a beállítás azonban eredményezi azt, hogy a cikkszükségletek automatikusan létrejönnek egy beszerzési rendelésből. A költségprojektek a **Cikkszükséglet létrehozása** figyelmen kívül hagyja a beállítást. Ha mégis cikkszükségletre van szüksége egy költségprojektben, elkészítheti manuálisan, mindaddig, amíg a vevő társítva van a projekthez. | | Belső |}] Belső projektek olyan projekt, amely a szervezeten belüli költségek nyomon követésére szolgálnak. Belső projektek kezelése az erőforrás-felhasználás tervezési eszköz biztosíthat. **Megjegyzés:** belső projektek tranzakciói nem tükrözi a **elhatárolt bevétel** vagy **számlajavaslatok létrehozása** oldalon.                                                                                                                                                                                                                                                                       | | Idő |}] Időelszámolású projektek nem felszámítható és nem termelő tevékenységek, például a projekt nyomon követheti a betegszabadság munkavállalók társított idő nyomon követésére szolgálnak. Az időelszámolású projektek tranzakciói nem kerülnek feladásra a főkönyvbe. Ehelyett dolgozói kihasználtsági jelentésekbe kerülnek. Az időelszámolású projektekben csak óratranzakciók regisztrálására van lehetőség. Ezeket az órákat óranapló vagy idő-nyilvántartás használatával regisztrálhatja a projekthez. Miután az óramennyiség regisztrálva, projekttranzakciók jelennek meg, de nem rendelkezik megfelelő Bizonylattranzakciók.

> [!NOTE] 
> Időelszámolású projektek tranzakciói nem tükrözi a **költségek feladása**, **elhatárolt bevétel**, vagy **számlajavaslatok létrehozása** oldalon.                                                                                                                                                                                       |
...
Íme néhány dolog, hogy az erőforrás-ütemezési funkció használható:
...
Igazgatását és ellenőrzését, a projektek két módja van: a Projekt-előrejelzések és projekt költségvetések. Használja a projekt-előrejelzést, amennyiben a szervezetnek van működési terve, és ha az a meghatározott tranzakciókból származtatott bevételekre és költségekre fókuszál. Használja a projekt költségvetés-tervezéshez, ha a szervezet inkább a pénzügyi összegekre összpontosít.
...
-   Felhasznált cikk/nem hivatkozott rendelés *** – hivatkozás a projekt cikk-követelménybe. A módszer alkalmazása esetén a a tényleges projektköltségek megtekinthetők, amikor a termelés **Elindítva** vagy Készként jelentve állapotú. A költség feladása a nyersanyagok esetében több projektcikk tranzakcióiként, illetve a termelés esetében a felhasznált órák formájában történik. Definiálni lehet, hogy az anyagjegyzék-hierarchia (BOM) melyik szintje legyen nyomon követve a termelési projektekben.
...
-   Ha a vállalat készletéből rendel cikkeket, akkor cikkszükségletként kell megadnia a rendelést. Ha a **követelmények cikk** lapon állíthatja be a követelményt úgy, hogy megkapja a részleges szállítások elemek. Ezért fogyasztási cikkek mennyiségének elhalasztani, amíg az elem nem szükséges.
...
> [!NOTE] 
> A projekthez kapcsolódó értékesítési rendelés csomagjegyzékének nem érvényteleníthető, ha a cikkeket már jelölt csomagjegyzék. 
...
Microsoft Dynamics 365 műveletek automatikusan nem csökken az előre jelzett becslések. Ezért célszerű karbantartása rögzített árú projekten összehasonlítás alaptervet létrehozására, a projekt befejezésekor az eredeti előrejelzési modellel. 
> [!NOTE]Ha ezt a módszert választja, legalább két előrejelzési modellt használja. Egy modell tartalmaznia kell az eredeti előrejelzés. A modell, az előrejelzési tranzakciókat kell másolása egy másik modellbe. Ez a mező csak rögzített árú és beruházási projektekre vonatkozik.</td>
> </tr>
<tr class="odd">
...
-   **Számla dátuma:** 2012. március 31. Ez a dátum a Számla-gyakoriság alapján történik. Ebben a példában a Számlagyakoriság meg az aktuális hónaphoz. Emiatt a március hónapban feladott összes tranzakció számlázása a hónap utolsó napját.
-   **Határidő:** április 14, 2012. Ez a dátum a projekthez beállított fizetési feltételek alapján határozza meg. Ebben a példában a kiválasztott fizetési feltételek 14 napos. Ezért 14 nap hozzáadódnak rakódó határidő 2012. április 14. a számla dátumát.
-   **Várható értékesítési kifizetési dátuma:** 2012. április 27. Ezt a dátumot a napok száma összeadásával a **Általános puffernapok** mezőjében a **projekt management és könyvelési paraméterek** oldalra a napok száma a **egyedi puffernapok** mezőjében **projekt szerződések** oldal és a teljes napok száma a **határidő** mező. Ebben a példában a beírt **3** a**Általános puffernapok** mező és **10** a **Egyedi puffernapok** mező. Ezért 13 nap hozzáadódnak rakódó határidő 2012. április 27. a számla dátumát.
...
-   **Határidő:** 2012. március 16. A fizetési feltételek 14 nap van beállítva.
-   **Várható értékesítési kifizetési dátuma:** 2012. március 29. A számítás magában foglalja a három általános puffernapok és 10 egyedi puffernapok.
...
> [!NOTE] 
> A beszerzési rendelés határideje a projekt beszerzési rendelés létrehozásakor a szállítói tranzakció alapul. A határidő nem alapértelmezett beállításait határozza meg. 
...
> [!NOTE] 
> Ha a **Költségkontroll** lapon megtekinthető az aktuális állapot, a projekt költségeinek, az eredeti és a fennmaradó költségvetés-a kijelölt előrejelzési modellek használni. Ha más előrejelzési modellek költségeinek kiszámítása, a számítási eredmények nem lesznek pontosak.
