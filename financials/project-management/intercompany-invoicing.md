...
description: "A cikk tudnivalókat és példákat a Microsoft Dynamics 365 műveletek projektek számlázása vállalatközi nyújt."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
A cikk tudnivalókat és példákat a Microsoft Dynamics 365 műveletek projektek számlázása vállalatközi nyújt.

Előfordulhat, hogy a szervezete több osztállyal, leányvállalattal és egyéb jogi személyekkel rendelkezik, amelyek az adott projektekhez egymás között is átadnak termékeket és szolgáltatásokat. A jogi személy, amely a szolgáltatás vagy termék neve a *kölcsönzés jogi személy*, és a jogi személy, amely megkapja a szolgáltatás vagy termék neve a *kölcsönbe vevő jogi személy*. 
...
A célja, hogy Költségkontroll, árbevétel, adók, transzferár vállalatközi projekttranzakciók több rugalmas és hatékony. Ezen túlmenően a következő lehetőségeket nyújtják:
...
1.  Az FRSI beállítása az USSI jogi személy vevőjeként és az USSI beállítása az FRSI jogi személy szállítójaként. A feladathoz szükséges lépésekhez három belépési pont van.
    ...
    |------|-----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | A:    | A USSI, kattintson **követelések**&gt;**vevők**&gt;**vevőket**. | Hozzon létre egy új ügyfélbejegyzést az FRSI lehetőségre vonatkozóan, és válassza ki a vevőcsoportot.                                                                                                                                                                                                                           |
    | milliárd    | Kattintson a FRSI, **kötelezettségek**&gt;**szállítók**&gt;**minden szállítóra**.        | Új szállítói rekord létrehozása az USSI lehetőségre vonatkozóan, és a szállítói csoport kiválasztása.                                                                                                                                                                                                                               |
...
2.  Kattintson a **projektek igazgatási és számviteli**&gt;**telepítő**&gt;**projekt elszámolási paraméterek**, és kattintson a **vállalatközi** fülre. A paraméterek beállításának módja attól függ, hogy Ön a kölcsönbe vevő jogi személy vagy a kölcsönadó jogi személy szerepkörével rendelkezik.
...
3.  Kattintson a **projekt igazgatási és számviteli**&gt;**a telepítő**&gt;**árak**&gt;**átadási ár**.
...
5.  Kattintson a **főkönyvi**&gt;**könyvelési mátrix**&gt;**vállalatközi könyvelés**, és állítsa be a kapcsolat USSI és FRSI.
...
| Lépés | Belépési pont                                                                       | Leírás                                                                                                                                                                                       |
|------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A:    | **Projekt management és számviteli**&gt;**munkaidő-nyilvántartások**&gt;**az összes munkaidő-nyilvántartások** | Új időnyilvántartás létrehozása. Az idő-nyilvántartási sorban, a **Jogi személy** mezőben válassza az **FRSI** lehetőséget. A **Projekt azonosító** mezőben, jelölje ki az FRSI projektet. Adja meg a hét egyes napjain teljesített munkaórák számát. |
...
| Lépés | Belépési pont                                                                                             | Leírás                                                                                                                                      |
|------|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| A:    | **Projekt management és számviteli**&gt;**projekt számlákról**&gt;**vállalatközi vevői számla**  | Kattintson az **Új** lehetőségre a **A vállalatközi számla létrehozása** oldal megnyitásához.                                                                                  |
| milliárd    | **Projekt management és számviteli**&gt;**projekt számlákról**&gt;**vállalatközi vevői számlák** | **A vállalatközi számla létrehozása** lapon, adja meg a jogi személyt, adja meg azt a tranzakciót, amelyet tartalmaznia kell, majd kattintson a **Keresés** lehetőségre. |
| K    | **Projekt management és számviteli**&gt;**projekt számlákról**&gt;**vállalatközi vevői számlák** | Jelölje ki a tranzakciót a számlához, vagy kattintson az **Összes kijelölése** lehetőségre a lista összes tranzakciójának számlázásához, és kattintson az **OK** lehetőségre.                  |
...
| milliárd    | **Projekt management és számviteli**&gt;**projekt számlákról**&gt;**Projekt-számlajavaslatok** | Új projektszámla létrehozása a projektre vonatkozóan és győzödjön meg arról, hogy a feladott óratranzakciók megjelennek.            |
