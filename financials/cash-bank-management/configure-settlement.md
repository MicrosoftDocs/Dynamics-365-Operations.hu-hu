...
A következő paraméterek befolyásolják a kiegyenlítések hogyan dolgozza fel a Microsoft Dynamics 365 műveletekhez. A kiegyenlítés az a folyamat, amikor a számlát kiegyenlítjük egy kifizetéssel vagy jóváírással szemben. Ezek a paraméterek a **Kiegyenlítés** területen, a **Kinnlevőségek paraméterei** és a **Kötelezettségek paraméterei** lapokon találhatók.
...
-   **Készpénzfizetési engedmény adminisztrációja** – megadása hogyan egy [a készpénzfizetési engedmény legyenek kezelve amikor a számla túlfizetés van](cash-discount-handling-overpayments.md). Túlfizetés csökkenthető a készpénzfizetési engedmény, kezelhető a különbözet vagy a szállítói vagy vevői számla továbbra is azt.
...
-   **Jóváírások készpénzfizetési engedményeinek számítása** – Állítsa be az **Igen** értéket a készpénzfizetési engedmények jóváírásainak automatikus kiszámításához. A Kinnlevőségekben a jóváírás tranzakció egy negatív tranzakció, amelynek az értéke a **Számla** mezőben jelenik meg a **Szabadszöveges számla** oldalon vagy a **Értékesítési rendelés** lapon visszaadott értékként.
    -   A beállítás hatása függ a **Készpénzfizetési engedmény használata** mező értékétől a **Tranzakciók kiegyenlítése** oldalon. Ha ez a beállítás értéke **Igen**, az engedmény történik, amikor a *** készpénzfizetési engedmény *** mező értéke **normál**. Ha a *** készpénzfizetési engedmény *** mező értéke **mindig**, a készpénzfizetési engedmény mindig hozott, ez a mező beállításától függetlenül. Ha a *** készpénzfizetési engedmény *** mező értéke **soha**, a készpénzfizetési engedmény soha nem hozott, ez a mező beállításától függetlenül.
...
-   **Kiegyenlítés rangsorolása (csak AR)** – Állítsa be az **Igen** értéket a **Megjelölés prioritás szerint** gomb engedélyezéséhez a **Vevői kifizetések megadása** és a **Tranzakciók kiegyenlítése** oldalakon. Ez a gomb segítségével a felhasználók az előre meghatározott elszámolási rendelés társítása a tranzakciókat.  A Kiegyenlítési sorrend kiegyenlített tranzakció, miután a a rendelés és a kifizetés felosztása feladás előtt módosíthatók.
-   **Prioritás használata automatikus fizetések** – értéket kell megadni **Igen**, a meghatározott prioritási sorrendben használja, ha a tranzakciók automatikusan leülepedtek. Ez a mező akkor érhető el, ha a **Kiegyenlítés rangsorolása** és **automatikus kiegyenlítés** beállítása **Igen**.
