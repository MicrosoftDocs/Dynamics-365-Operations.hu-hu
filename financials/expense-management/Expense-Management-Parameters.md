...
| **Mező**                             | **Leírás**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Napidíj minimális órakövetelménye**           | Adja meg azt a minimális óraszámot, amelyet egy munkavállalónak egy nap alatt kell dolgoznia ahhoz, hogy napidíjat kaphasson az utazáshoz kapcsolódó költségekért.                                                                                      |
