...
> + Juttatási tervek meghatározása és adminisztrálására, munkavállalók felvétele, eltartott juttatásbeli jogosultságok hozzárendelése, és a kedvezményezettek kijelölése.
> + Távolléti irányelvek létrehozása és felügyelete.
> + A profilalapú munkaidő kezelésének implementálása és nyomonkövetése, valamint fizetési adatok exportálása egy bérrendszerbe.
> + Dolgozók kompetenciáinak kezelése.
> + Teljesítmények értékelése és a dolgozói célok implementálása.
...
<a name="develop-a-human-resources-strategy"></a>A humán erőforrás stratégia kidolgozása
---------------------------------------------------------

Az emberi erőforrások munka is eldöntheti, a szervezet felépítésének használt elemek, például a szervezeti egységek és a feladatok. Ezek az emberi erőforrások is beállíthatja a eligazodást elemek között. Az egyes alkalmazottak pozíciókhoz rendelhetők, amelyek feladatokhoz vannak társítva.
...
Segíti a munkahelyekkel eléri a kritikus üzleti kézbesítése szükséges, míg az alkalmazottak állíthat be célok, teljesítmény-ellenőrzések létrehozása és nyomon követése érdekében szükséges készségek fejlesztését az alkalmazottak visszajelzési, akkor is állíthatja oktatók, Tanfolyamtípusok, tanfolyamok, Tanfolyamleírások, napirendek, szekciók és munkamenetek oktató hozzárendelése a tanfolyam, vagy valaki egy tanfolyam regisztrálása előtt. Oktatóknak már létezniük kell a rendszerben dolgozóként, pályázóként vagy kapcsolattartóként.

-   [Teljesítménymenedzsment](performance-management-overview.md)
-   [Munkaerő képzettsége és üzleti igényekhez igazítása](skills.md)
...
-   [A juttatási program kezelése](manage-benefit-program.md)
