...
5.  A böngésző URL-címét másolja ki a célként megadott Dynamics 365 for Operations példányból, illessze be a **Kiszolgáló URL-címe** mezőben, és töröljön mindent az állomás neve után (például törölje a következőt: **/?cmp=usmf&mi=CustTableListPage**). Az eredményül kapott URL-címnek csak az állomásnevet kell tartalmaznia (például **https://xxx.dynamics.com**).
...
11. Miután hozzáadta a kívánt mezőket a **Kijelölt mezők** listához, győződjön meg arról, hogy a kurzor a megfelelő helyen van a munkalapon (például az A1 cellán), és kattintson a **Kész** elemre. Kattintson a **Kész** elemre, és lépjen ki a tervezőből.
...
-   Kattintson bárhová a munkalapon, majd az **Új** lehetőségre az Excel-bővítményben.
-   Kattintson a munkalap utolsó sorába, és nyomja le a Tab billentyűt mindaddig, amíg a kurzor ki nem lép a sor utolsó oszlopából, és új sor nem jön létre.
-   Kattintson a sorra közvetlenül a munkalap alatt, és kezdjen el adatokat beírni egy cellába. Amikor a fókuszt kimozgatja a cellából, a munkalap kiegészül az új sorral.
...
5.  A **Frissítés** lehetőségre kattintva alkalmazza a módosításokat az adatforrásra. Kattintson a **Kész** elemre, és lépjen ki a tervezőből. Ha hozzáadott egy mezőt (oszlop), kattintson a **Frissítés** lehetőségre egy frissített adatkészlet behúzásához.

## <a name="httpspowerappsmicrosoftcomenustutorialsdataplatforminteractiveexceltroubleshootingtroubleshooting"></a>[](https://powerapps.microsoft.com/enus/tutorials/dataplatforminteractiveexcel/#troubleshooting)Hibaelhárítás
