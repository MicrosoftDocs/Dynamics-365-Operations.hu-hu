...
-   Ha az elválasztó a számlatükröt használnak, a dupla határoló lehetőség közül választhat: dupla kötőjel (-), függőleges dupla vonal (|) vagy dupla pontot (.) vagy dupla aláhúzás (\_\_).
