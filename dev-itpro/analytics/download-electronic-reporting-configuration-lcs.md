...
description: "Ez a témakör a Microsoft Dynamics életciklus szolgáltatások (LCS) (ER) konfigurációk jelentési elektronikus letöltését ismerteti."
author: kfend
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Ez a témakör a Microsoft Dynamics életciklus szolgáltatások (LCS) (ER) konfigurációk jelentési elektronikus letöltését ismerteti.
...
2.  Ugrás a **szervezet felügyelete**&gt;**elektronikus jelentés**.
3.  Jelölje be a **Microsoft** lapot a **Konfigurációs szolgáltatók** részben.
4.  Kattintson a **Tárházak** lehetőségre a **Microsoft** lapon. [![Update-er-from-LCS-for-MS-Open-MS-repositories-List](./media/update-er-from-lcs-for-ms-open-ms-repositories-list.png)](./media/update-er-from-lcs-for-ms-open-ms-repositories-list.png)
...
6.  Kattintson a **Megnyitás** lehetőségre a kijelölt tárház ER-konfigurációk listájának megtekintéséhez. [![Update-er-from-LCS-for-MS-Make-LCS-Repository](./media/update-er-from-lcs-for-ms-make-lcs-repository.png)](./media/update-er-from-lcs-for-ms-make-lcs-repository.png)
...
9.  Kattintson az **Importálás** lehetőségre a kiválasztott verzió LCS rendszerből a jelenlegi Dynamics 365 for Operations példányba történő letöltéséhez. **Megjegyzés:** Az **Importálás** gomb nem érhető el azon ER konfigurációs verziókhoz, amelyek már szerepelnek a Dynamics 365 for Operations aktuális példányában. [![Update-er-from-LCS-for-MS-download-Configuration](./media/update-er-from-lcs-for-ms-download-configuration.png)](./media/update-er-from-lcs-for-ms-download-configuration.png)

**Megjegyzés:** Az ER beállításoktól függ a konfigurációk érvényesítése azok importálását követően. Előfordulhat, hogy bármilyen észlelt ellentmondásos problémáról értesítést kap. Ezeket a problémákat meg kell oldania az importált konfiguráció verziójának használata előtt. További tudnivalókért lásd: ehhez a témakörhöz kapcsolódó cikkek listáját.
