...
-   A címkének (a és z között vagy A és Z között) egy alfabetikus karakterrel kell kezdődnie, és legfeljebb 16 karakterig a számoknak és a betűknek bármely kombinációja lehet. **Megjegyzés:** címke tartalmazhat aláhúzásjelet (\_), de más különleges karaktereket nem engedélyezettek.
...
A **Formátum Kód** cella előre megformázott lehetőségeket kínál az adott sor tartalmához. Ha a **Formátum Kód** cella üres, akkor az adott sor pénzügyi adatot leíró sorként van értelmezve. **Megjegyzés:** Ha a jelentés olyan nem-összeg sorokat tartalmaz, amik kapcsolódnak rejtett összeg sorokhoz (például, mert az egyenlege nulla), használhatja a **Kapcsolódó Képletek/Sorok/Egységek** oszlopot, hogy megakadályozza a cím és a formátum sorok kinyomtatását.
...
3.  Jelöljön ki egy formátumkódot a listában. Az következő táblázat leírja a formátumkódokat és a szerepüket.
    ...
    | TOT                           | Összesen                              | Azonosítja a matematikai operátorokat használó sorokat a **Kapcsolódó Képletek/Sorok/Egységek** oszlopban. Összegek tartalmazhat például egyszerű operátorok, **+**vagy**-**.                                                      |
    | CAL                           | Számítás                        | Azonosítja a matematikai operátorokat használó sorokat a **Kapcsolódó Képletek/Sorok/Egységek** oszlopban. Számítások tartalmazhat például összetett szereplők **+**, **-**, **\***, **/**, és **IF/THEN/ELSE** utasítás. |
...
A következő példában, Phyllis szeretné megakadályozni, hogy a jelentésének az **Összes Készpénz** sorában, a fejléc és az aláhúzások nyomtatásra kerüljenek, mivel nem volt tevékenység a készpénzszámlák egyikén sem. Ezért sorában 220 (, mint a **---**formátum a kód azt jelzi, a formázási sor), a a **kapcsolódó képletek/sorok/egységek** cella, ő ad **250**, ez az összeg sor mellőzni szeretné a sor kódot. [![RelatedRowsRowDefinition](./media/relatedrowsrowdefinition-1024x144.png)](./media/relatedrowsrowdefinition.png)
...
6.  A **Fájl** menüben, kattintson a **Mentés másként** parancsra, hogy új név alatt mentse az oszlopdefiníciót. Append **CBR** az aktuális fájl neve (például **PÉNZNEM\_IDEI\_CBR**). Ez az oszlopdefiníció lesz az Ön alaposzlop-definíciója.
...
A következő sordefiníció-példában, a 100. sor azt mutatja, hogy a számításokhoz használt alapsor a 280. sor. [![Példa a számítási alap sor.](./media/cbrrowdefinition.png)](./media/cbrrowdefinition.png) A következő egy oszlopdefiníció példában, a számítások a **CBR** kódformátumot használják. A számítás a C oszlopban elosztja a B oszlopban található jelentés értékét, a B oszlop 280-ik sorában lévő értékkel. A formátum felülírása a B oszlopban százalékként nyomtatja kis a számítás eredményét. Ehhez hasonlóan, minden összeg az E oszlopban a D oszlop összege, mint a nettó értékesítések százalékai. [![Oszlop definition példa.](./media/cbrcolumndefinition2.png)](./media/cbrcolumndefinition2.png) A következő példa bemutat egy jelentést, ami az előző számítás alapján létrehozható. [![Példa jelentés például korábbi számítások alapján.](./media/cbrreport-1024x272.png)](./media/cbrreport.png)
...
4.  Az **Oszlop Korlátozás** cellában, írja be a rendezéshez használni kívánt jelentésoszlop betűjét. **Megjegyzés:** Csak összegsorokat vegyen bele a rendezési számításba.

### <a name="examples-of-ascending-and-descending-column-values"></a>Példák növekvő és csökkenő oszlop értékekre

A következő példa az értékeket a D oszlop a jelentés rendezése növekvő sorrendben sorok 160 490 keresztül történik. Ezenkívül sorok 610 940 keresztül csökkenő sorrendben az abszolút értékek a G oszlopban a jelentés rendezve.
...
**Növekvő Sorrendbe Rendezve az Idei Abszolút Eltérés Szerint**
...
-   **Nullérték felülíró szövege** – Az a szöveg, amelyet 0 (nulla) értékeknél szeretne megjeleníteni a jelentésben. Ez a szöveg jelenik meg utolsó sorként a **Minta** területen. **Megjegyzés:** Ha a nullértékek vagy a tevékenység nélküli időszakok nyomtatása le van tiltva, akkor ez a szöveg nem jelenik meg.
...
A típus adja meg a pozitív értéket, majd a negatív értéket. Általában olyan, hasonló formátumot ad meg, amely különbséget tesz a pozitív és a negatív értékek között. Adja meg, hogy pozitív és negatív értékeket két tizedesjegy van, de a negatív számok zárójelben jelennek meg, például írja be a **0.00;(0.00)**. Az alábbi táblázat bemutatja azokat az egyéni formázásokat, amelyekkel irányíthatja az értékek formázásait. A példák mind az 1234,56 értéktől indulnak.
...
5.  Az **Attribútumok** részen végezze el az alábbi lépéseket minden olyan attribútumnál, amelyet hozzá kíván adni a sorkódhoz:
    1.  Kattintson duplán az **Attribútum** cellára, és válasszon ki egy attribútum nevet. **Figyelem:** cseréje a kettős kereszt (\#) numerikus értéket.
...
Ha kiválaszt egy adott számlát, a jelentéstervező általában összekombinálja azt a pénzügyi évvel, az időszakokkal és azon egyéb információkkal, amelyeket a oszlopdefinícióban megadott. Adott sorokhoz, használhat különböző információkat, mint például különböző pénzügyi időszakokat. A következő táblázat az elérhető számlamódosítókat mutatja. Cserélje ki a kettős kereszt (\#), amely egyenlő vagy kisebb, mint az időszakok számát az üzleti év értékű.

| Számlamódosító | A nyomtatott                                                                           |
|------------------|-------------------------------------------------------------------------------------------|
| /BB              | Egy számla kezdő egyenlege.                                                     |
| /\#              | A megadott időszak egyenlege.                                                     |
| /-\#             | Az egyenleg az időszak, amely \#az aktuális időszak előtti időszakok.                  |
| /+\#             | Az egyenleg az időszak, amely \#a jelenlegi időszak után időszakok.                   |
| /C               | A jelenlegi időszak egyenlege.                                                       |
| /C-\#            | Az egyenleg az időszak, amely \#az aktuális időszak előtti időszakok.                  |
| /C+\#            | Az egyenleg az időszak, amely \#a jelenlegi időszak után időszakok.                   |
| /Y               | Az aktuális év eddigi egyenlege a jelenlegi időszakban.                                      |
| /Y-\#            | Az év megadott napjáig egyenleg az időszak, amely \#az aktuális időszak előtti időszakok. |
| /Y+\#            | Az év megadott napjáig egyenleg az időszak, amely \#a jelenlegi időszak után időszakok.  |

### <a name="book-code-modifiers"></a>Könyvelési kód módosítók

Korlátozhatja a sort egy meglévő könyvelési kódra. A oszlopdefiníciónak tartalmaznia kell legalább egy könyv kódot tartalmazó **FD** oszlopot. **Megjegyzés:** A könyvelési kód sorhoz tartozó korlátozása felülírja az oszlopdefiníció könyvelési kódjának korlátozásait az adott sorra.
...
5.  A a **a** mezőben adja meg a kezdő dimenziót, vagy kattintson a ![Tallózás](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "Tallózás") rendelkezésre álló dimenziók keresése. Dimenziók tartományának megadásához adja meg az utolsó dimenziót az **Idáig** mezőben.
...
A természetes szegmens érték megadásakor a **dimenziók** párbeszédpanelen elhelyezhetjük a helyettesítő karakterek (?) Vagy \*) egy szegmens bármilyen helyzetben. Jelentéstervező a meghatározott pozíciók értékeinek kibontása nélkül figyelembe véve a helyettesítő karakterek. Például, a sordefiníció csak természetes szegmensértékeket tartalmaz, és a természetes szegmensek négy karakteresek. Megadásával **6???** Egy sor természetes szegmens érték, amely egy 6 kezdődik minden számlák jelentéstervező utasítja. Ha **6\***, az azonos eredményt ad, de az eredmények is bevehetjük változó szélességű, például a **60** és **600000**. A jelentéstervező minden (?) helyettesítő karakter helyére a lehetséges értékek teljes tartományát behelyettesíti, ide értve a betűket és a különleges karaktereket is. Például ha a tartomány kezdete a **12?0**, a vége pedig **12?4**, akkor a **12?0** kód helyettesítő karaktere helyére behelyettesíti a karakterkészlet legalacsonyabb érétkét, a **12?4** kódban pedig a legmagasabb értéket. **Megjegyzés:** A számlatartományok kezdő és záró értékeinél lehetőség szerint ne használjon helyettesítő karaktert. Ha a kezdő számlánál vagy a záró számlánál helyettesítő karaktert használ, előfordulhat, hogy nem a várt eredményt kapja.

### <a name="single-segment-or-single-dimension-ranges"></a>Egyetlen-szegmenses vagy egyetlen-dimenziós tartományok

Megadhat egy tartományt a szegmens értékekhez vagy a dimenzió értékekhez. Egy értéktartomány meghatározásának az az előnye, hogy nem kell minden alkalommal frissítenie a sordefiníciót, valahányszor új szegmensértéket vagy dimenzióértéket adnak hozzá a pénzügyi adatokhoz. Ha például a tartomány **+ számla =\[6100:6900\]** számlákról és 6900 6100 értékek alapján tölti ki a sor összeg. Ha egy tartomány tartalmaz egy helyettesítő karaktert (?), akkor a jelentéstervező nem értékeli ki a tartományt karakterenként. Ehelyett a tartomány alsó és felső végét állapítja meg, majd ezt a kettőt és a köztük levő összes értéket figyelembe veszi. **Megjegyzés:** Report Designer jelölhetők ki számlákat, a méretek vagy a mezők a Microsoft Dynamics ERP rendszerből, amely tartalmazhatja a következő karaktereket: &, \*, \[, \], {, vagy}. Latin és-szimbólumot (&) csak akkor vehet fel, ha automatikusan épít sordefiníciókat a **Sorok Beszúrása Dimenziókból** párbeszédpanel használatával.

### <a name="multiple-segment-or-multiple-dimension-ranges"></a>Több-szegmenses vagy több-dimenziós tartományok

Egy tartomány több dimenzió érték kombináció használatával adja meg, ha a tartomány összehasonlítás történik egy... \financial-dimensions\dimension-by-Dimension alapján. A tartomány-összehasonlítás nem hajtható végre karakterenkénti módszerrel, sem részleges szegmens alapján. Például a tartomány **+ számla =\[5000:6000\], részleg =\[1000:2000\], költséghely =\[00\]** csak azokat a számlákat, amelyek megfelelnek az egyes szegmensek tartalmazza. Ebben a forgatókönyvben az első dimenzió 5000-6000 tartományban kell lennie, a második dimenzió 1000 és 2000 közötti tartományba kell lennie, és az utolsó dimenziónak kell lennie a 00. Például **+ számla =\[5100\], részleg =\[1100\], költséghely =\[01\]** a jelentés nem tartalmazza, mert a megadott tartományon kívül esik az utolsó szegmens. Ha a szegmens érték szóközöket tartalmaz, ez az érték foglaljuk szögletes zárójelek közé (\[\]). Egy négy karakterből álló szegmens a következő értékek érvényesek: **\[234\], \[123 \], \[1 34\]**. Dimenzióértékek szögletes zárójelbe kell tenni (\[\]), és a jelentés Tervező ezek szögletes ad meg. Amikor többszegmensű vagy dimenzió több tartományt tartalmaz helyettesítő karakterek (?) Vagy \*), az alacsony és magas végén a többszegmensű vagy több dimenzió egész tartomány határozza meg és, majd a végén és közöttük minden értékek szerepelnek. Nagyméretű tartomány esetén ( amilyen például az összes számla 40000-től 99999-ig) lehetőleg minden esetben érvényes kezdő és záró számlát adjon meg. **Megjegyzés:** Report Designer jelölhetők ki számlákat, a méretek vagy a mezők a Microsoft Dynamics ERP rendszerből, amely tartalmazhatja a következő karaktereket: &, \*, \[, \], {, vagy}. Latin és-szimbólumot (&) csak akkor vehet fel, ha automatikusan épít sordefiníciókat a **Sorok Beszúrása Dimenziókból** párbeszédpanel használatával.
...
|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| Adjon hozzá két teljesen minősített számlát.                                                       | + Osztály =\[000\], fiók =\[1205\], részleg =\[00\]+ körzet =\[100\], fiók =\[1205\], részleg =\[00\] |
...
| Egy teljesen minősített számla kivonása egy másikból.              | + Körzet =\[000\], számla =\[1205\], részleg =\[00\]-ágazat =\[100\], fiók =\[1205\], részleg =\[00\] |
| Egy szegmensérték kivonása egy másikból.                                  | + Számla =\[1205\]-fiók =\[1210\]                                                                           |
| Egy helyettesítő karaktert is tartalmazó szegmensérték kivonása egy másikból. | + Számla =\[1200\]-fiók =\[11??\]                                                                           |
| Teljesen minősített számlák tartományának kivonása.                                           | -Osztás =\[000:100\], számla =\[1200:1205\], részleg =\[00:01\]                                           |
| Szegmensértékek tartományának kivonása.                                                     | -Fiók =\[1200:1205\]                                                                                       |
| Helyettesítő karaktereket is tartalmazó szegmensértékek tartományának kivonása.                    | -Fiók =\[120?: 130?\]                                                                                       |

Annak ellenére, hogy közvetlenül módosíthatja a számlákat, használhatja a **Dimenziók** párbeszédpanelt, hogy a helyes formátumot alkalmazza a pénzügyi adat hivatkozásokra. Az értékek bármelyikét tartalmazhat helyettesítő karakterek (?) Or \*). Azonban Report Designer jelölhetők ki számlákat, a méretek vagy a mezők az alábbi fenntartott karakterek szerepelhetnek a Microsoft Dynamics ERP rendszerből: &, \*, \[, \], {, vagy}. **Megjegyzés:** Értékek kivonásához zárójelek közé kell tennie az értékeket. Például, ha **450?-(4509)**, akkor jelenik meg **+ számla =\[4509\]-fiók =\[450? \]**, és éppen modulban a jelentéstervező a fiók szegmens 4509 minden fiók szegmens 450 kezdődő összeg összegét ki szeretnénk vonni.
...
3.  A **Dimenziók** párbeszédpanel első sorában, kövesse az alábbi lépéseket:
    ...
    2.  Kattintson duplán a **+/-üzemeltető** cellára, és válassza ki a plusz (**+**) vagy mínusz (**-**) műveleti jelet, amely egy vagy több dimenzió érték vonatkozik, vagy a sor állítja be.
...
**Megjegyzés:** A műveleti jel a sorban szereplő összes dimenzióra vonatkozik.
...
| Cikk                | Leírás                                                                                                                                                                                                                                                                                             |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Egyéni vagy tartományi | A a **a** mezőben adja meg a fiók nevét, vagy kattintson a **keresse** gomb ![Tallózás](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "Tallózás"), tallózással megkeresheti a fiók. Tartomány kiválasztásához, adjon meg, vagy keressen egy értéket a **Záró érték** mezőben.                                             |
| Dimenzióérték Beállítása | A **Név** mezőbe írja be a dimenzióérték-készlet nevét. Készlet létrehozásához, módosításához, másolásához, vagy törléséhez, kattintson a **Dimenziókészletek Értékének Kezelése** gombra. A **képlet** mezőt a program beírja a képletet a **pénzügyi dimenziók mutató hivatkozást** ezt a dimenzió értéket a sordefiníció beállítása cellában. |
...
5.  A **Módosítás** párbeszédpanelben, módosítsa a készletben szerepeltetendő képlet értékét. **Megjegyzés:** Ha új számlákat vagy dimenziókat ad hozzá, akkor ügyeljen, hogy módosítsa a már meglévő dimenzióérték-készleteket, hogy azok a módosításokat is magukba foglalják.
