...
## <a name="pos--microsoft-dynamics-ax-retail"></a>POS – a Microsoft Dynamics AX Kiskereskedelmi
|                                |                                                                                                                                                                                         |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Mit lehet tenni?**           | **Miért fontos ez?**                                                                                                                                                              |
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Mit lehet tenni?**                                                | **Miért fontos ez?**                                                                                                                                                                                                                                                                                         |
| A pénzügyi jelentési adatpiac újraépítése.                          | Dynamics AX adatbázisok áthelyezése a környezete között, vagy egyéb invazív módosítások a környezet, a pénzügyi jelentéskészítő adatbázis lehet kell építeni. A Windows PowerShell-parancsfájl most nyújtott, az adatbázis újraépítése meg.                                                                |
| Már nem választhat érvénytelen jelentéstervező lehetőségek közül. | Számos Management reporter forgalmazott verziójában használt jelentéstervező a Dynamics AX ezen verziójára nem vonatkozik. Ezek a beállítások pénzügyi jelentés Tervező, a kimeneti és a csatolás voltak kapcsolatosak. Ezek a beállítások felhasználói hibák elkerülése érdekében a pénzügyi jelentés Tervező el lett távolítva. |
