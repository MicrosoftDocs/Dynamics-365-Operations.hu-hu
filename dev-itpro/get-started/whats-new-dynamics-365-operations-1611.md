...
| Öt új energiagazdálkodási BI tartalmi csomagok hozzáférést az emberi erőforrások                                     | Az új tartalom csomagok engedélyezése humánerőforrás-szervezetek és az emberi erőforrások menedzserek a következő elemzése: munkaerő metrikák • demográfiai elszámolást életkora, neme és családi állapot • kopásállóság árfolyamok évek összehasonlítása és alkalmazottak adott a szervezet • lista nyitott pozíciók, valamint a lezárt, nyitott pozíciók kompenzációs összehasonlítása és előnyök • összehasonlítása óránkénti nézet elhagyása okok listájának megtekintéséhez és fizetett alkalmazottak • elérhető előnyök • nézet alkalmazottak beiratkozott az alkalmazottak számának megtekintése Foglalkoztatási típus toborzás • elemzése pályázók, ha azok éppen érkező, és mi azok alkalmazzuk a szervezeti képzés • Tanfolyami regisztráció által hely • Couse jelenléti állapota • alkalmazottak listája szerint pozíciók tanfolyamok Alkalmazotti kompetenciák és fejlődés • szakértelmek listájának regisztrált száma alapján a kérelmező birtokában alkalmazottak • Szakértelemtípusok csapattag által bontása |
...
<td>Bank LC-vegyes Foglalási díj formátuma Szaúd-Arábia</td>
</tr>
<tr class="odd">
...
### <a name="personalized-product-recommendations"></a>Személyre szabott termék-ajánlások

| Mit lehet tenni                                                                                                                                                                                                                                                                        | Miért fontos ez                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Személyre szabott termék-ajánlások a pénztári (POS) meghatározása alapján lehet, hogy a vevő milyen érdekli a Vásárlási előzmények, azok kívánságát lista elemeinek és más felhasználóknak és online vásárolt cikkek a tégla és habarcs üzletek több touchpoints megtekintése | Kiskereskedők nagy katalógusok személyre szabott ajánlások súgó a vevő a termék felderítése és felhatalmazni tároló vállalkozásokban való intelligens clienteling. Bemutató termékek szólnak, a vevő érdekeit, és a vevő szokásait termék ajánlások segíthetnek a kiskereskedők a upsell, és növelheti a vevői visszatartási. Dynamics 365 - műveletekhez, kiskereskedelmi termék ajánlások látja el árammal kognitív szolgáltatások és a Microsoft Azure gép tanulás. |
...
| További tudnivalók a Dynamics 365 for Operations bizományosi támogatásáról                                                                                                         | További információt a szállítmány folyamatok támogatása, lásd: [szállítmány](/dynamics365/operations/scm/inventory/consignment), [beállítása a szállítmány](/dynamics365/operations/scm/inventory/set-up-consignment), [hozzon létre egy szállítmány a készletfeltöltési rendelésre (feladat guide)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), és [változtatja meg a szállítmány készlet (feladat guide) gyártási igények alapján](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| További tudnivalók a Dynamics 365 for Operations szállítói együttműködési támogatásáról. | A szállítói együttműködéssel kapcsolatos további tudnivalókat lásd: [A külső szállítókkal történő szállítói együttműködés](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Szállítói együttműködés a vevőkkel](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Szállítói együttműködés felhasználóinak kezelése](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Szállítói együttműködés beállítása és karbantartása](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) és [Szállítói együttműködési számlázás munkaterület](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tr class="even">
<td>Rendelési ígéret közvetlen létrehozása az értékesítésirendelés-sorokból. <strong>Példa</strong> a vállalatközi szállító megosztásban értékesítésirendelés-sor létrehozása. Lépjen ki a sorból. A szállítási dátumokat a forrás vállalat rendelkezésre állása alapján számítják ki.</td>
