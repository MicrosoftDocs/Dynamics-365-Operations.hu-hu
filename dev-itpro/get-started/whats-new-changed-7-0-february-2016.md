...
<td>A Súgórendszer a Dynamics AX jelenlegi verziójában a Microsoft Dynamics Lifecycle Services (LCS) BPM-ben tárolt feladat-útmutatókat jelenít meg. A Súgórendszer a Microsoft wikiből származó témakörökat is megjelenít. További tájékoztatás: [Dynamics AX Súgó – Első lépések](help-overview.md) és [Új feladat-útmutatók érhetők el (2016. február)](new-task-guides-available-february-2016.md).</td>
