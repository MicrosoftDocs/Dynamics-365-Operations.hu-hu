---
title: "Mi az új vagy megváltozott a Dynamics AX 7.0 (2016. február)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Mi az új vagy megváltozott a Dynamics AX 7.0 (2016. február)
...
<tr class="odd">
<td>Használja az új **Könyvelési források böngészője **oldalt.</td>
...
<td>Jelentés beállításainak kerültek, így a különböző szűrőket kell alkalmazni, amikor egy felhasználó megtekinti a jelentés. Új jelentés majd e szűrők alapján jön létre.</td>
...
<td>A "Pénzügyi teljesítményének figyelésére" kiemelt BI tartalom pénzügyi adatokat elemezhet.</td>
<td>Nem érhető el.</td>
...
<td>A Súgórendszer a Dynamics AX jelenlegi verziójában a Microsoft Dynamics Lifecycle Services (LCS) BPM-ben tárolt feladat-útmutatókat jelenít meg. A Súgórendszer a Microsoft wikiből származó témakörökat is megjelenít. További tudnivalókért lásd: [Dynamics AX súgóban - bevezetés](help-overview.md) és [új feladat elérhető útmutatók (2016. február)](new-task-guides-available-february-2016.md).</td>
<td>A feladat-útmutató irányított, interaktív tapasztalatot tartalmaz, amely végigvezeti a feladat vagy az üzleti folyamat lépésein. Letöltheti és testreszabhatja a Microsoft által kínált feladat-útmutatókat. A wiki segítségével gyorsabb és rugalmasabb a termékdokumentáció létrehozása, leszállítása, és frissítése. Ezért segítségével garantálható, hogy a legfrissebb technikai információkhoz jut hozzá.</td>
</tr>
</tbody>
</table>
...
<td>A funkció egy elektronikus jelentési beállításokkal hajtották végre. Ez a funkció Németország és Ausztria területén érhető el.</td>
...
<td>Egyenleglista csoportösszegző számlákkal jelentés csoport van megvalósítva, ami SSRS-jelentés (LedgerAccountSum\_FR).</td>
...
<td>Az Intrastat-vámtarifakódok külön lista típusú vámtarifakód termékhierarchia egyesülnek.</td>
...
<td>Intrastat vámtarifakód van egy szövegmező további egységek azonosítására és a ** termék ** kártya tartozik, a mező azonosítja a kilogrammban kiegészítő egységek mennyisége.</td>
...
<tr class="odd">
<td>A "Performance Monitor kiskereskedelmi csatorna" kiemelt BI tartalom kiskereskedelmi csatorna értékesítési adatokat elemezhet.</td>
<td>Nem érhető el.</td>
...
<td>Ehhez a funkcióhoz a következő szükséges: <a href="http://www.microsoft.com/en-us/download/details.aspx?id=42636">System Center 2012 felügyeleti csomag a Microsoft Dynamics AX 2012 R3 CU8 Kiskereskedelemhez</a>.</td>
...
<li>Ez lehetővé teszi az alternatív szállítási "kész" csomagok, például a kombináció/raktározás/variant/átviteli mód, a leggyorsabb szállítási (legkorábbi rendelkezésre állási dátumnak) kritériuma, hogy a felhasználó választhat alapján.</li>
