...
description: "Ez a témakör leírja az alapfogalmakat és beállítása és használata a gyártás-végrehajtási megértéséhez szükséges feltételeket."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
| Időszak                          | Leírás                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Gyártásvégrehajtás       | Ez a funkció regisztrálhatók az idő, az anyagfelhasználás, a termelési feladatok, projektek és a közvetett tevékenységek költségei. A regisztráció egy gyártásvégrehajtás-regisztráló ügyfélben történik.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **Projekt díjak és a Projekt-cikkek regisztrálása** (elérhető a munkaidő-nyilvántartás) – munkavállalók regisztrálhatja a projektdíjnapló, például útiköltséget és a híd nem ingyenesen hívható szám az egy projekthez tartozó díjak (költségek). Cikkfelhasználás projekteken dolgozók is rögzítheti. Ez egy projektcikknaplóban történik.
