---
title: "A lean gyártási feladatütemezés kanban"
...
# <a name="kanban-job-scheduling-for-lean-manufacturing"></a>A lean gyártási feladatütemezés kanban
...
Ütemezés is lehet automatikusan elindul, ha a **tervezés mennyiség automatikus** a kanbanszabály paraméter. Ha **tervezés mennyiség automatikus**, **1**, azonnal létrehozása során minden egyes kanban feladat tervezett. Az eredmény egy műveletekből álló sorozat, amelynek végrehajtása a lekérés sorrendjében történik. Amennyiben az **Automatikus tervezési mennyiség** értéke 1-nél nagyobb, a rendszer a tervezés előtt csoportosítja a kanbanfeladatokat. Ez a koncepció lehetővé teszi, hogy a kanbanok méretét a tényleges gazdaságos kötegméret alá csökkentsük. Például a gazdasági kötegelt egy adott cikkre (vagy elem termékcsalád) mérete 30. Kanban termékmennyiség, 30, használó létrehozása helyett beállíthatja a kanban szabály, hogy a termék mennyisége 10 és egy ** tervezési mennyiség automatikus ** értékének **3**. Bár az automatikus tervezés csak akkor ütemezi a munkacella kanbanfeladatait, ha három nem tervezett feladat létezik, a tervező és az üzemirányítási felügyelő számára világosan látható, hogy két nem tervezett feladat végrehajtásra várhat. A tervező vagy üzemvezető ezután kézzel megtervezheti ezt a két feladatot, vagy ezek mellé további kanbanokat hozhat létre.
