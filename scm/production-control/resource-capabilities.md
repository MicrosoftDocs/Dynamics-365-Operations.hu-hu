...
Az azonos képességekkel rendelkező üzemi erőforrások prioritással hozzárendelhetőek. Ha több erőforrás ütemezési megfelelnek-e a szükséges szinten lehetőségével rendelkeznek, és szabad kapacitással rendelkezik, az ütemezési motor kiválaszthatja azokat a források között. Ha **prioritás** van megadva a a **elsődleges erőforrás kijelölése** mezőjében a **ütemezési paraméterek**, az erőforrás a legmagasabb prioritással rendelkező lapon (a legalacsonyabb numerikus érték a **prioritás** mező) kiválasztott első ütemezés során.
...
-   Hozzon létre két külön képességet: Alacsony és Magas sebességű fúrás. Határozza meg az Alacsony sebességű fúrást, egy olyan folyamatként aminek a folyamatideje egytől kilenc egység óránként. Határozza meg a Magas sebességű fúrást, egy olyan folyamatként aminek a folyamatideje 10-19 egység óránként. Az M1 gépet a kis sebességű fúrási képesség rendelni, majd hozzárendelése a M2 gép a nagy sebességű fúrási képesség. Végül módosítsa az erőforrás képességre vonatkozó követelmény az útvonal nagy sebességű fúró. Az ütemezési motor ezután kiválasztja a megfelelő gépet (M2).
-   Használja a képességi szintet a Fúrási képesség minősítésére, ami a fúrógépekhez van rendelve. Adja meg, hogy az M1 gép képes Drilling 2.0 szinten, és hogy a M2 gép a Drilling képesség 11.0 szintjén. Adja meg, hogy 10.0 Drilling képességre vonatkozó követelmény az útvonal szükséges minimális szintre. Az ütemezési motor ezután meghatározza, hogy csak az M2 gép tesz eleget a forrás szükségletnek.

## <a name="competencies-for-human-resources"></a>Emberi erőforrások kompetenciái
Ha **Emberi erőforrások** típusú üzemi erőforrással rendelkezik, amelyik az Emberi erőforrásoknál dolgozókhoz van rendelve, akkor kihasználhatja a dolgozók kompetenciáit amikor megadja az útvonal forrás szükségleteit. Más szóval is megadhat követelményeket bizonyos képességekhez, tanfolyamokhoz, tanúsítványokhoz vagy beosztásokhoz. Az ütemezési motor kiválaszthat forrásokat, amelyek dolgozókhoz vannak rendelve, a kiválasztás a dolgozók kompetenciái alapján történik. A kompetenciák az Emberi erőforrásoknál, nem pedig az **Erőforrások képességei** oldalon találhatók. Amikor meg képességek, tanfolyamok, tanúsítványok vagy címek, erőforrás-igényű, kell az emberi erőforrások funkcióval és csatolása az egyes erőforrások a **emberi erőforrások** írja be a megfelelő munkavállaló. Ha nem használjuk a humánerőforrás-funkciók, képességek határozhatja meg a **erőforrás-képességek** hasonlító vagy másolása a szakértelem, az emberi erőforrások lap. Ugyanakkor az **Erőforrás-képességek** oldal nem tartalmaz funkciót amelyik szükséges a képességek, tanfolyamok, bizonyítványok vagy beosztások karbantartásához.
