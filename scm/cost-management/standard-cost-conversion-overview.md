...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Ellenőrizze és módosítsa a konvertálási rekord új költségszámítási verzió
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. a cikkek elszámolóárra való átalakítás azonosítása
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Adja meg, vagy minden egyes cikkhez, amely konvertálja a függőben lévő Elszámolóár kiszámítása
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Ellenőrizze, és a cikkek, amelyeket éppen a problémák megoldásához
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. az átalakítási rekord állapotának módosítása kész
...
## <a name="7-back-up-the-database-before-conversion"></a>7. készítsen biztonsági másolatot az adatbázis a konvertálás előtt
A biztonsági mentés lehetővé teszi az adatbázis helyreállítását, ha hiba merül fel az átalakítási folyamat során.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. az átalakítás végrehajtása esetén az átalakítási rekord állapota Kész
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. ellenőrzése és összehangolása az átalakított cikkek készletértéke
