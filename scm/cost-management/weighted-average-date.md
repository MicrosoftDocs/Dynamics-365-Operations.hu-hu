...
Az alábbi esetben egy pénzügyi szempontból frissített bevételezés és kiadás feladására került sor. A készlet zárása során a rendszer közvetlenül a kiadással szemben számolja el a bevételezést, és a kiadás alkalmával nem kell módosítani az önköltségi árat. A következő ábrán ezek a tranzakciók láthatók:
...
A rendszer az 1. naphoz a közvetlen elszámolási megközelítést fogja alkalmazni. **2. nap:**
...
A rendszer a 2. naphoz a közvetlen elszámolási megközelítést fogja alkalmazni. **3. nap:**
