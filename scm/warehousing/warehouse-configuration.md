...
Hely állománysűrűségi korlátozások garantálják, hogy a munka nem kérhet, hogy a leltár létre a készlet elvégzésére fizikai kapacitás nem rendelkező helyen kell elhelyezni. Például ha egyes helyeken a raktáron belül raktár szerint képes tárolni csak egy raklapot, korlátok állomány helyét engedélyezhető. A ** mennyiség ** értéke beállítható **1**, és a ** egység ** értéke beállítható **PL** belül egy adott helyen profil egyesülés. 
...
A raktáron belüli helyét gyors létrehozásához használhatja a ** hely beállítása ** varázsló. Ennek a folyamatnak a részeként egyszerűen karbantarthatja a helynevek formátumát.
...
[Helyek konfigurálásához a WMS-t raktárban (feladat guide)](https://ax.help.dynamics.com/en/wiki/configure-locations-in-a-wms-enabled-warehousing/)
