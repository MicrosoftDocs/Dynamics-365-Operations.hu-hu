...
[Mobileszköz menüelemének beállítása beszerzési rendelés típusú munka befejezéséhez (Feladat-útmutató)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Mobileszköz-menüelem beállítása a bevételezett elem regisztrálásához (Feladat-útmutató)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
