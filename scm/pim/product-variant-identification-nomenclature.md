...
[Termékszámozási rendszer létrehozása előre definiált termékváltozatokhoz](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-predefined-product-variants/)

[Termékszámozás-elnevezési rendszer létrehozása konfigurált termékváltozatokhoz](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-configured-product-variants/)
