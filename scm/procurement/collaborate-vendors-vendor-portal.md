...
| Művelet                                                                                                        | Állapot és verzió                                                                                                                                                                                                                                                                                                                                                                          |
|---------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A beszerzési rendelés eredeti verzióját a Dynamics AX rendszerben hozzák létre.                                                      | Az állapota **Vázlat**.                                                                                                                                                                                                                                                                                                                                                                    |
...
| A beszerzési rendelést elküldik a Szállítói portálra                                                                           | A verzió regisztrálva lesz a Szállítói portálon, és az állapota **Külső ellenőrzés alatt** állapotra módosul.                                                                                                                                                                                                                                                                                        |
...
| Küldje el a beszerzési rendelés új verzióját a Szállító portálra.                                                      | Az új verzió regisztrálva lesz a Szállítói portálon, és az állapota **Külső ellenőrzés alatt** állapotra módosul.                                                                                                                                                                                                                                                                                    |
...
[Szállítói együttműködési számlázás munkaterület](/dynamics365/unified-operations/financials/accounts-payable/vendor-portal-invoicing-workspace)
