...
-   [Felhasználási igénylés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-requisition-for-consumption/)
-   [Olyan igénylés létrehozása, amely ajánlatkérést használ](http://ax.help.dynamics.com/en/wiki/create-a-requisition-that-uses-an-rfq/)
-   [Engedélyek létrehozása, amelyek birtokában mások nevében lehet termékeket rendelni](http://ax.help.dynamics.com/en/wiki/set-up-permissions-for-ordering-products-on-behalf-of-someone-else/)

## <a name="requests-for-quotation"></a>Ajánlatkérések
-   [Ajánlatkérések](request-quotations.md)
-   [Ajánlatkérés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-request-for-quotation/)
-   [Adja meg és hasonlítsa össze az Ajánlatkérés ajánlatait, és rendeljen hozzá szerződéseket](http://ax.help.dynamics.com/en/wiki/enter-and-compare-rfq-bids-and-award-contracts/)
-   [Pontozási mód létrehozása az ajánlatkérésekhez](http://ax.help.dynamics.com/en/wiki/create-a-scoring-method-for-rfqs/)
-   [Meghirdetési típusok és pontozási kritériumok létrehozása az ajánlatkérésekhez](http://ax.help.dynamics.com/en/wiki/create-solicitation-types-and-scoring-criteria-for-rfqs/)
...
-   [Szállítói számla létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-vendor-account/)
-   [Szállítói bankszámla létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-vendor-bank-account/)
-   [Szállítók keresése](http://ax.help.dynamics.com/en/wiki/search-for-vendors/)
-   [A meghatározott termékek szállítójának jóváhagyása](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-products/)
...
-   [Beszerzési katalógus létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-procurement-catalog/)
...
-   [Beszerzési kategóriahierarchia beállítása](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
-   [Beszerzésikategória-hierarchiák irányelveinek beállítása](http://ax.help.dynamics.com/en/wiki/set-up-policies-for-procurement-category-hierarchies/)
-   [Szállítók jóváhagyása konkrét beszerzési kategóriákra vonatkozóan](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-procurement-categories/)
...
-   [Beszerzési rendelés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order/)
-   [Ismételt beszerzési rendelés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-repeat-purchase-order/)
-   [Beszerzési rendelés létrehozása értékesítési rendelésből](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-from-a-sales-order/)
-   [Beszerzési rendelés létrehozása egyszeri szállítóhoz](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-for-a-one-time-supplier/)
-   [Szállítási ütemezéssel ellátott beszerzési rendelés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-with-a-delivery-schedule/)
-   [Beszerzési visszárurendelés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-purchase-return-order/)
-   [Beszerzésirendelés-kiadás létrehozása beszerzési szerződésből](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-from-a-purchase-agreement/)
-   [Beszerzésirendelés-kiadás létrehozása új beszerzési rendelés létrehozásakor](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-when-creating-the-purchase-order/)
-   [Bizományosi feltöltési rendelés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)

## <a name="prices-and-discounts"></a>Árak és engedmények
-   [Beszerzési szerződések](purchase-agreements.md)
-   [Beszerzési szerződés létrehozása](http://ax.help.dynamics.com/en/wiki/create-a-purchase-agreement/)
...
-   [Az áruk bevételezésének rögzítése a beszerzési rendelésen](http://ax.help.dynamics.com/en/wiki/record-receipt-of-goods-on-a-purchase-order/)
...
-   [Beszerzési irányelvek létrehozása](http://ax.help.dynamics.com/en/wiki/create-purchasing-policies/)
