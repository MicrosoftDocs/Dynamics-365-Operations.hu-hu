---
title: "A szabálytalanságok kezelése"
...
# <a name="nonconformance-management"></a>A szabálytalanságok kezelése
...
1.  Határozza meg a szabálytalanságokhoz kapcsolódó Készlet- és raktárkezelési paramétereket:
    ...
    -   Használja a **minőségirányítás** fülre, a **szóló jelentés beállítása** lapon adja meg a nyomtatandó dokumentum típusa. Szabálytalansági jelentés, a szabálytalanságok címke vagy a javító jelentés nyomtatása A jelentéseknél a különféle dokumentumtípusok, illetve a belső és külső jegyzetek nyomtatásához egynél több rekordot is kiválaszthat. A szabálytalansági jelentés, szabálytalansági címke és a javítási jelentés egyedi dokumentumtípusának meghatározását érdemes a **Dokumentumtípus** képernyőn végezni. Tegyük fel, hogy a szabálytalanságokhoz tartozó egyedi dokumentumtípus használatával szeretne jegyzeteket rögzíteni egy szabálytalansággal kapcsolatban. Ebben az esetben a jelentés beállításai között kell megadnia az egyedi dokumentumtípust.
...
[Létrehozása és feldolgozása a szabálytalanság (feladat guide)](https://ax.help.dynamics.com/en/wiki/create-and-process-a-nonconformance/)

[Quality management processes](quality-management-processes.md)

[Állítsa be a szabálytalanság kezelés (feladat guide) előfeltételei](https://ax.help.dynamics.com/en/wiki/set-up-prequisites-for-nonconformance-management/)
