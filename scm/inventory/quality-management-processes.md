...
[![Minőségi kezelési folyamat](./media/quality-management-process-diagram.png)](./media/quality-management-process-diagram.png)  
...
A szabálytalanságok problématípusokhoz vannak társítva. A problématípusok a **Problématípusok** oldalon vannak meghatározva, ahol pontosíthatja melyik probléma típus, milyen szabálytalansági típussal azonosítható. Például a szabálytalanságok a probléma típusa a **szolgáltatási kérelem** típusa lehet tükrözi vevői panaszok, osztályozása, mivel a probléma típusok esetében a szabálytalanságok a ** belső ** típusát jelölheti a hiba kódok osztályozása. 
...
[Minőségi rendelések (feladat guide) beállítása](http://ax.help.dynamics.com/en/wiki/set-up-quality-orders/)
