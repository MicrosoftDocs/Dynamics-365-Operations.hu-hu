...
# [Fedélzeti műveletekre 365 Dynamics](get-started/onboarding-home.md)
## Dynamics 365 műveletek bemutatása
### [Microsoft FastTrack Dynamics 365 Ismerkedés](get-started/fasttrack-dynamics-365-overview.md)
...
## [A demó környezet telepítése](/dynamics365/operations/dev-itpro/deployment/deploy-demo-environment?toc=/dynamics365/operations/toc.json)

## Fedezze fel a felhasználói felület
...
### [365 Dynamics műveletek ügyfél gyakran ismételt kérdések](get-started/client-faq.md)
...
### [Weblapok megjelenése kezelése](get-started/window-management.md)
### [Életciklus szolgáltatások ismertetése](/dynamics365/operations/dev-itpro/lifecycle-services/lcs-works-lcs?toc=/dynamics365/operations/toc.json)

## Súgó és támogatás
### [Súgó – áttekintés](/dynamics365/operations/dev-itpro/get-started/help-overview?toc=/dynamics365/operations/toc.json)
### [Csatlakozás a Súgó](/dynamics365/operations/dev-itpro/get-started/help-connect?toc=/dynamics365/operations/toc.json)
### [View and export field descriptions](get-started/view-export-field-descriptions.md)

### Feladat útmutatók és feladatrögzítő
#### [A feladatrögzítő](/dynamics365/operations/dev-itpro/user-interface/task-recorder?toc=/dynamics365/operations/toc.json)
#### [Dokumentáció vagy képzési létrehozása](/dynamics365/operations/dev-itpro/user-interface/task-recorder?toc=/dynamics365/operations/toc.json)

## [Ország-/ területspecifikus súgótartalom](/dynamics365/operations/dev-itpro/lcs-solutions/country-region?toc=/dynamics365/operations/toc.json)
...
## [Szervezeti hierarchia beállítása](organization-administration/plan-organizational-hierarchy.md)
...
### [Globális címjegyzékek beállítása](organization-administration/plan-configuration-global-address-book-additional-address-books.md)
...
### [Eset biztonsági folyamatok és kategóriák konfigurálása](organization-administration/plan-case-management.md)
## [Rekordsablonok létrehozása](organization-administration/record-templates.md)
## [Konfigurálja és e-mail küldése](organization-administration/configure-email.md)
## [Időzóna és a dátum/idő adattípus](organization-administration/date-time-zones.md)
...
## [Sortétel munkafolyamatának beállítása](organization-administration/configure-line-item-workflow.md)
...
## [Párhuzamos tevékenység beállítása](organization-administration/configure-parallel-activity-workflow.md)
## [Párhuzamos ág beállítása](organization-administration/configure-parallel-branch-workflow.md)
...
# [Fejlesztők és rendszergazdák](/dynamics365/operations/dev-itpro/index)
