---
title: "Jóváhagyási folyamat egy munkafolyamat beállítása"
...
# <a name="configure-an-approval-process-in-a-workflow"></a>Jóváhagyási folyamat egy munkafolyamat beállítása

A következő eljárás segítségével állítsa be a jóváhagyási folyamat tulajdonságait.

Adja meg a jóváhagyási folyamatot, a munkafolyamat-szerkesztőben, kattintson a jobb gombbal a Jóváhagyás elemre, és kattintson a **tulajdonságok** megnyitása a **tulajdonságok** űrlap.
...
2.  Jelölje be a jelölőnégyzetet azon eseményekhez, amelyekhez ki kell küldeni az értesítéseket:
    -   **Delegált** – Ha egy dokumentumot egy másik felhasználó jóváhagyásra van rendelve.
    -   **Eszkalálása** – Ha a kijelölt felhasználó nem döntött a dokumentum a megadott idő alatt.
    -   **Jóváhagyása** – a dokumentum jóváhagyásakor.
    -   **Elutasítás** – Ha a bizonylatot elutasították.
    -   **Módosítási kérelme** – Ha a kijelölt felhasználó kérte a dokumentum beadásának módosításakor.
...
7.  A bejelentés fordítások hozzáadásához kattintson **fordítás**. A megjelenő űrlapon tegye a következőket:
    1.  Click **Add**.
...
9.  Határozza meg az értesítések címzettjeit. Válasszon ki egy lehetőséget a következő táblázatban, majd ezt követően végezze el a további lépéseket a beállításhoz, mielőtt továbblép a 10. lépésre.
    ...
    <li>A <strong>elérhető felhasználók</strong>: a lista tartalmazza az összes Microsoft Dynamics 365 műveletek számára. Válassza ki azokat a felhasználókat, akik számára értesítéseket kíván küldeni, majd helyezze át ezeket a felhasználókat a <strong>Kijelölt felhasználók</strong>: listába.</li>
    </ol></td>
    </tr>
    </tbody>
    </table>
...
1.  A bal oldali panelen kattintson az **Speciális beállítások** gombra.
2.  Válassza ki a **jóváhagyás** jelölőnégyzetet, ha a felhasználó jóváhagyhatja a dokumentumot.
3.  Válassza ki a **elutasítása** jelölőnégyzetet a felhasználó elutasíthatja a bizonylatot.
4.  Válassza ki a **módosításának kérése** jelölőnégyzetet a felhasználó kérheti a dokumentum módosításait.
5.  Válassza ki a **delegált** jelölőnégyzetet, ha a felhasználó a dokumentumot egy másik felhasználó jóváhagyásra rendelhető.
